		...
		try {
			...
			if (!isTransient && eStructuralFeature instanceof EReference) {
				...
				if (aReference != null && aReference.getTransient() == null
						&& aReference.getExternal() == null && aReference.getAReferenceType() != null
			...
			if (aStructuralFeature instanceof PAnnotatedEAttribute) {
				...
				final boolean otoUnidirectionalRelation = aReference.getManyToOne() == null
						&& !isMany
						&& eOpposite == null
						&& (aReference.getOneToOne() != null || !aReference.getPrimaryKeyJoinColumns()
								.isEmpty());
				final boolean mtoBidirectionalRelation = !isMany && eOpposite != null && isOppositeMany;
				final boolean mtoUnidirectionalRelation = !isMany && eOpposite == null
