...
public class ExtensionUtil {
	...
	public static void registerDefaultExtensions(ExtensionManager em) {
		...
		em.registerExtension(createExtension(XmlPersistenceContentHandler.class,
		...
		em.registerExtension(createExtension(
				"org.eclipse.emf.teneo.hibernate.mapping.property.EListPropertyHandler", false));
		em.registerExtension(createExtension(
		...
		em.registerExtension(createExtension(
				"org.eclipse.emf.teneo.hibernate.mapping.property.VersionPropertyHandler", false));
		em.registerExtension(createExtension("org.eclipse.emf.teneo.hibernate.EMFInterceptor", false));

		em.registerExtension(createExtension(
				"org.eclipse.emf.teneo.hibernate.tuplizer.EMFEntityNameResolver", false));

		em.registerExtension(createExtension(
				"org.eclipse.emf.teneo.hibernate.mapping.elist.HibernatePersistableEList", false));
		em.registerExtension(createExtension(
				"org.eclipse.emf.teneo.hibernate.mapping.elist.HibernatePersistableEMap", false));
		em.registerExtension(createExtension(
		...
		// hibernate mapper
		em.registerExtension(createExtension(
				"org.eclipse.emf.teneo.hibernate.mapper.HibernateMappingGenerator", false));
		em.registerExtension(createExtension("org.eclipse.emf.teneo.hibernate.mapper.MappingContext",
				false));
		em.registerExtension(createExtension("org.eclipse.emf.teneo.hibernate.mapper.BasicMapper",
				false));
		em.registerExtension(createExtension("org.eclipse.emf.teneo.hibernate.mapper.EmbeddedMapper",
				false));
		em.registerExtension(createExtension("org.eclipse.emf.teneo.hibernate.mapper.EntityMapper",
				false));
		em.registerExtension(createExtension("org.eclipse.emf.teneo.hibernate.mapper.FeatureMapper",
				false));
		em.registerExtension(createExtension("org.eclipse.emf.teneo.hibernate.mapper.IdMapper", false));
		em.registerExtension(createExtension(
				"org.eclipse.emf.teneo.hibernate.mapper.ManyAttributeMapper", false));
		em.registerExtension(createExtension("org.eclipse.emf.teneo.hibernate.mapper.ManyToManyMapper",
				false));
		em.registerExtension(createExtension("org.eclipse.emf.teneo.hibernate.mapper.ManyToOneMapper",
				false));
		em.registerExtension(createExtension("org.eclipse.emf.teneo.hibernate.mapper.MappingContext",
				false));
		em.registerExtension(createExtension("org.eclipse.emf.teneo.hibernate.mapper.OneToManyMapper",
				false));
		em.registerExtension(createExtension("org.eclipse.emf.teneo.hibernate.mapper.OneToOneMapper",
				false));
		em.registerExtension(createExtension(
				"org.eclipse.emf.teneo.hibernate.mapper.TypedEReferenceMapper", false));
		em.registerExtension(createExtension(
				"org.eclipse.emf.teneo.hibernate.mapper.ManyExternalReferenceMapper", false));
		em.registerExtension(createExtension(
				"org.eclipse.emf.teneo.hibernate.mapping.EMFInitializeCollectionEventListener", false));
		em.registerExtension(createExtension(
				"org.eclipse.emf.teneo.hibernate.mapping.eav.EAVMergeEventListener", false));

		// jpox mapping
		em.registerExtension(createExtension(
				"org.eclipse.emf.teneo.jpox.mapper.association.EmbeddedMapper", false));
		em.registerExtension(createExtension(
				"org.eclipse.emf.teneo.jpox.mapper.association.ManyToManyMapper", false));
		em.registerExtension(createExtension(
				"org.eclipse.emf.teneo.jpox.mapper.association.ManyToOneMapper", false));
		em.registerExtension(createExtension(
				"org.eclipse.emf.teneo.jpox.mapper.association.OneToManyMapper", false));
		em.registerExtension(createExtension(
				"org.eclipse.emf.teneo.jpox.mapper.association.OneToOneMapper", false));
		em.registerExtension(createExtension("org.eclipse.emf.teneo.jpox.mapper.property.BasicMapper",
				false));
		em.registerExtension(createExtension("org.eclipse.emf.teneo.jpox.mapper.property.ColumnMapper",
				false));
		em.registerExtension(createExtension(
				"org.eclipse.emf.teneo.jpox.mapper.property.EClassFeatureMapper", false));
		em.registerExtension(createExtension("org.eclipse.emf.teneo.jpox.mapper.property.IdMapper",
				false));
		em.registerExtension(createExtension(
				"org.eclipse.emf.teneo.jpox.mapper.property.InheritanceMapper", false));
		em.registerExtension(createExtension(
				"org.eclipse.emf.teneo.jpox.mapper.property.JoinColumnMapper", false));
		em.registerExtension(createExtension(
				"org.eclipse.emf.teneo.jpox.mapper.property.ManyBasicMapper", false));
		em.registerExtension(createExtension("org.eclipse.emf.teneo.jpox.mapper.property.TableMapper",
				false));
		em.registerExtension(createExtension("org.eclipse.emf.teneo.jpox.mapper.JPOXMappingGenerator",
				false));
