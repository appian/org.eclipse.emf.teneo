 ...
 * <ul>
 * <li>{@link org.eclipse.emf.teneo.annotations.pannotation.impl.AssociationOverrideImpl#getName
 * <em>Name</em>}</li>
 * <li>
 * {@link org.eclipse.emf.teneo.annotations.pannotation.impl.AssociationOverrideImpl#getJoinColumns
 * <em>Join Columns</em>}</li>
 * <li>
 * {@link org.eclipse.emf.teneo.annotations.pannotation.impl.AssociationOverrideImpl#getJoinTable
 * <em>Join Table</em>}</li>
 * </ul>
 * </p>
 * 
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					PannotationPackage.ASSOCIATION_OVERRIDE__NAME, oldName, name));
	}
	...
	public EList<JoinColumn> getJoinColumns() {
		if (joinColumns == null) {
			joinColumns = new EObjectContainmentEList<JoinColumn>(JoinColumn.class, this,
					PannotationPackage.ASSOCIATION_OVERRIDE__JOIN_COLUMNS);
		}
		return joinColumns;
	}
	...
	public NotificationChain basicSetJoinTable(JoinTable newJoinTable, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PannotationPackage.ASSOCIATION_OVERRIDE__JOIN_TABLE, oldJoinTable, newJoinTable);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newJoinTable != joinTable) {
			...
			if (joinTable != null)
				msgs = ((InternalEObject) joinTable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- PannotationPackage.ASSOCIATION_OVERRIDE__JOIN_TABLE, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					PannotationPackage.ASSOCIATION_OVERRIDE__JOIN_TABLE, newJoinTable, newJoinTable));
	}
