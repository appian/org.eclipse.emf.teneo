 ...
 * <em><b>PAnnotated EData Type</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedEDataTypeImpl#getModelEDataType
 * <em>Model EData Type</em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedEDataTypeImpl#getBasic <em>
 * Basic</em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedEDataTypeImpl#getEnumerated
 * <em>Enumerated</em>}</li>
 * <li>
 * {@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedEDataTypeImpl#getGeneratedValue
 * <em>Generated Value</em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedEDataTypeImpl#getId <em>Id
 * </em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedEDataTypeImpl#getLob <em>Lob
 * </em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedEDataTypeImpl#getTemporal
 * <em>Temporal</em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedEDataTypeImpl#getVersion <em>
 * Version</em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedEDataTypeImpl#getPaEPackage
 * <em>Pa EPackage</em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedEDataTypeImpl#getColumn <em>
 * Column</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
 */
public class PAnnotatedEDataTypeImpl extends PAnnotatedEModelElementImpl implements
		PAnnotatedEDataType {
	/**
	...
	public EDataType getModelEDataType() {
		...
		return modelEDataType != null && modelEDataType.eIsProxy() ? (EDataType) eResolveProxy((InternalEObject) modelEDataType)
				: modelEDataType;
	}
	...
	public NotificationChain basicSetBasic(Basic newBasic, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_EDATA_TYPE__BASIC, oldBasic, newBasic);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setBasic(Basic newBasic) {
		if (newBasic != basic) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_EDATA_TYPE__BASIC, newBasic, newBasic));
	}
	...
	public NotificationChain basicSetEnumerated(Enumerated newEnumerated, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_EDATA_TYPE__ENUMERATED, oldEnumerated, newEnumerated);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setEnumerated(Enumerated newEnumerated) {
		if (newEnumerated != enumerated) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_EDATA_TYPE__ENUMERATED, newEnumerated, newEnumerated));
	}
	...
	public NotificationChain basicSetGeneratedValue(GeneratedValue newGeneratedValue,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_EDATA_TYPE__GENERATED_VALUE, oldGeneratedValue,
					newGeneratedValue);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setGeneratedValue(GeneratedValue newGeneratedValue) {
		if (newGeneratedValue != generatedValue) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_EDATA_TYPE__GENERATED_VALUE, newGeneratedValue,
					newGeneratedValue));
	}
	...
	public NotificationChain basicSetId(Id newId, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_EDATA_TYPE__ID, oldId, newId);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setId(Id newId) {
		if (newId != id) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_EDATA_TYPE__ID, newId, newId));
	}
	...
	public NotificationChain basicSetLob(Lob newLob, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_EDATA_TYPE__LOB, oldLob, newLob);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setLob(Lob newLob) {
		if (newLob != lob) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_EDATA_TYPE__LOB, newLob, newLob));
	}
	...
	public NotificationChain basicSetTemporal(Temporal newTemporal, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_EDATA_TYPE__TEMPORAL, oldTemporal, newTemporal);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setTemporal(Temporal newTemporal) {
		if (newTemporal != temporal) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_EDATA_TYPE__TEMPORAL, newTemporal, newTemporal));
	}
	...
	public NotificationChain basicSetVersion(Version newVersion, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_EDATA_TYPE__VERSION, oldVersion, newVersion);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setVersion(Version newVersion) {
		if (newVersion != version) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_EDATA_TYPE__VERSION, newVersion, newVersion));
	}
	...
	public NotificationChain basicSetPaEPackage(PAnnotatedEPackage newPaEPackage,
		...
		msgs = eBasicSetContainer((InternalEObject) newPaEPackage,
				PamodelPackage.PANNOTATED_EDATA_TYPE__PA_EPACKAGE, msgs);
		return msgs;
	}
	...
	public void setPaEPackage(PAnnotatedEPackage newPaEPackage) {
		if (newPaEPackage != eInternalContainer()
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_EDATA_TYPE__PA_EPACKAGE, newPaEPackage, newPaEPackage));
	}
	...
	public NotificationChain basicSetColumn(Column newColumn, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_EDATA_TYPE__COLUMN, oldColumn, newColumn);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setColumn(Column newColumn) {
		if (newColumn != column) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_EDATA_TYPE__COLUMN, newColumn, newColumn));
	}
