 ...
 * <em><b>PAnnotated ETyped Element</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedETypedElementImpl#getAttributeOverrides
 * <em>Attribute Overrides</em>}</li>
 * <li>
 * {@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedETypedElementImpl#getJoinTable
 * <em>Join Table</em>}</li>
 * <li>
 * {@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedETypedElementImpl#getOneToMany
 * <em>One To Many</em>}</li>
 * <li>
 * {@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedETypedElementImpl#getSequenceGenerator
 * <em>Sequence Generator</em>}</li>
 * <li>
 * {@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedETypedElementImpl#getTableGenerators
 * <em>Table Generators</em>}</li>
 * <li>
 * {@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedETypedElementImpl#getJoinColumns
 * <em>Join Columns</em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedETypedElementImpl#getColumn
 * <em>Column</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
 */
public abstract class PAnnotatedETypedElementImpl extends PAnnotatedEModelElementImpl implements
	...
	/**
	 * The cached value of the '{@link #getSequenceGenerator() <em>Sequence Generator</em>}'
	...
	public EList<AttributeOverride> getAttributeOverrides() {
		if (attributeOverrides == null) {
			attributeOverrides = new EObjectContainmentEList<AttributeOverride>(AttributeOverride.class,
					this, PamodelPackage.PANNOTATED_ETYPED_ELEMENT__ATTRIBUTE_OVERRIDES);
		}
	...
	public NotificationChain basicSetJoinTable(JoinTable newJoinTable, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_ETYPED_ELEMENT__JOIN_TABLE, oldJoinTable, newJoinTable);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newJoinTable != joinTable) {
			...
			if (joinTable != null)
				msgs = ((InternalEObject) joinTable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- PamodelPackage.PANNOTATED_ETYPED_ELEMENT__JOIN_TABLE, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_ETYPED_ELEMENT__JOIN_TABLE, newJoinTable, newJoinTable));
	}
	...
	public NotificationChain basicSetOneToMany(OneToMany newOneToMany, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_ETYPED_ELEMENT__ONE_TO_MANY, oldOneToMany, newOneToMany);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newOneToMany != oneToMany) {
			...
			if (oneToMany != null)
				msgs = ((InternalEObject) oneToMany).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- PamodelPackage.PANNOTATED_ETYPED_ELEMENT__ONE_TO_MANY, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_ETYPED_ELEMENT__ONE_TO_MANY, newOneToMany, newOneToMany));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetSequenceGenerator(SequenceGenerator newSequenceGenerator,
			NotificationChain msgs) {
		SequenceGenerator oldSequenceGenerator = sequenceGenerator;
		sequenceGenerator = newSequenceGenerator;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_ETYPED_ELEMENT__SEQUENCE_GENERATOR, oldSequenceGenerator,
		...
		if (newSequenceGenerator != sequenceGenerator) {
			...
			if (sequenceGenerator != null)
				msgs = ((InternalEObject) sequenceGenerator).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- PamodelPackage.PANNOTATED_ETYPED_ELEMENT__SEQUENCE_GENERATOR, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_ETYPED_ELEMENT__SEQUENCE_GENERATOR, newSequenceGenerator,
					newSequenceGenerator));
	}
	...
	public EList<TableGenerator> getTableGenerators() {
		if (tableGenerators == null) {
			tableGenerators = new EObjectContainmentEList<TableGenerator>(TableGenerator.class, this,
					PamodelPackage.PANNOTATED_ETYPED_ELEMENT__TABLE_GENERATORS);
		}
	...
	public EList<JoinColumn> getJoinColumns() {
		if (joinColumns == null) {
			joinColumns = new EObjectContainmentEList<JoinColumn>(JoinColumn.class, this,
					PamodelPackage.PANNOTATED_ETYPED_ELEMENT__JOIN_COLUMNS);
		}
		return joinColumns;
	}
	...
	public NotificationChain basicSetColumn(Column newColumn, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_ETYPED_ELEMENT__COLUMN, oldColumn, newColumn);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newColumn != column) {
			...
			if (column != null)
				msgs = ((InternalEObject) column).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- PamodelPackage.PANNOTATED_ETYPED_ELEMENT__COLUMN, null, msgs);
			if (newColumn != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_ETYPED_ELEMENT__COLUMN, newColumn, newColumn));
	}
