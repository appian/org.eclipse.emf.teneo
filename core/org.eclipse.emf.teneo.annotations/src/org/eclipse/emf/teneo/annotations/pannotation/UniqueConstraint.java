 ...
 * <ul>
 * <li>{@link org.eclipse.emf.teneo.annotations.pannotation.UniqueConstraint#getColumnNames <em>
 * Column Names</em>}</li>
 * </ul>
 * </p>
 * 
...
public interface UniqueConstraint extends PAnnotation {
	/**
	 * Returns the value of the '<em><b>Column Names</b></em>' attribute list. The list contents are
	 * of type {@link java.lang.String}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Column Names</em>' attribute list isn't clear, there really should
