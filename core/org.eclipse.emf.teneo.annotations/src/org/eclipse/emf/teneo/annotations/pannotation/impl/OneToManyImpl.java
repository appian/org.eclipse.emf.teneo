 ...
 * <ul>
 * <li>{@link org.eclipse.emf.teneo.annotations.pannotation.impl.OneToManyImpl#getTargetEntity <em>
 * Target Entity</em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pannotation.impl.OneToManyImpl#getCascade <em>
 * Cascade</em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pannotation.impl.OneToManyImpl#getFetch <em>Fetch
 * </em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pannotation.impl.OneToManyImpl#getMappedBy <em>
 * Mapped By</em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pannotation.impl.OneToManyImpl#isIndexed <em>Indexed
 * </em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pannotation.impl.OneToManyImpl#isUnique <em>Unique
 * </em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pannotation.impl.OneToManyImpl#isOrphanRemoval <em>
...
public class OneToManyImpl extends PAnnotationImpl implements OneToMany {
	...
	public void setFetch(FetchType newFetch) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PannotationPackage.ONE_TO_MANY__FETCH,
					oldFetch, fetch));
	}
	...
	public void setTargetEntity(String newTargetEntity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					PannotationPackage.ONE_TO_MANY__TARGET_ENTITY, oldTargetEntity, targetEntity));
	}
	...
	public void setMappedBy(String newMappedBy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					PannotationPackage.ONE_TO_MANY__MAPPED_BY, oldMappedBy, mappedBy));
	}
	...
	public void setIndexed(boolean newIndexed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					PannotationPackage.ONE_TO_MANY__INDEXED, oldIndexed, indexed));
	}
	...
	public void setUnique(boolean newUnique) {
		...
		unique = newUnique;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PannotationPackage.ONE_TO_MANY__UNIQUE,
					oldUnique, unique));
	}
	...
	public void setOrphanRemoval(boolean newOrphanRemoval) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					PannotationPackage.ONE_TO_MANY__ORPHAN_REMOVAL, oldOrphanRemoval, orphanRemoval));
	}
