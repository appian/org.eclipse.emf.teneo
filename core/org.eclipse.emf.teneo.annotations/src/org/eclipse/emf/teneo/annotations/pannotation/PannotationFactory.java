...
public interface PannotationFactory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>Cacheable</em>'. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>External</em>'. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>EAV Mapping</em>'. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
