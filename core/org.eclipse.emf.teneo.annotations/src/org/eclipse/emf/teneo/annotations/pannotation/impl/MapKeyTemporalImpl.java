 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.annotations.pannotation.impl.MapKeyTemporalImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MapKeyTemporalImpl extends PAnnotationImpl implements MapKeyTemporal {
	/**
	...
	public void setValue(TemporalType newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PannotationPackage.MAP_KEY_TEMPORAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PannotationPackage.MAP_KEY_TEMPORAL__VALUE:
				return getValue();
		}
