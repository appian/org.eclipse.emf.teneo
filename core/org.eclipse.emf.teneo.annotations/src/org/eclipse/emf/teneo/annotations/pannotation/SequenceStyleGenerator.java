 ...
 * <ul>
 * <li>{@link org.eclipse.emf.teneo.annotations.pannotation.SequenceStyleGenerator#getName <em>Name
 * </em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pannotation.SequenceStyleGenerator#getSequenceName
 * <em>Sequence Name</em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pannotation.SequenceStyleGenerator#getInitialValue
 * <em>Initial Value</em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pannotation.SequenceStyleGenerator#getIncrementSize
 * <em>Increment Size</em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pannotation.SequenceStyleGenerator#getOptimizer <em>
 * Optimizer</em>}</li>
 * <li>
...
public interface SequenceStyleGenerator extends PAnnotation {
	...
	/**
	 * Returns the value of the '<em><b>Increment Size</b></em>' attribute. The default value is
	 * <code>"50"</code>. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Increment Size</em>' attribute isn't clear, there really should be
	 * more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * <em>Increment Size</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Increment Size</em>' attribute.
	...
	/**
	 * Returns the value of the '<em><b>Optimizer</b></em>' attribute. The default value is
	 * <code>"DEFAULT"</code>. The literals are from the enumeration
	 * {@link org.eclipse.emf.teneo.annotations.pannotation.OptimizerType}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Optimizer</em>' attribute isn't clear, there really should be more
	 ...
	 * <em>Optimizer</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Optimizer</em>' attribute.
	 * @see org.eclipse.emf.teneo.annotations.pannotation.OptimizerType
	 * @see #getOptimizer()
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Optimizer Class</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Optimizer Class</em>' attribute isn't clear, there really should be
	 * more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * Sets the value of the '
	 * {@link org.eclipse.emf.teneo.annotations.pannotation.SequenceStyleGenerator#getOptimizerClass
	 * <em>Optimizer Class</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Optimizer Class</em>' attribute.
