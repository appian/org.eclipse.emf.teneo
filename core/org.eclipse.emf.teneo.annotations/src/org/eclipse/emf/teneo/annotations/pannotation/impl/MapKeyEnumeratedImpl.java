 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.annotations.pannotation.impl.MapKeyEnumeratedImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class MapKeyEnumeratedImpl extends PAnnotationImpl implements MapKeyEnumerated {
	/**
	...
	public void setValue(EnumType newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PannotationPackage.MAP_KEY_ENUMERATED__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PannotationPackage.MAP_KEY_ENUMERATED__VALUE:
				return getValue();
		}
