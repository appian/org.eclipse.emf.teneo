 ...
 * <ul>
 * <li>{@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedEClassImpl#getPaEPackage <em>
 * Pa EPackage</em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedEClassImpl#getModelEClass
 * <em>Model EClass</em>}</li>
 * <li>
 * {@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedEClassImpl#getPaEStructuralFeatures
 * <em>Pa EStructural Features</em>}</li>
 * <li>
 * {@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedEClassImpl#getAttributeOverrides
 * <em>Attribute Overrides</em>}</li>
 * <li>
 * {@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedEClassImpl#getDiscriminatorColumn
 * <em>Discriminator Column</em>}</li>
 * <li>
 * {@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedEClassImpl#getDiscriminatorValue
 * <em>Discriminator Value</em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedEClassImpl#getEmbeddable <em>
 * Embeddable</em>}</li>
 * <li>
 * {@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedEClassImpl#getMappedSuperclass
 * <em>Mapped Superclass</em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedEClassImpl#getEntity <em>
 * Entity</em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedEClassImpl#getIdClass <em>Id
 * Class</em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedEClassImpl#getInheritance
 * <em>Inheritance</em>}</li>
 * <li>
 * {@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedEClassImpl#getPrimaryKeyJoinColumns
 * <em>Primary Key Join Columns</em>}</li>
 * <li>
 * {@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedEClassImpl#getSecondaryTables
 * <em>Secondary Tables</em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedEClassImpl#getTable <em>Table
 * </em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedEClassImpl#getTableGenerator
 * <em>Table Generator</em>}</li>
 * <li>
 * {@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedEClassImpl#getAssociationOverrides
 * <em>Association Overrides</em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedEClassImpl#getEavMapping <em>
 * Eav Mapping</em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedEClassImpl#getNoEAVMapping
 * <em>No EAV Mapping</em>}</li>
 * <li>
 * {@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedEClassImpl#getSequenceGenerators
 * <em>Sequence Generators</em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedEClassImpl#getExternal <em>
 * External</em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pamodel.impl.PAnnotatedEClassImpl#getCacheable <em>
 * Cacheable</em>}</li>
 * </ul>
 * </p>
 * 
...
public class PAnnotatedEClassImpl extends PAnnotatedEModelElementImpl implements PAnnotatedEClass {
	/**
	 * The cached value of the '{@link #getPaEStructuralFeatures() <em>Pa EStructural Features</em>}'
	...
	/**
	 * The cached value of the '{@link #getAttributeOverrides() <em>Attribute Overrides</em>}'
	 * containment reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getDiscriminatorColumn() <em>Discriminator Column</em>}'
	...
	/**
	 * The cached value of the '{@link #getDiscriminatorValue() <em>Discriminator Value</em>}'
	 * containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getMappedSuperclass() <em>Mapped Superclass</em>}' containment
	...
	/**
	 * The cached value of the '{@link #getSecondaryTables() <em>Secondary Tables</em>}' containment
	...
	/**
	 * The cached value of the '{@link #getTableGenerator() <em>Table Generator</em>}' containment
	 * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getNoEAVMapping() <em>No EAV Mapping</em>}' containment
	 * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getNoEAVMapping()
	 * @generated
	...
	public PAnnotatedEPackage getPaEPackage() {
		if (eContainerFeatureID() != PamodelPackage.PANNOTATED_ECLASS__PA_EPACKAGE)
			return null;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetPaEPackage(PAnnotatedEPackage newPaEPackage,
			NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject) newPaEPackage,
				PamodelPackage.PANNOTATED_ECLASS__PA_EPACKAGE, msgs);
		return msgs;
	}
	...
	public void setPaEPackage(PAnnotatedEPackage newPaEPackage) {
		if (newPaEPackage != eInternalContainer()
				|| (eContainerFeatureID() != PamodelPackage.PANNOTATED_ECLASS__PA_EPACKAGE && newPaEPackage != null)) {
			...
			if (newPaEPackage != null)
				msgs = ((InternalEObject) newPaEPackage).eInverseAdd(this,
						PamodelPackage.PANNOTATED_EPACKAGE__PA_ECLASSES, PAnnotatedEPackage.class, msgs);
			msgs = basicSetPaEPackage(newPaEPackage, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_ECLASS__PA_EPACKAGE, newPaEPackage, newPaEPackage));
	}
	...
	public EClass getModelEClass() {
		...
		return modelEClass != null && modelEClass.eIsProxy() ? (EClass) eResolveProxy((InternalEObject) modelEClass)
				: modelEClass;
	}
	...
	public EList<PAnnotatedEStructuralFeature> getPaEStructuralFeatures() {
		if (paEStructuralFeatures == null) {
			paEStructuralFeatures = new EObjectContainmentWithInverseEList<PAnnotatedEStructuralFeature>(
					PAnnotatedEStructuralFeature.class, this,
					PamodelPackage.PANNOTATED_ECLASS__PA_ESTRUCTURAL_FEATURES,
					PamodelPackage.PANNOTATED_ESTRUCTURAL_FEATURE__PA_ECLASS);
		}
	...
	public EList<AttributeOverride> getAttributeOverrides() {
		if (attributeOverrides == null) {
			attributeOverrides = new EObjectContainmentEList<AttributeOverride>(AttributeOverride.class,
					this, PamodelPackage.PANNOTATED_ECLASS__ATTRIBUTE_OVERRIDES);
		}
	...
	public NotificationChain basicSetDiscriminatorColumn(DiscriminatorColumn newDiscriminatorColumn,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_ECLASS__DISCRIMINATOR_COLUMN, oldDiscriminatorColumn,
		...
		if (newDiscriminatorColumn != discriminatorColumn) {
			...
			if (discriminatorColumn != null)
				msgs = ((InternalEObject) discriminatorColumn).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- PamodelPackage.PANNOTATED_ECLASS__DISCRIMINATOR_COLUMN, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_ECLASS__DISCRIMINATOR_COLUMN, newDiscriminatorColumn,
					newDiscriminatorColumn));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetDiscriminatorValue(DiscriminatorValue newDiscriminatorValue,
			NotificationChain msgs) {
		DiscriminatorValue oldDiscriminatorValue = discriminatorValue;
		discriminatorValue = newDiscriminatorValue;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_ECLASS__DISCRIMINATOR_VALUE, oldDiscriminatorValue,
	...
	public void setDiscriminatorValue(DiscriminatorValue newDiscriminatorValue) {
		if (newDiscriminatorValue != discriminatorValue) {
			...
			if (discriminatorValue != null)
				msgs = ((InternalEObject) discriminatorValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- PamodelPackage.PANNOTATED_ECLASS__DISCRIMINATOR_VALUE, null, msgs);
			if (newDiscriminatorValue != null)
				msgs = ((InternalEObject) newDiscriminatorValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
						- PamodelPackage.PANNOTATED_ECLASS__DISCRIMINATOR_VALUE, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_ECLASS__DISCRIMINATOR_VALUE, newDiscriminatorValue,
					newDiscriminatorValue));
	}
	...
	public NotificationChain basicSetEmbeddable(Embeddable newEmbeddable, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_ECLASS__EMBEDDABLE, oldEmbeddable, newEmbeddable);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newEmbeddable != embeddable) {
			...
			if (embeddable != null)
				msgs = ((InternalEObject) embeddable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- PamodelPackage.PANNOTATED_ECLASS__EMBEDDABLE, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_ECLASS__EMBEDDABLE, newEmbeddable, newEmbeddable));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetMappedSuperclass(MappedSuperclass newMappedSuperclass,
			NotificationChain msgs) {
		MappedSuperclass oldMappedSuperclass = mappedSuperclass;
		mappedSuperclass = newMappedSuperclass;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_ECLASS__MAPPED_SUPERCLASS, oldMappedSuperclass,
					newMappedSuperclass);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newMappedSuperclass != mappedSuperclass) {
			...
			if (mappedSuperclass != null)
				msgs = ((InternalEObject) mappedSuperclass).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- PamodelPackage.PANNOTATED_ECLASS__MAPPED_SUPERCLASS, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_ECLASS__MAPPED_SUPERCLASS, newMappedSuperclass,
					newMappedSuperclass));
	}
	...
	public NotificationChain basicSetEntity(Entity newEntity, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_ECLASS__ENTITY, oldEntity, newEntity);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newEntity != entity) {
			...
			if (entity != null)
				msgs = ((InternalEObject) entity).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- PamodelPackage.PANNOTATED_ECLASS__ENTITY, null, msgs);
			if (newEntity != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_ECLASS__ENTITY, newEntity, newEntity));
	}
	...
	public NotificationChain basicSetIdClass(IdClass newIdClass, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_ECLASS__ID_CLASS, oldIdClass, newIdClass);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newIdClass != idClass) {
			...
			if (idClass != null)
				msgs = ((InternalEObject) idClass).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- PamodelPackage.PANNOTATED_ECLASS__ID_CLASS, null, msgs);
			if (newIdClass != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_ECLASS__ID_CLASS, newIdClass, newIdClass));
	}
	...
	public NotificationChain basicSetInheritance(Inheritance newInheritance, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_ECLASS__INHERITANCE, oldInheritance, newInheritance);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newInheritance != inheritance) {
			...
			if (inheritance != null)
				msgs = ((InternalEObject) inheritance).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- PamodelPackage.PANNOTATED_ECLASS__INHERITANCE, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_ECLASS__INHERITANCE, newInheritance, newInheritance));
	}
	...
	public EList<PrimaryKeyJoinColumn> getPrimaryKeyJoinColumns() {
		if (primaryKeyJoinColumns == null) {
			primaryKeyJoinColumns = new EObjectContainmentEList<PrimaryKeyJoinColumn>(
					...
					PamodelPackage.PANNOTATED_ECLASS__PRIMARY_KEY_JOIN_COLUMNS);
		}
	...
	public EList<SecondaryTable> getSecondaryTables() {
		if (secondaryTables == null) {
			secondaryTables = new EObjectContainmentEList<SecondaryTable>(SecondaryTable.class, this,
					PamodelPackage.PANNOTATED_ECLASS__SECONDARY_TABLES);
		}
	...
	public NotificationChain basicSetTable(Table newTable, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_ECLASS__TABLE, oldTable, newTable);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setTable(Table newTable) {
		if (newTable != table) {
			NotificationChain msgs = null;
			if (table != null)
				msgs = ((InternalEObject) table).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- PamodelPackage.PANNOTATED_ECLASS__TABLE, null, msgs);
			if (newTable != null)
				msgs = ((InternalEObject) newTable).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
						- PamodelPackage.PANNOTATED_ECLASS__TABLE, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_ECLASS__TABLE, newTable, newTable));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetTableGenerator(TableGenerator newTableGenerator,
			NotificationChain msgs) {
		TableGenerator oldTableGenerator = tableGenerator;
		tableGenerator = newTableGenerator;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_ECLASS__TABLE_GENERATOR, oldTableGenerator, newTableGenerator);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newTableGenerator != tableGenerator) {
			...
			if (tableGenerator != null)
				msgs = ((InternalEObject) tableGenerator).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- PamodelPackage.PANNOTATED_ECLASS__TABLE_GENERATOR, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_ECLASS__TABLE_GENERATOR, newTableGenerator, newTableGenerator));
	}
	...
	public EList<AssociationOverride> getAssociationOverrides() {
		if (associationOverrides == null) {
			associationOverrides = new EObjectContainmentEList<AssociationOverride>(
					AssociationOverride.class, this, PamodelPackage.PANNOTATED_ECLASS__ASSOCIATION_OVERRIDES);
		}
	...
	public NotificationChain basicSetEavMapping(EAVMapping newEavMapping, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_ECLASS__EAV_MAPPING, oldEavMapping, newEavMapping);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setEavMapping(EAVMapping newEavMapping) {
		if (newEavMapping != eavMapping) {
			NotificationChain msgs = null;
			if (eavMapping != null)
				msgs = ((InternalEObject) eavMapping).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- PamodelPackage.PANNOTATED_ECLASS__EAV_MAPPING, null, msgs);
			if (newEavMapping != null)
				msgs = ((InternalEObject) newEavMapping).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
						- PamodelPackage.PANNOTATED_ECLASS__EAV_MAPPING, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_ECLASS__EAV_MAPPING, newEavMapping, newEavMapping));
	}
	...
	public NotificationChain basicSetNoEAVMapping(NoEAVMapping newNoEAVMapping, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_ECLASS__NO_EAV_MAPPING, oldNoEAVMapping, newNoEAVMapping);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setNoEAVMapping(NoEAVMapping newNoEAVMapping) {
		if (newNoEAVMapping != noEAVMapping) {
			...
			if (noEAVMapping != null)
				msgs = ((InternalEObject) noEAVMapping).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- PamodelPackage.PANNOTATED_ECLASS__NO_EAV_MAPPING, null, msgs);
			if (newNoEAVMapping != null)
				msgs = ((InternalEObject) newNoEAVMapping).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
						- PamodelPackage.PANNOTATED_ECLASS__NO_EAV_MAPPING, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_ECLASS__NO_EAV_MAPPING, newNoEAVMapping, newNoEAVMapping));
	}
	...
	public EList<SequenceGenerator> getSequenceGenerators() {
		if (sequenceGenerators == null) {
			sequenceGenerators = new EObjectContainmentEList<SequenceGenerator>(SequenceGenerator.class,
					this, PamodelPackage.PANNOTATED_ECLASS__SEQUENCE_GENERATORS);
		}
			...
			if (external != oldExternal) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							PamodelPackage.PANNOTATED_ECLASS__EXTERNAL, oldExternal, external));
			}
		}
		return external;
	}
	...
	public NotificationChain basicSetCacheable(Cacheable newCacheable, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_ECLASS__CACHEABLE, oldCacheable, newCacheable);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setCacheable(Cacheable newCacheable) {
		if (newCacheable != cacheable) {
			NotificationChain msgs = null;
			if (cacheable != null)
				msgs = ((InternalEObject) cacheable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- PamodelPackage.PANNOTATED_ECLASS__CACHEABLE, null, msgs);
			if (newCacheable != null)
				msgs = ((InternalEObject) newCacheable).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
						- PamodelPackage.PANNOTATED_ECLASS__CACHEABLE, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					PamodelPackage.PANNOTATED_ECLASS__CACHEABLE, newCacheable, newCacheable));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID,
		...
		case PamodelPackage.PANNOTATED_ECLASS__PA_ESTRUCTURAL_FEATURES:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getPaEStructuralFeatures())
	...
	public void eSet(int featureID, Object newValue) {
		...
		case PamodelPackage.PANNOTATED_ECLASS__PA_ESTRUCTURAL_FEATURES:
			...
			getPaEStructuralFeatures().addAll(
					(Collection<? extends PAnnotatedEStructuralFeature>) newValue);
			return;
		case PamodelPackage.PANNOTATED_ECLASS__ATTRIBUTE_OVERRIDES:
	...
	public InheritanceType getInheritanceStrategy() {
		...
		return paSuperEntity != null ? paSuperEntity.getInheritanceStrategy()
