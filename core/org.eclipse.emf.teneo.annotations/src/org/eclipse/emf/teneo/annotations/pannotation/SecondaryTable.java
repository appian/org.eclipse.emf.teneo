 ...
 * <li>{@link org.eclipse.emf.teneo.annotations.pannotation.SecondaryTable#getCatalog <em>Catalog
 * </em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pannotation.SecondaryTable#getSchema <em>Schema
 * </em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pannotation.SecondaryTable#getPkJoinColumns <em>Pk
 * Join Columns</em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pannotation.SecondaryTable#getUniqueConstraints <em>
...
public interface SecondaryTable extends PAnnotation {
	...
	/**
	 * Returns the value of the '<em><b>Pk Join Columns</b></em>' containment reference list. The list
	 * contents are of type {@link org.eclipse.emf.teneo.annotations.pannotation.PrimaryKeyJoinColumn}
	 * . <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Pk Join Columns</em>' containment reference list isn't clear, there
