...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Secondary Table</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.emf.teneo.annotations.pannotation.impl.SecondaryTableImpl#getName <em>Name
 * </em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pannotation.impl.SecondaryTableImpl#getCatalog <em>
 * Catalog</em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pannotation.impl.SecondaryTableImpl#getSchema <em>
 * Schema</em>}</li>
 * <li>
 * {@link org.eclipse.emf.teneo.annotations.pannotation.impl.SecondaryTableImpl#getPkJoinColumns
 * <em>Pk Join Columns</em>}</li>
 * <li>
 * {@link org.eclipse.emf.teneo.annotations.pannotation.impl.SecondaryTableImpl#getUniqueConstraints
...
public class SecondaryTableImpl extends PAnnotationImpl implements SecondaryTable {
	...
	/**
	 * The cached value of the '{@link #getPkJoinColumns() <em>Pk Join Columns</em>}' containment
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					PannotationPackage.SECONDARY_TABLE__NAME, oldName, name));
	}
	...
	public void setCatalog(String newCatalog) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					PannotationPackage.SECONDARY_TABLE__CATALOG, oldCatalog, catalog));
	}
	...
	public void setSchema(String newSchema) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					PannotationPackage.SECONDARY_TABLE__SCHEMA, oldSchema, schema));
	}
	...
	public EList<PrimaryKeyJoinColumn> getPkJoinColumns() {
		if (pkJoinColumns == null) {
			pkJoinColumns = new EObjectContainmentEList<PrimaryKeyJoinColumn>(PrimaryKeyJoinColumn.class,
					this, PannotationPackage.SECONDARY_TABLE__PK_JOIN_COLUMNS);
		}
	...
	public EList<UniqueConstraint> getUniqueConstraints() {
		if (uniqueConstraints == null) {
			uniqueConstraints = new EObjectContainmentEList<UniqueConstraint>(UniqueConstraint.class,
					this, PannotationPackage.SECONDARY_TABLE__UNIQUE_CONSTRAINTS);
		}
