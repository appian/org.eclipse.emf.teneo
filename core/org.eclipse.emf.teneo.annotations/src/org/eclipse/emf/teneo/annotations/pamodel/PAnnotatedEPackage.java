 ...
 * <ul>
 * <li>{@link org.eclipse.emf.teneo.annotations.pamodel.PAnnotatedEPackage#getPaModel <em>Pa Model
 * </em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pamodel.PAnnotatedEPackage#getModelEPackage <em>
 * Model EPackage</em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pamodel.PAnnotatedEPackage#getPaEClasses <em>Pa
 * EClasses</em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pamodel.PAnnotatedEPackage#getSequenceGenerators
 * <em>Sequence Generators</em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pamodel.PAnnotatedEPackage#getTableGenerators <em>
 * Table Generators</em>}</li>
 * <li>{@link org.eclipse.emf.teneo.annotations.pamodel.PAnnotatedEPackage#getPaEDataTypes <em>Pa
 * EData Types</em>}</li>
 * <li>
...
public interface PAnnotatedEPackage extends PAnnotatedEModelElement {
	/**
	 * Returns the value of the '<em><b>Pa Model</b></em>' container reference. It is bidirectional
	 * and its opposite is '
	 * {@link org.eclipse.emf.teneo.annotations.pamodel.PAnnotatedModel#getPaEPackages
	 * <em>Pa EPackages</em>}'. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Pa Model</em>' reference isn't clear, there really should be more of
	 * a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * <em>Pa Model</em>}' container reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 ...
	 * -->
	 * <p>
	 * If the meaning of the '<em>Annotated EPackage</em>' reference isn't clear, there really should
	...
	/**
	 * Returns the value of the '<em><b>Pa EClasses</b></em>' containment reference list. The list
	 * contents are of type {@link org.eclipse.emf.teneo.annotations.pamodel.PAnnotatedEClass}. It is
	 * bidirectional and its opposite is '
	 * {@link org.eclipse.emf.teneo.annotations.pamodel.PAnnotatedEClass#getPaEPackage
	 * <em>Pa EPackage</em>}'. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Pa EClasses</em>' containment reference list isn't clear, there
	...
	/**
	 * Returns the value of the '<em><b>Table Generators</b></em>' containment reference list. The
	 * list contents are of type {@link org.eclipse.emf.teneo.annotations.pannotation.TableGenerator}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Table Generators</em>' containment reference list isn't clear, there
	 * really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the value of the '<em><b>Pa EData Types</b></em>' containment reference list. The list
	 * contents are of type {@link org.eclipse.emf.teneo.annotations.pamodel.PAnnotatedEDataType}. It
	 * is bidirectional and its opposite is '
	 * {@link org.eclipse.emf.teneo.annotations.pamodel.PAnnotatedEDataType#getPaEPackage
	 * <em>Pa EPackage</em>}'. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Pa EData Types</em>' containment reference list isn't clear, there
	 * really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the value of the '<em><b>Sequence Style Generators</b></em>' containment reference
	 * list. The list contents are of type
	 * {@link org.eclipse.emf.teneo.annotations.pannotation.SequenceStyleGenerator}. <!--
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Sequence Style Generators</em>' containment reference list isn't
