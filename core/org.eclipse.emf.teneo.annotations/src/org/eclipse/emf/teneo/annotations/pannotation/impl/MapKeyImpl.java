...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Map Key</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public class MapKeyImpl extends PAnnotationImpl implements MapKey {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PannotationPackage.MAP_KEY__NAME,
					oldName, name));
	}
