...
public interface PamodelFactory extends EFactory {
	 ...
	 * @generated
	 */
	PamodelFactory eINSTANCE = org.eclipse.emf.teneo.annotations.pamodel.impl.PamodelFactoryImpl
			.init();

	/**
	 * Returns a new object of class '<em>PAnnotated Model</em>'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>PAnnotated EPackage</em>'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>PAnnotated EClass</em>'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>PAnnotated EAttribute</em>'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>PAnnotated EData Type</em>'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>PAnnotated EReference</em>'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
