 ...
 * <ul>
 * <li>{@link org.eclipse.emf.teneo.annotations.pannotation.impl.ForeignKeyImpl#getName <em>Name
 * </em>}</li>
 * </ul>
 * </p>
 * 
...
public class ForeignKeyImpl extends PAnnotationImpl implements ForeignKey {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PannotationPackage.FOREIGN_KEY__NAME,
					oldName, name));
	}
