 ...
 */
public class EMapAuditingNoTrueEMapAction extends AbstractTestAction {
	 ...
	 * @param arg0
	 */
	public EMapAuditingNoTrueEMapAction() {
	...
	public void doAction(TestStore store) {
		...
		final HibernateTestStore testStore = (HibernateTestStore) store;
		{
			...
			for (Book bk : store.getObjects(Book.class)) {
				...
				assertEquals(TeneoAuditKind.UPDATE, auditEntries.get(2).getTeneo_audit_kind());
				final Book bkAdd = (Book) auditVersionProvider.getRevision(auditEntries.get(0));
				final Book bkUpdate1 = (Book) auditVersionProvider.getRevision(auditEntries.get(1));
				final Book bkUpdate = (Book) auditVersionProvider.getRevision(auditEntries.get(2));
...

		{
			...
			assertTrue(e3.getTeneo_previous_start() == e2.getTeneo_start());
			assertTrue(e3.getTeneo_start() == (e2.getTeneo_end() + 1));
			assertTrue(e3.getTeneo_end() == -1);

			assertTrue(e1 == auditVersionProvider.getNextEntry(e0));
			assertTrue(e0 == auditVersionProvider.getPreviousEntry(e1));
			assertTrue(e2 == auditVersionProvider.getNextEntry(e1));
			assertTrue(e3 == auditVersionProvider
