...
public interface TransientotmFactory extends EFactory {
	 ...
	 * @generated
	 */
	TransientotmFactory eINSTANCE = org.eclipse.emf.teneo.samples.emf.hibernate.transientotm.impl.TransientotmFactoryImpl
			.init();

	/**
	 * Returns a new object of class '<em>TBook</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>TWriter</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
