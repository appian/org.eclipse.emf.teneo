...
public class TransientotmPackageImpl extends EPackageImpl implements TransientotmPackage {
	...
	public static TransientotmPackage init() {
		if (isInited)
			return (TransientotmPackage) EPackage.Registry.INSTANCE
					.getEPackage(TransientotmPackage.eNS_URI);

		// Obtain or create and register package
		TransientotmPackageImpl theTransientotmPackage = (TransientotmPackageImpl) (EPackage.Registry.INSTANCE
				.getEPackage(eNS_URI) instanceof TransientotmPackageImpl ? EPackage.Registry.INSTANCE
				.getEPackage(eNS_URI) : new TransientotmPackageImpl());
	...
	public void initializePackageContents() {
		...
		initEClass(tBookEClass, TBook.class, "TBook", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getTBook_Title(), theXMLTypePackage.getString(), "title", null, 1, 1,
				TBook.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getTBook_Authors(), this.getTWriter(), null, "authors", null, 1, -1,
				TBook.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(tWriterEClass, TWriter.class, "TWriter", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getTWriter_Name(), theXMLTypePackage.getString(), "name", null, 1, 1,
				TWriter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTWriter_Book(), this.getTBook(), null, "book", null, 0, 1, TWriter.class,
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation(tBookEClass, source, new String[] { "name", "TBook", "kind", "elementOnly" });
		addAnnotation(getTBook_Title(), source, new String[] { "kind", "element", "name", "title" });
		addAnnotation(getTBook_Authors(), source, new String[] { "kind", "element", "name", "authors" });
		addAnnotation(tWriterEClass, source, new String[] { "name", "TWriter", "kind", "elementOnly" });
		addAnnotation(getTWriter_Name(), source, new String[] { "kind", "element", "name", "name" });
		addAnnotation(getTWriter_Book(), source, new String[] { "kind", "element", "name", "book" });
	}
