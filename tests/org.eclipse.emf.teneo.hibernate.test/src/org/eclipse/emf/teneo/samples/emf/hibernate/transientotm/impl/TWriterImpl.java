...
/**
 * <!-- begin-user-doc --> An implementation of the model object ' <em><b>TWriter</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link org.eclipse.emf.teneo.samples.emf.hibernate.transientotm.impl.TWriterImpl#getName <em>Name
 * </em>}</li>
 * <li>
 * {@link org.eclipse.emf.teneo.samples.emf.hibernate.transientotm.impl.TWriterImpl#getBook <em>Book
 * </em>}</li>
 * </ul>
 * </p>
 * 
...
public class TWriterImpl extends EObjectImpl implements TWriter {
	...
	/**
	 * The cached value of the '{@link #getBook() <em>Book</em>}' reference. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @see #getBook()
	 * @generated
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TransientotmPackage.TWRITER__NAME,
					oldName, name));
	}
			...
			if (book != oldBook) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							TransientotmPackage.TWRITER__BOOK, oldBook, book));
			}
		}
		return book;
	}
	...
	public void setBook(TBook newBook) {
		...
		book = newBook;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TransientotmPackage.TWRITER__BOOK,
					oldBook, book));
	}
