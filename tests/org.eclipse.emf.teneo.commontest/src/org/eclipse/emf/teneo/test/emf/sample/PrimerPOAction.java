 ...
 * </copyright>
 *
 * $Id: PrimerPOAction.java,v 1.2.2.1 2007/03/05 18:07:40 mtaal Exp $
 */
	...
	{
    	{
	        ...
	        item.setShipDate(store.getDate(new Date()));
	        ...
	        item2.setShipDate(store.getDate(new Date()));
	        ...
	        po.setOrderDate(store.getDate(new Date()));
