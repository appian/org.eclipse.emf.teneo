			...
			// retrieve both and check the content
			{
				...
				while (it.hasNext()) {
					...
					if (number.getName().compareTo("o1") == 0) {
						...
						OddComplexNumberType odd = (OddComplexNumberType) number.getMyComplexAbstractGroup()
								.getValue(0);
						...
						EvenComplexNumberType even = (EvenComplexNumberType) number.getMyComplexAbstractGroup()
								.getValue(0);
