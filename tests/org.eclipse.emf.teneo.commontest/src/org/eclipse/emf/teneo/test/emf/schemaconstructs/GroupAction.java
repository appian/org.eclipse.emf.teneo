...
public class GroupAction extends AbstractTestAction {
	...
	public void doAction(TestStore store) {
		...
		// get a featuremap all type
		{
			...
			assertEquals(all.getAllMap().getEStructuralFeature(0),
					GroupallPackage.eINSTANCE.getSimpleAllMapType_Bbb());
			assertEquals(all.getAllMap().getEStructuralFeature(1),
					GroupallPackage.eINSTANCE.getSimpleAllMapType_Aaa());
			assertEquals(all.getAllMap().getEStructuralFeature(2),
					GroupallPackage.eINSTANCE.getSimpleAllMapType_Ccc());
			store.store(all);
			store.commitTransaction();
		}
