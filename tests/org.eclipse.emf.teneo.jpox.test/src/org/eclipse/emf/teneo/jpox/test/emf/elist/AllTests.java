 ...
 * AllTests.java,v 1.4 2007/02/01 12:34:05 mtaal Exp $
 */
...
public class AllTests {
	...
	public static Test suite() {
		TestSuite suite =
				new MultiCfgTestSuite("Test for org.eclipse.emf.teneo.hibernate.test.emf.elist", JPOXTestbed.instance()
					.getConfigurations());
		// suite.addTestSuite(TestAnyModelAction.class);
