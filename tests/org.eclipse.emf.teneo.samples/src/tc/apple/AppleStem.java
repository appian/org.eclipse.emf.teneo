 ...
 * </copyright>
 *
 * $Id: AppleStem.java,v 1.1 2007/07/09 12:55:20 mtaal Exp $
 */
package tc.apple;
 ...
 * <ul>
 *   <li>{@link tc.apple.AppleStem#getBigtree <em>Bigtree</em>}</li>
 *   <li>{@link tc.apple.AppleStem#getUniqueName <em>Unique Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see tc.apple.ApplePackage#getAppleStem()
 * @model extendedMetaData="name='AppleStem' kind='elementOnly'"
 * @generated
 */
public interface AppleStem extends EObject {
	/**
	 ...
	 * @see tc.apple.ApplePackage#getAppleStem_Bigtree()
	 ...
	 * @see tc.apple.ApplePackage#getAppleStem_UniqueName()
	...
	/**
	 * Sets the value of the '{@link tc.apple.AppleStem#getUniqueName <em>Unique Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
