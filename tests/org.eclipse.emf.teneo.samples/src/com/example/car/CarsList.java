...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Cars List</b></em>'. <!--
 * end-user-doc -->
 * 
 * <p>
...
public interface CarsList extends EObject {
	/**
	 * Returns the value of the '<em><b>Car Type</b></em>' containment reference list. The list
	 * contents are of type {@link com.example.car.CarType}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Car Type</em>' containment reference list isn't clear, there really
	...
	/**
	 * Returns the value of the '<em><b>Car Link</b></em>' containment reference list. The list
	 * contents are of type {@link com.example.car.CarLink}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Car Link</em>' containment reference list isn't clear, there really
	 * should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
