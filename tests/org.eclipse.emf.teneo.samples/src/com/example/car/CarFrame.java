...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Frame</b></em>'. <!--
 * end-user-doc -->
 * 
 * <p>
...
public interface CarFrame extends EObject {
	/**
	 * Returns the value of the '<em><b>Car Wheel</b></em>' containment reference list. The list
	 * contents are of type {@link com.example.car.CarWheel}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Car Wheel</em>' containment reference list isn't clear, there really
	...
	/**
	 * Returns the value of the '<em><b>Car Link Ref</b></em>' reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Car Link Ref</em>' reference isn't clear, there really should be
	 ...
	 * @model resolveProxies="false" extendedMetaData="kind='attribute' name='carLinkRef'"
	 * @generated
	 */
	CarLink getCarLinkRef();

	/**
	 * Sets the value of the '{@link com.example.car.CarFrame#getCarLinkRef <em>Car Link Ref</em>}'
	 * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Car Link Ref</em>' reference.
	 * @see #getCarLinkRef()
	 * @generated
	 */
