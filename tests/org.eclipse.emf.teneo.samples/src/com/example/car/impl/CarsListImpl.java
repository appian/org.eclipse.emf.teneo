...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Cars List</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public class CarsListImpl extends EObjectImpl implements CarsList {
	...
	public EList<CarType> getCarType() {
		if (carType == null) {
			carType = new EObjectContainmentEList<CarType>(CarType.class, this,
					CarPackage.CARS_LIST__CAR_TYPE);
		}
		return carType;
	}
	...
	public EList<CarLink> getCarLink() {
		if (carLink == null) {
			carLink = new EObjectContainmentEList<CarLink>(CarLink.class, this,
					CarPackage.CARS_LIST__CAR_LINK);
		}
		return carLink;
	}
