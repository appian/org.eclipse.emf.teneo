...
public class TestPackageImpl extends EPackageImpl implements TestPackage {
	...
	public static TestPackage init() {
		...
		TestPackageImpl theTestPackage = (TestPackageImpl) (EPackage.Registry.INSTANCE
				.getEPackage(eNS_URI) instanceof TestPackageImpl ? EPackage.Registry.INSTANCE
				.getEPackage(eNS_URI) : new TestPackageImpl());
	...
	public void initializePackageContents() {
		...
		initEClass(adultBooksEClass, AdultBooks.class, "AdultBooks", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getAdultBooks_Title(), theXMLTypePackage.getString(), "title", null, 1, 1,
				AdultBooks.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAdultBooks_Checkedout(), theXMLTypePackage.getString(), "checkedout", null,
				1, 1, AdultBooks.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAdultBooks_Userid(), theXMLTypePackage.getString(), "userid", null, 1, 1,
				AdultBooks.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(bookDefinitionEClass, BookDefinition.class, "BookDefinition", IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getBookDefinition_Description(), theXMLTypePackage.getString(), "description",
				null, 1, 1, BookDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getBookDefinition_Location(), theXMLTypePackage.getString(), "location", null,
				1, 1, BookDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getBookDefinition_UniqueName(), theXMLTypePackage.getID(), "uniqueName", null,
				1, 1, BookDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(bookDefinitionResourceLinkEClass, BookDefinitionResourceLink.class,
				"BookDefinitionResourceLink", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getBookDefinitionResourceLink_BookSubject(), theXMLTypePackage.getString(),
				"bookSubject", null, 0, 1, BookDefinitionResourceLink.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(booksInLibEClass, BooksInLib.class, "BooksInLib", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getBooksInLib_Library(), this.getLibrary(), null, "library", null, 1, -1,
				BooksInLib.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(childrenBooksEClass, ChildrenBooks.class, "ChildrenBooks", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getChildrenBooks_Title(), theXMLTypePackage.getString(), "title", null, 1, 1,
				ChildrenBooks.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getChildrenBooks_Cartoon(), theXMLTypePackage.getString(), "cartoon", null, 1,
				1, ChildrenBooks.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getChildrenBooks_Popup(), theXMLTypePackage.getString(), "popup", null, 1, 1,
				ChildrenBooks.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getChildrenBooks_PublisherDefinitionRef(), this.getPublisherDefinition(), null,
				"publisherDefinitionRef", null, 1, 1, ChildrenBooks.class, !IS_TRANSIENT, !IS_VOLATILE,
		...
		initEReference(getDocumentRoot_XSISchemaLocation(), ecorePackage.getEStringToStringMapEntry(),
				...
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDocumentRoot_AbstractBookDefinition(), this.getBookDefinition(), null,
				"abstractBookDefinition", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getDocumentRoot_AdultBooks(), this.getAdultBooks(), null, "adultBooks", null, 0,
				-2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getDocumentRoot_Booksinlib(), this.getBooksInLib(), null, "booksinlib", null, 0,
				-2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getDocumentRoot_ChildrenBooks(), this.getChildrenBooks(), null, "childrenBooks",
				null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEReference(getDocumentRoot_PublisherDefinition(), this.getPublisherDefinition(), null,
				"publisherDefinition", null, 0, -2, null, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);

		initEClass(libraryEClass, Library.class, "Library", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getLibrary_Library(), this.getLibrary(), null, "library", null, 0, -1,
				Library.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLibrary_AbstractBookDefinitionGroup(), ecorePackage.getEFeatureMapEntry(),
				"abstractBookDefinitionGroup", null, 0, -1, Library.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getLibrary_AbstractBookDefinition(), this.getBookDefinition(), null,
				"abstractBookDefinition", null, 0, -1, Library.class, IS_TRANSIENT, IS_VOLATILE,
				!IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getLibrary_UniqueName(), theXMLTypePackage.getID(), "uniqueName", null, 1, 1,
				Library.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(publisherDefinitionEClass, PublisherDefinition.class, "PublisherDefinition",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getPublisherDefinition_Title(), theXMLTypePackage.getString(), "title", null, 0,
				1, PublisherDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE,
				!IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPublisherDefinition_ResourceLink(), this.getBookDefinitionResourceLink(),
				null, "resourceLink", null, 1, 1, PublisherDefinition.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		initEClass(resourceLinkEClass, ResourceLink.class, "ResourceLink", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getResourceLink_Name(), theXMLTypePackage.getString(), "name", null, 1, 1,
				ResourceLink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation(adultBooksEClass, source, new String[] { "name", "AdultBooks", "kind",
				"elementOnly" });
		addAnnotation(getAdultBooks_Title(), source, new String[] { "kind", "element", "name", "title",
				"namespace", "##targetNamespace" });
		addAnnotation(getAdultBooks_Checkedout(), source, new String[] { "kind", "element", "name",
				"checkedout", "namespace", "##targetNamespace" });
		addAnnotation(getAdultBooks_Userid(), source, new String[] { "kind", "element", "name",
				"userid", "namespace", "##targetNamespace" });
		addAnnotation(bookDefinitionEClass, source, new String[] { "name", "BookDefinition", "kind",
				"elementOnly" });
		addAnnotation(getBookDefinition_Description(), source, new String[] { "kind", "element",
				"name", "description", "namespace", "##targetNamespace" });
		addAnnotation(getBookDefinition_Location(), source, new String[] { "kind", "element", "name",
				"location", "namespace", "##targetNamespace" });
		addAnnotation(getBookDefinition_UniqueName(), source, new String[] { "kind", "attribute",
				"name", "uniqueName" });
		addAnnotation(bookDefinitionResourceLinkEClass, source, new String[] { "name",
				"BookDefinitionResourceLink", "kind", "empty" });
		addAnnotation(getBookDefinitionResourceLink_BookSubject(), source, new String[] { "kind",
				"attribute", "name", "bookSubject" });
		addAnnotation(booksInLibEClass, source, new String[] { "name", "BooksInLib", "kind",
				"elementOnly" });
		addAnnotation(getBooksInLib_Library(), source, new String[] { "kind", "element", "name",
				"library", "namespace", "##targetNamespace" });
		addAnnotation(childrenBooksEClass, source, new String[] { "name", "ChildrenBooks", "kind",
				"elementOnly" });
		addAnnotation(getChildrenBooks_Title(), source, new String[] { "kind", "element", "name",
				"title", "namespace", "##targetNamespace" });
		addAnnotation(getChildrenBooks_Cartoon(), source, new String[] { "kind", "element", "name",
				"cartoon", "namespace", "##targetNamespace" });
		addAnnotation(getChildrenBooks_Popup(), source, new String[] { "kind", "element", "name",
				"popup", "namespace", "##targetNamespace" });
		addAnnotation(getChildrenBooks_PublisherDefinitionRef(), source, new String[] { "kind",
				"attribute", "name", "publisherDefinitionRef" });
		...
		addAnnotation(getDocumentRoot_AbstractBookDefinition(), source, new String[] { "kind",
				"element", "name", "abstract-book-definition", "namespace", "##targetNamespace" });
		addAnnotation(getDocumentRoot_AdultBooks(), source,
				new String[] { "kind", "element", "name", "adult-books", "namespace", "##targetNamespace",
						"affiliation", "abstract-book-definition" });
		addAnnotation(getDocumentRoot_Booksinlib(), source, new String[] { "kind", "element", "name",
				"booksinlib", "namespace", "##targetNamespace" });
		addAnnotation(getDocumentRoot_ChildrenBooks(), source, new String[] { "kind", "element",
				"name", "children-books", "namespace", "##targetNamespace", "affiliation",
				"abstract-book-definition" });
		addAnnotation(getDocumentRoot_PublisherDefinition(), source, new String[] { "kind", "element",
				"name", "publisher-definition", "namespace", "##targetNamespace", "affiliation",
				"abstract-book-definition" });
		addAnnotation(libraryEClass, source, new String[] { "name", "Library", "kind", "elementOnly" });
		addAnnotation(getLibrary_Library(), source, new String[] { "kind", "element", "name",
				"library", "namespace", "##targetNamespace" });
		addAnnotation(getLibrary_AbstractBookDefinitionGroup(), source, new String[] { "kind", "group",
				"name", "abstract-book-definition:group", "namespace", "##targetNamespace" });
		addAnnotation(getLibrary_AbstractBookDefinition(), source, new String[] { "kind", "element",
				"name", "abstract-book-definition", "namespace", "##targetNamespace", "group",
				"abstract-book-definition:group" });
		addAnnotation(getLibrary_UniqueName(), source, new String[] { "kind", "attribute", "name",
				"uniqueName" });
		addAnnotation(publisherDefinitionEClass, source, new String[] { "name", "PublisherDefinition",
				"kind", "elementOnly" });
		addAnnotation(getPublisherDefinition_Title(), source, new String[] { "kind", "element", "name",
				"title", "namespace", "##targetNamespace" });
		addAnnotation(getPublisherDefinition_ResourceLink(), source, new String[] { "kind", "element",
				"name", "resource-link", "namespace", "##targetNamespace" });
		addAnnotation(resourceLinkEClass, source, new String[] { "name", "ResourceLink", "kind",
				"empty" });
		addAnnotation(getResourceLink_Name(), source, new String[] { "kind", "attribute", "name",
				"name" });
	}
