 ...
 * <ul>
 * <li>
 * {@link com.ibm.websphere.appserver.schemas._6._0.ibm.portal.test.impl.DocumentRootImpl#getMixed
 * <em>Mixed</em>}</li>
 * <li>
 * {@link com.ibm.websphere.appserver.schemas._6._0.ibm.portal.test.impl.DocumentRootImpl#getXMLNSPrefixMap
 * <em>XMLNS Prefix Map</em>}</li>
 * <li>
 * {@link com.ibm.websphere.appserver.schemas._6._0.ibm.portal.test.impl.DocumentRootImpl#getXSISchemaLocation
 * <em>XSI Schema Location</em>}</li>
 * <li>
 * {@link com.ibm.websphere.appserver.schemas._6._0.ibm.portal.test.impl.DocumentRootImpl#getAbstractBookDefinition
 * <em>Abstract Book Definition</em>}</li>
 * <li>
 * {@link com.ibm.websphere.appserver.schemas._6._0.ibm.portal.test.impl.DocumentRootImpl#getAdultBooks
 * <em>Adult Books</em>}</li>
 * <li>
 * {@link com.ibm.websphere.appserver.schemas._6._0.ibm.portal.test.impl.DocumentRootImpl#getBooksinlib
 * <em>Booksinlib</em>}</li>
 * <li>
 * {@link com.ibm.websphere.appserver.schemas._6._0.ibm.portal.test.impl.DocumentRootImpl#getChildrenBooks
 * <em>Children Books</em>}</li>
 * <li>
 * {@link com.ibm.websphere.appserver.schemas._6._0.ibm.portal.test.impl.DocumentRootImpl#getPublisherDefinition
 * <em>Publisher Definition</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class DocumentRootImpl extends EObjectImpl implements DocumentRoot {
	...
	public EMap<String, String> getXMLNSPrefixMap() {
		if (xMLNSPrefixMap == null) {
			xMLNSPrefixMap = new EcoreEMap<String, String>(
					...
					this, TestPackage.DOCUMENT_ROOT__XMLNS_PREFIX_MAP);
		}
	...
	public EMap<String, String> getXSISchemaLocation() {
		if (xSISchemaLocation == null) {
			xSISchemaLocation = new EcoreEMap<String, String>(
					EcorePackage.Literals.ESTRING_TO_STRING_MAP_ENTRY, EStringToStringMapEntryImpl.class,
					this, TestPackage.DOCUMENT_ROOT__XSI_SCHEMA_LOCATION);
		}
	...
	public BookDefinition getAbstractBookDefinition() {
		return (BookDefinition) getMixed().get(
				TestPackage.Literals.DOCUMENT_ROOT__ABSTRACT_BOOK_DEFINITION, true);
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetAbstractBookDefinition(BookDefinition newAbstractBookDefinition,
			NotificationChain msgs) {
		return ((FeatureMap.Internal) getMixed()).basicAdd(
				TestPackage.Literals.DOCUMENT_ROOT__ABSTRACT_BOOK_DEFINITION, newAbstractBookDefinition,
				msgs);
	}
	...
	public NotificationChain basicSetAdultBooks(AdultBooks newAdultBooks, NotificationChain msgs) {
		return ((FeatureMap.Internal) getMixed()).basicAdd(
				TestPackage.Literals.DOCUMENT_ROOT__ADULT_BOOKS, newAdultBooks, msgs);
	}
	...
	public void setAdultBooks(AdultBooks newAdultBooks) {
		((FeatureMap.Internal) getMixed()).set(TestPackage.Literals.DOCUMENT_ROOT__ADULT_BOOKS,
				newAdultBooks);
	}
	...
	public NotificationChain basicSetBooksinlib(BooksInLib newBooksinlib, NotificationChain msgs) {
		return ((FeatureMap.Internal) getMixed()).basicAdd(
				TestPackage.Literals.DOCUMENT_ROOT__BOOKSINLIB, newBooksinlib, msgs);
	}
	...
	public void setBooksinlib(BooksInLib newBooksinlib) {
		((FeatureMap.Internal) getMixed()).set(TestPackage.Literals.DOCUMENT_ROOT__BOOKSINLIB,
				newBooksinlib);
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetChildrenBooks(ChildrenBooks newChildrenBooks,
			NotificationChain msgs) {
		return ((FeatureMap.Internal) getMixed()).basicAdd(
				TestPackage.Literals.DOCUMENT_ROOT__CHILDREN_BOOKS, newChildrenBooks, msgs);
	}
	...
	public void setChildrenBooks(ChildrenBooks newChildrenBooks) {
		((FeatureMap.Internal) getMixed()).set(TestPackage.Literals.DOCUMENT_ROOT__CHILDREN_BOOKS,
				newChildrenBooks);
	}
	...
	public PublisherDefinition getPublisherDefinition() {
		return (PublisherDefinition) getMixed().get(
				TestPackage.Literals.DOCUMENT_ROOT__PUBLISHER_DEFINITION, true);
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetPublisherDefinition(PublisherDefinition newPublisherDefinition,
			NotificationChain msgs) {
		return ((FeatureMap.Internal) getMixed()).basicAdd(
				TestPackage.Literals.DOCUMENT_ROOT__PUBLISHER_DEFINITION, newPublisherDefinition, msgs);
	}
	...
	public void setPublisherDefinition(PublisherDefinition newPublisherDefinition) {
		((FeatureMap.Internal) getMixed()).set(
				TestPackage.Literals.DOCUMENT_ROOT__PUBLISHER_DEFINITION, newPublisherDefinition);
	}
