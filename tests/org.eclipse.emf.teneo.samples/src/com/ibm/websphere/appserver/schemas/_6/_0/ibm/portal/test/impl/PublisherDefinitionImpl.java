 ...
 * <em><b>Publisher Definition</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link com.ibm.websphere.appserver.schemas._6._0.ibm.portal.test.impl.PublisherDefinitionImpl#getTitle
 * <em>Title</em>}</li>
 * <li>
 * {@link com.ibm.websphere.appserver.schemas._6._0.ibm.portal.test.impl.PublisherDefinitionImpl#getResourceLink
 * <em>Resource Link</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class PublisherDefinitionImpl extends BookDefinitionImpl implements PublisherDefinition {
	...
	/**
	 * The cached value of the '{@link #getResourceLink() <em>Resource Link</em>}' containment
	...
	public void setTitle(String newTitle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TestPackage.PUBLISHER_DEFINITION__TITLE, oldTitle, title));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetResourceLink(BookDefinitionResourceLink newResourceLink,
			NotificationChain msgs) {
		BookDefinitionResourceLink oldResourceLink = resourceLink;
		resourceLink = newResourceLink;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					TestPackage.PUBLISHER_DEFINITION__RESOURCE_LINK, oldResourceLink, newResourceLink);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setResourceLink(BookDefinitionResourceLink newResourceLink) {
		if (newResourceLink != resourceLink) {
			...
			if (resourceLink != null)
				msgs = ((InternalEObject) resourceLink).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- TestPackage.PUBLISHER_DEFINITION__RESOURCE_LINK, null, msgs);
			if (newResourceLink != null)
				msgs = ((InternalEObject) newResourceLink).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
						- TestPackage.PUBLISHER_DEFINITION__RESOURCE_LINK, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					TestPackage.PUBLISHER_DEFINITION__RESOURCE_LINK, newResourceLink, newResourceLink));
	}
