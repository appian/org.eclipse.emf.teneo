...
public interface TestFactory extends EFactory {
	 ...
	 * @generated
	 */
	TestFactory eINSTANCE = com.ibm.websphere.appserver.schemas._6._0.ibm.portal.test.impl.TestFactoryImpl
			.init();

	/**
	 * Returns a new object of class '<em>Adult Books</em>'. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Book Definition Resource Link</em>'. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Books In Lib</em>'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Children Books</em>'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Publisher Definition</em>'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
