 ...
 * <ul>
 * <li>{@link com.ibm.websphere.appserver.schemas._6._0.ibm.portal.test.Library#getLibrary <em>
 * Library</em>}</li>
 * <li>
 ...
 * <li>{@link com.ibm.websphere.appserver.schemas._6._0.ibm.portal.test.Library#getUniqueName <em>
 * Unique Name</em>}</li>
 * </ul>
 * </p>
 * 
...
public interface Library extends EObject {
	 ...
	 * contents are of type {@link com.ibm.websphere.appserver.schemas._6._0.ibm.portal.test.Library}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Library</em>' containment reference list isn't clear, there really
	...
	/**
	 * Returns the value of the '<em><b>Abstract Book Definition Group</b></em>' attribute list. The
	 ...
	 *        extendedMetaData
	 *        ="kind='group' name='abstract-book-definition:group' namespace='##targetNamespace'"
	 * @generated
	 */
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Abstract Book Definition</em>' containment reference list isn't
	 ...
	 *        extendedMetaData=
	 *        "kind='element' name='abstract-book-definition' namespace='##targetNamespace' group='abstract-book-definition:group'"
	 * @generated
	 */
	EList<BookDefinition> getAbstractBookDefinition();

	/**
	 * Returns the value of the '<em><b>Unique Name</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Unique Name</em>' attribute isn't clear, there really should be more
	 ...
	 * <em>Unique Name</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
