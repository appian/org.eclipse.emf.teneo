...
public interface Person extends Temporal {
	...
	/**
	 * Sets the value of the '{@link fleet.Person#getId <em>Id</em>}' attribute. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Returns the value of the '<em><b>Employed</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Employed</em>' attribute isn't clear, there really should be more of
	 * a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * 
	 * @param value
	 *          the new value of the '<em>Employed</em>' attribute.
	 * @see #isEmployed()
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Addresses</b></em>' containment reference list. The list
	 * contents are of type {@link fleet.Address}. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Returns the value of the '<em><b>Owned Vehicles</b></em>' reference list. The list contents are
	 * of type {@link fleet.VehicleInfo}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Owned Vehicles</em>' reference list isn't clear, there really should
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Birth Address</em>' containment reference isn't clear, there really
	...
	/**
	 * Sets the value of the '{@link fleet.Person#getBirthAddress <em>Birth Address</em>}' containment
	 * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Birth Address</em>' containment reference.
	 * @see #getBirthAddress()
	 * @generated
	 */
