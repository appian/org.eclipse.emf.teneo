 ...
 * <li>{@link testinheritance.impl.SomeOtherBaseClassImpl#getNameValuePairs <em>Name Value Pairs
 * </em>}</li>
 * </ul>
 * </p>
 * 
	...
	public void setProperty(String newProperty) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TestinheritancePackage.SOME_OTHER_BASE_CLASS__PROPERTY, oldProperty, property));
	}
	...
	public EList<NameValuePair> getNameValuePairs() {
		if (nameValuePairs == null) {
			nameValuePairs = new EObjectResolvingEList<NameValuePair>(NameValuePair.class, this,
					TestinheritancePackage.SOME_OTHER_BASE_CLASS__NAME_VALUE_PAIRS);
		}
