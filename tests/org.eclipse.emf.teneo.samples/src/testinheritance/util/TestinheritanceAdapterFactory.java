...
public class TestinheritanceAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected TestinheritanceSwitch<Adapter> modelSwitch = new TestinheritanceSwitch<Adapter>() {
		@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link testinheritance.SomeResource
	 * <em>Some Resource</em>}'. <!-- begin-user-doc --> This default implementation returns null so
	...
	/**
	 * Creates a new adapter for an object of class '{@link testinheritance.SomeBaseClass
	 * <em>Some Base Class</em>}'. <!-- begin-user-doc --> This default implementation returns null so
	 * that we can easily ignore cases; it's useful to ignore a case when inheritance will catch all
	 * the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '{@link testinheritance.SomeOtherBaseClass
	 * <em>Some Other Base Class</em>}'. <!-- begin-user-doc --> This default implementation returns
	...
	/**
	 * Creates a new adapter for an object of class '{@link testinheritance.NameValuePair
	 * <em>Name Value Pair</em>}'. <!-- begin-user-doc --> This default implementation returns null so
	 * that we can easily ignore cases; it's useful to ignore a case when inheritance will catch all
	 * the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '{@link testinheritance.ParentOne
	 * <em>Parent One</em>}'. <!-- begin-user-doc --> This default implementation returns null so that
	...
	/**
	 * Creates a new adapter for an object of class '{@link testinheritance.ParentTwo
	 * <em>Parent Two</em>}'. <!-- begin-user-doc --> This default implementation returns null so that
	 * we can easily ignore cases; it's useful to ignore a case when inheritance will catch all the
	 * cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '{@link testinheritance.ParentZero
	 * <em>Parent Zero</em>}'. <!-- begin-user-doc --> This default implementation returns null so
	 * that we can easily ignore cases; it's useful to ignore a case when inheritance will catch all
	 * the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '{@link testinheritance.SomeReference
	 * <em>Some Reference</em>}'. <!-- begin-user-doc --> This default implementation returns null so
	 * that we can easily ignore cases; it's useful to ignore a case when inheritance will catch all
	 * the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
