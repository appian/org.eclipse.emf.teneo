...
public class TestinheritanceSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case TestinheritancePackage.SOME_RESOURCE: {
			...
			if (result == null)
				result = caseSomeBaseClass(someResource);
			if (result == null)
				result = caseSomeOtherBaseClass(someResource);
			if (result == null)
		...
		case TestinheritancePackage.CHILD: {
			...
			if (result == null)
				result = caseParentZero(child);
			if (result == null)
				result = caseParentTwo(child);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case TestinheritancePackage.CHILD2: {
			...
			if (result == null)
				result = caseParentZero(child2);
			if (result == null)
				result = caseParentOne(child2);
			if (result == null)
				result = caseParentTwo(child2);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case TestinheritancePackage.SOME_REFERENCE: {
			...
			T result = caseSomeReference(someReference);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * @generated
	 */
	public T caseSomeReference(SomeReference object) {
		return null;
	}
