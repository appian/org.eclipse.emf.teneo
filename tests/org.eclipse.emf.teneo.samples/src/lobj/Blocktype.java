...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Blocktype</b></em>'. <!--
 * end-user-doc -->
 * 
 * <p>
...
public interface Blocktype extends EObject {
	...
	/**
	 * Sets the value of the '{@link lobj.Blocktype#getCreationDate <em>Creation Date</em>}'
	...
	/**
	 * Returns the value of the '<em><b>Style Ref</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Style Ref</em>' attribute isn't clear, there really should be more
	 * of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * 
	 * @param value
	 *          the new value of the '<em>Style Ref</em>' attribute.
	 * @see #getStyleRef()
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Domains</b></em>' reference list. The list contents are of
	 * type {@link lobj.Domain}. It is bidirectional and its opposite is '
	 * {@link lobj.Domain#getBlocktypes <em>Blocktypes</em>}'. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Domains</em>' reference list isn't clear, there really should be
	 * more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link lobj.Blocktype#getId <em>Id</em>}' attribute. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @param value
