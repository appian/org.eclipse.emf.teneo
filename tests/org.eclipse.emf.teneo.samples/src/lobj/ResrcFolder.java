...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Resrc Folder</b></em>'. <!--
 * end-user-doc -->
 * 
 * <p>
...
public interface ResrcFolder extends LearningObject {
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Folder Meta</em>' containment reference isn't clear, there really
	...
	/**
	 * Sets the value of the '{@link lobj.ResrcFolder#getFolderMeta <em>Folder Meta</em>}' containment
	 * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Folder Meta</em>' containment reference.
	 * @see #getFolderMeta()
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Resrc Folder</b></em>' containment reference list. The list
	 * contents are of type {@link lobj.ResrcFolder}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Resrc Folder</em>' containment reference list isn't clear, there
	...
	/**
	 * Sets the value of the '{@link lobj.ResrcFolder#getAccessControl <em>Access Control</em>}'
	...
	/**
	 * Returns the value of the '<em><b>Delete Scheduled</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Delete Scheduled</em>' attribute isn't clear, there really should be
	...
	/**
	 * Sets the value of the '{@link lobj.ResrcFolder#isDeleteScheduled <em>Delete Scheduled</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Delete Scheduled</em>' attribute.
	...
	/**
	 * Returns the value of the '<em><b>Resrc File</b></em>' containment reference list. The list
	 * contents are of type {@link lobj.ResrcFile}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Resrc File</em>' containment reference list isn't clear, there
	 * really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
