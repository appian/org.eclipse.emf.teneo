...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Corr Block</b></em>'. <!--
 * end-user-doc -->
 * 
 * <p>
...
public interface CorrBlock extends EObject {
	/**
	 * Returns the value of the '<em><b>Presentation Block</b></em>' containment reference list. The
	 * list contents are of type {@link lobj.PresentationBlock}. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link lobj.CorrBlock#getId <em>Id</em>}' attribute. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @param value
