...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Block Folder</b></em>'. <!--
 * end-user-doc -->
 * 
 * <p>
...
public interface BlockFolder extends LearningObject {
	...
	/**
	 * Sets the value of the '{@link lobj.BlockFolder#getFolderMeta <em>Folder Meta</em>}' containment
	...
	/**
	 * Returns the value of the '<em><b>Block Folder</b></em>' containment reference list. The list
	 * contents are of type {@link lobj.BlockFolder}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Block Folder</em>' containment reference list isn't clear, there
	...
	/**
	 * Returns the value of the '<em><b>Block</b></em>' containment reference list. The list contents
	 * are of type {@link lobj.Block}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Block</em>' containment reference list isn't clear, there really
	 * should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link lobj.BlockFolder#getAccessControl <em>Access Control</em>}'
