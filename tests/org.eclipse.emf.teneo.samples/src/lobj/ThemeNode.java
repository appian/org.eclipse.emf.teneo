...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Theme Node</b></em>'. <!--
 * end-user-doc -->
 * 
 * <p>
...
public interface ThemeNode extends Node {
	/**
	 * Returns the value of the '<em><b>Theme</b></em>' containment reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Theme</em>' containment reference isn't clear, there really should
	 ...
	 * 
	 * @param value
	 *          the new value of the '<em>Theme</em>' containment reference.
	 * @see #getTheme()
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Childnodes</b></em>' containment reference list. The list
	 * contents are of type {@link lobj.Node}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Childnodes</em>' containment reference list isn't clear, there
