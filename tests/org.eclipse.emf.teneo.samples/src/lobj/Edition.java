...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Edition</b></em>'. <!--
 * end-user-doc -->
 * 
 * <p>
...
public interface Edition extends EObject {
	/**
	 * Returns the value of the '<em><b>Edition Nr</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Edition Nr</em>' attribute isn't clear, there really should be more
	 ...
	 * 
	 * @param value
	 *          the new value of the '<em>Edition Nr</em>' attribute.
	 * @see #getEditionNr()
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Edited By</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Edited By</em>' attribute isn't clear, there really should be more
	 * of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * 
	 * @param value
	 *          the new value of the '<em>Edited By</em>' attribute.
	 * @see #getEditedBy()
	 * @generated
	 */
	...
	/**
	 * Returns whether the value of the '{@link lobj.Edition#isVersion <em>Version</em>}' attribute is
	...
	/**
	 * Returns the value of the '<em><b>Last Version Number</b></em>' attribute. <!-- begin-user-doc
	 * -->
	 * <p>
	 * If the meaning of the '<em>Last Version Number</em>' attribute isn't clear, there really should
	...
	/**
	 * Sets the value of the '{@link lobj.Edition#getLastVersionNumber <em>Last Version Number</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Last Version Number</em>' attribute.
	...
	/**
	 * Returns the value of the '<em><b>Edition Creation Date</b></em>' attribute. <!-- begin-user-doc
	 * -->
	 * <p>
	 * If the meaning of the '<em>Edition Creation Date</em>' attribute isn't clear, there really
	...
	/**
	 * Sets the value of the '{@link lobj.Edition#getEditionCreationDate
	 * <em>Edition Creation Date</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Edition Creation Date</em>' attribute.
	...
	/**
	 * Sets the value of the '{@link lobj.Edition#getId <em>Id</em>}' attribute. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @param value
