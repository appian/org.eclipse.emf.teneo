...
public class LobjSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		...
		case LobjPackage.BLOCK: {
			...
			if (result == null)
				result = caseLearningObject(block);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case LobjPackage.HYPERTEXT_BLOCK: {
			...
			if (result == null)
				result = caseBlock(hypertextBlock);
			if (result == null)
				result = caseLearningObject(hypertextBlock);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case LobjPackage.ABSTRACT_CONTENT: {
			...
			if (result == null)
				result = caseLearningObject(abstractContent);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case LobjPackage.HYPERTEXT_CONTENT: {
			...
			if (result == null)
				result = caseAbstractContent(hypertextContent);
			if (result == null)
				result = caseLearningObject(hypertextContent);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case LobjPackage.BLOCK_FOLDER: {
			...
			if (result == null)
				result = caseLearningObject(blockFolder);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case LobjPackage.CATEGORY: {
			...
			if (result == null)
				result = caseLearningObject(category);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case LobjPackage.COURSE: {
			...
			if (result == null)
				result = caseLearningObject(course);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case LobjPackage.LEARNING_UNIT: {
			...
			if (result == null)
				result = caseLearningObject(learningUnit);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case LobjPackage.LU_FOLDER: {
			...
			if (result == null)
				result = caseLearningObject(luFolder);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case LobjPackage.MODULE: {
			...
			if (result == null)
				result = caseLearningObject(module);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case LobjPackage.MODULE_FOLDER: {
			...
			if (result == null)
				result = caseLearningObject(moduleFolder);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case LobjPackage.RESRC_FOLDER: {
			...
			if (result == null)
				result = caseLearningObject(resrcFolder);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case LobjPackage.THEME: {
			...
			if (result == null)
				result = caseLearningObject(theme);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case LobjPackage.RESRC_FILE: {
			...
			if (result == null)
				result = caseLearningObject(resrcFile);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case LobjPackage.BLOCK_AUDIOFILE: {
			...
			if (result == null)
				result = caseLearningObject(blockAudiofile);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case LobjPackage.BLOCK_META: {
			...
			if (result == null)
				result = caseLearningObject(blockMeta);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case LobjPackage.COURSE_META: {
			...
			if (result == null)
				result = caseLearningObject(courseMeta);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case LobjPackage.DIDAC_META: {
			...
			if (result == null)
				result = caseSimpleDidacMeta(didacMeta);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case LobjPackage.FOLDER_META: {
			...
			if (result == null)
				result = caseLearningObject(folderMeta);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case LobjPackage.LU_META: {
			...
			if (result == null)
				result = caseLearningObject(luMeta);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case LobjPackage.RESRC_META: {
			...
			if (result == null)
				result = caseLearningObject(resrcMeta);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case LobjPackage.MODULE_META: {
			...
			if (result == null)
				result = caseLearningObject(moduleMeta);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
