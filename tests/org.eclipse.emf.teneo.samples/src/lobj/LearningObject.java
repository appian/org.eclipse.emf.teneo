...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Learning Object</b></em>'.
 * <!-- end-user-doc -->
 * 
 * <p>
...
public interface LearningObject extends EObject {
	 ...
	 * <p>
	 * If the meaning of the '<em>Timestamp</em>' attribute isn't clear, there really should be more
	 ...
	 * @model unique="false" required="true" extendedMetaData="kind='attribute'"
	 * @generated
	 */
	Date getTimestamp();
	 ...
	 * <p>
	 * If the meaning of the '<em>Synchronized</em>' attribute isn't clear, there really should be
	...
	/**
	 * Sets the value of the '{@link lobj.LearningObject#isSynchronized <em>Synchronized</em>}'
