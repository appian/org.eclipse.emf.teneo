...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Block Audiofile</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class BlockAudiofileImpl extends LearningObjectImpl implements BlockAudiofile {
	...
	public void setFile(byte[] newFile) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.BLOCK_AUDIOFILE__FILE,
					oldFile, file));
	}
	...
	public void setOriginalextension(String newOriginalextension) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					LobjPackage.BLOCK_AUDIOFILE__ORIGINALEXTENSION, oldOriginalextension, originalextension));
	}
	...
	public void setFilesize(int newFilesize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.BLOCK_AUDIOFILE__FILESIZE,
	...
	public void setResrcHref(String newResrcHref) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					LobjPackage.BLOCK_AUDIOFILE__RESRC_HREF, oldResrcHref, resrcHref));
	}
			...
			if (resrcFiletype != oldResrcFiletype) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							LobjPackage.BLOCK_AUDIOFILE__RESRC_FILETYPE, oldResrcFiletype, resrcFiletype));
			}
		}
