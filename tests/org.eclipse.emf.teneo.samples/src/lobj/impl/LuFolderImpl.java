...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Lu Folder</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public class LuFolderImpl extends LearningObjectImpl implements LuFolder {
	...
	/**
	 * The cached value of the '{@link #getLearningUnit() <em>Learning Unit</em>}' containment
	...
	public NotificationChain basicSetFolderMeta(FolderMeta newFolderMeta, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					LobjPackage.LU_FOLDER__FOLDER_META, oldFolderMeta, newFolderMeta);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newFolderMeta != folderMeta) {
			...
			if (folderMeta != null)
				msgs = ((InternalEObject) folderMeta).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- LobjPackage.LU_FOLDER__FOLDER_META, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.LU_FOLDER__FOLDER_META,
	...
	public EList getLearningUnit() {
		if (learningUnit == null) {
			learningUnit = new EObjectContainmentEList(LearningUnit.class, this,
					LobjPackage.LU_FOLDER__LEARNING_UNIT);
		}
		return learningUnit;
	}
	...
	public NotificationChain basicSetAccessControl(AccessControl newAccessControl,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					LobjPackage.LU_FOLDER__ACCESS_CONTROL, oldAccessControl, newAccessControl);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newAccessControl != accessControl) {
			...
			if (accessControl != null)
				msgs = ((InternalEObject) accessControl).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- LobjPackage.LU_FOLDER__ACCESS_CONTROL, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.LU_FOLDER__ACCESS_CONTROL,
