...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Userauthorization</b></em>
 * '. <!-- end-user-doc -->
 * <p>
...
public class UserauthorizationImpl extends EObjectImpl implements Userauthorization {
	/**
	 * The cached value of the '{@link #getUser() <em>User</em>}' reference. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @see #getUser()
	 * @generated
			...
			if (user != oldUser) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							LobjPackage.USERAUTHORIZATION__USER, oldUser, user));
			}
		}
		return user;
	}
	...
	public void setUser(User newUser) {
		...
		user = newUser;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.USERAUTHORIZATION__USER,
					oldUser, user));
	}
	...
	public AuthorizationTypes getAuthType() {
		if (authType != null && authType.eIsProxy()) {
			...
			if (authType != oldAuthType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							LobjPackage.USERAUTHORIZATION__AUTH_TYPE, oldAuthType, authType));
			}
		}
		return authType;
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.USERAUTHORIZATION__ID,
					oldId, id));
	}
