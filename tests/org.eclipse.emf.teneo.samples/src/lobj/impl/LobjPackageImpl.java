 ...
 * </copyright>
 *
 * $Id: LobjPackageImpl.java,v 1.3 2007/03/28 13:56:58 mtaal Exp $
 */
package lobj.impl;
...
public class LobjPackageImpl extends EPackageImpl implements LobjPackage {
	...
	public void createPackageContents() {
		...
		createEReference(abstractContentEClass, ABSTRACT_CONTENT__SOURCE);
		...
		createEAttribute(corrBlockEClass, CORR_BLOCK__ID);
		...
		createEAttribute(presentationBlockEClass, PRESENTATION_BLOCK__ID);
		...
		createEReference(resrcFileEClass, RESRC_FILE__SOURCE);
		createEReference(resrcFileEClass, RESRC_FILE__HYPERTEXT_CONTENT);
		createEReference(resrcFileEClass, RESRC_FILE__RESRC_META);
		...
		createEAttribute(resrcFiletypeEClass, RESRC_FILETYPE__ID);
		...
		createEAttribute(accessControlEClass, ACCESS_CONTROL__ID);
		...
		createEAttribute(affiliationEClass, AFFILIATION__ID);
		...
		createEAttribute(blocktypeEClass, BLOCKTYPE__ID);
		...
		createEAttribute(titleMetaEClass, TITLE_META__ID);
		...
		createEAttribute(simpleDidacMetaEClass, SIMPLE_DIDAC_META__ID);
		...
		createEAttribute(editionEClass, EDITION__VERSION);
		...
		createEAttribute(editionEClass, EDITION__ID);
		...
		createEAttribute(userauthorizationEClass, USERAUTHORIZATION__ID);
		...
		createEAttribute(publishInfoEClass, PUBLISH_INFO__ID);
		...
		createEAttribute(sharednotesEClass, SHAREDNOTES__ID);
		...
		createEAttribute(coursetypeEClass, COURSETYPE__ID);
		...
		createEAttribute(externalMetadataEClass, EXTERNAL_METADATA__ID);
		...
		createEAttribute(precognitionEClass, PRECOGNITION__ID);
		...
		createEAttribute(internalRefEClass, INTERNAL_REF__ID);
		...
		createEAttribute(sourceEClass, SOURCE__PUBLISH_DATE);
		...
		createEAttribute(authorizationTypesEClass, AUTHORIZATION_TYPES__ID);
