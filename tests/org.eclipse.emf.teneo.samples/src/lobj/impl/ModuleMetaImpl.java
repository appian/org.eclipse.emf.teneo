...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Module Meta</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public class ModuleMetaImpl extends LearningObjectImpl implements ModuleMeta {
	...
	public EList getDidacMeta() {
		if (didacMeta == null) {
			didacMeta = new EObjectContainmentEList(DidacMeta.class, this,
					LobjPackage.MODULE_META__DIDAC_META);
		}
		return didacMeta;
	}
	...
	public void setCreationDate(Date newCreationDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.MODULE_META__CREATION_DATE,
	...
	public NotificationChain basicSetPublishInfo(PublishInfo newPublishInfo, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					LobjPackage.MODULE_META__PUBLISH_INFO, oldPublishInfo, newPublishInfo);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newPublishInfo != publishInfo) {
			...
			if (publishInfo != null)
				msgs = ((InternalEObject) publishInfo).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- LobjPackage.MODULE_META__PUBLISH_INFO, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.MODULE_META__PUBLISH_INFO,
			...
			if (defLang != oldDefLang) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							LobjPackage.MODULE_META__DEF_LANG, oldDefLang, defLang));
			}
		}
		return defLang;
	}
	...
	public void setDefLang(Language newDefLang) {
		...
		defLang = newDefLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.MODULE_META__DEF_LANG,
					oldDefLang, defLang));
	}
