...
public class SourceImpl extends EObjectImpl implements Source {
	...
	/**
	 * The default value of the '{@link #getPp() <em>Pp</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getPp()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getPp() <em>Pp</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getPp()
	 * @generated
	...
	public NotificationChain basicSetAuthor(Author newAuthor, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					LobjPackage.SOURCE__AUTHOR, oldAuthor, newAuthor);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newAuthor != author) {
			...
			if (author != null)
				msgs = ((InternalEObject) author).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- LobjPackage.SOURCE__AUTHOR, null, msgs);
			if (newAuthor != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.SOURCE__AUTHOR, newAuthor,
					newAuthor));
	}
	...
	public void setTitle(String newTitle) {
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.SOURCE__TITLE, oldTitle,
					title));
	}
	...
	public void setSubtitle(String newSubtitle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.SOURCE__SUBTITLE,
	...
	public void setPublishedIn(String newPublishedIn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.SOURCE__PUBLISHED_IN,
					oldPublishedIn, publishedIn));
	}
	...
	public void setPublishedBy(String newPublishedBy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.SOURCE__PUBLISHED_BY,
					oldPublishedBy, publishedBy));
	}
	...
	public void setPublishDate(Object newPublishDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.SOURCE__PUBLISH_DATE,
	...
	public boolean eIsSet(int featureID) {
		...
		case LobjPackage.SOURCE__PUBLISHED_IN:
			return PUBLISHED_IN_EDEFAULT == null ? publishedIn != null : !PUBLISHED_IN_EDEFAULT
					.equals(publishedIn);
		case LobjPackage.SOURCE__PUBLISHED_BY:
			return PUBLISHED_BY_EDEFAULT == null ? publishedBy != null : !PUBLISHED_BY_EDEFAULT
					.equals(publishedBy);
		case LobjPackage.SOURCE__PUBLISH_DATE:
			return PUBLISH_DATE_EDEFAULT == null ? publishDate != null : !PUBLISH_DATE_EDEFAULT
					.equals(publishDate);
		case LobjPackage.SOURCE__PP:
