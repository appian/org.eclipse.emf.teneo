...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Lu Node</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public class LuNodeImpl extends EObjectImpl implements LuNode {
	...
	public void setVisible(boolean newVisible) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.LU_NODE__VISIBLE,
					oldVisible, visible));
	}
			...
			if (learningUnit != oldLearningUnit) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							LobjPackage.LU_NODE__LEARNING_UNIT, oldLearningUnit, learningUnit));
			}
		}
		return learningUnit;
	}
	...
	public void setLearningUnit(LearningUnit newLearningUnit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.LU_NODE__LEARNING_UNIT,
					oldLearningUnit, learningUnit));
	}
