...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Lu Meta</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public class LuMetaImpl extends LearningObjectImpl implements LuMeta {
	...
	/**
	 * The cached value of the '{@link #getDomain() <em>Domain</em>}' reference. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @see #getDomain()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getPublishInfo() <em>Publish Info</em>}' containment
	...
	public EList getDidacMeta() {
		if (didacMeta == null) {
			didacMeta = new EObjectContainmentEList(DidacMeta.class, this,
					LobjPackage.LU_META__DIDAC_META);
		}
		return didacMeta;
	}
	...
	public void setCreationDate(Date newCreationDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.LU_META__CREATION_DATE,
	...
	public Domain getDomain() {
		if (domain != null && domain.eIsProxy()) {
			...
			if (domain != oldDomain) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LobjPackage.LU_META__DOMAIN,
							oldDomain, domain));
			}
		}
		return domain;
	...
	public void setDomain(Domain newDomain) {
		...
		domain = newDomain;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.LU_META__DOMAIN, oldDomain,
					domain));
	}
	...
	public NotificationChain basicSetPublishInfo(PublishInfo newPublishInfo, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					LobjPackage.LU_META__PUBLISH_INFO, oldPublishInfo, newPublishInfo);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setPublishInfo(PublishInfo newPublishInfo) {
		if (newPublishInfo != publishInfo) {
			...
			if (publishInfo != null)
				msgs = ((InternalEObject) publishInfo).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- LobjPackage.LU_META__PUBLISH_INFO, null, msgs);
			if (newPublishInfo != null)
				msgs = ((InternalEObject) newPublishInfo).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
						- LobjPackage.LU_META__PUBLISH_INFO, null, msgs);
			msgs = basicSetPublishInfo(newPublishInfo, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.LU_META__PUBLISH_INFO,
					newPublishInfo, newPublishInfo));
	}
	...
	public Language getDefLang() {
		if (defLang != null && defLang.eIsProxy()) {
			...
			if (defLang != oldDefLang) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LobjPackage.LU_META__DEF_LANG,
							oldDefLang, defLang));
			}
		}
		return defLang;
	...
	public void setDefLang(Language newDefLang) {
		...
		defLang = newDefLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.LU_META__DEF_LANG,
					oldDefLang, defLang));
	}
