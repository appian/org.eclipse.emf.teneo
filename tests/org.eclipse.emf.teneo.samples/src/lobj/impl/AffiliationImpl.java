...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Affiliation</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public class AffiliationImpl extends EObjectImpl implements Affiliation {
	...
	/**
	 * The cached value of the '{@link #getOrgname() <em>Orgname</em>}' attribute. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @see #getOrgname()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getOrgdiv() <em>Orgdiv</em>}' attribute. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @see #getOrgdiv()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getOrgdiv() <em>Orgdiv</em>}' attribute. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @see #getOrgdiv()
	 * @generated
	...
	public void setShortaffil(String newShortaffil) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.AFFILIATION__SHORTAFFIL,
					oldShortaffil, shortaffil));
	}
	...
	public void setJobtitle(String newJobtitle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.AFFILIATION__JOBTITLE,
	...
	public void setOrgname(String newOrgname) {
		...
		orgname = newOrgname;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.AFFILIATION__ORGNAME,
					oldOrgname, orgname));
	}
	...
	public void setOrgdiv(String newOrgdiv) {
		...
		orgdiv = newOrgdiv;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.AFFILIATION__ORGDIV,
					oldOrgdiv, orgdiv));
	}
	...
	public NotificationChain basicSetAddress(Address newAddress, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					LobjPackage.AFFILIATION__ADDRESS, oldAddress, newAddress);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newAddress != address) {
			...
			if (address != null)
				msgs = ((InternalEObject) address).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- LobjPackage.AFFILIATION__ADDRESS, null, msgs);
			if (newAddress != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.AFFILIATION__ADDRESS,
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case LobjPackage.AFFILIATION__SHORTAFFIL:
			return SHORTAFFIL_EDEFAULT == null ? shortaffil != null : !SHORTAFFIL_EDEFAULT
					.equals(shortaffil);
		case LobjPackage.AFFILIATION__JOBTITLE:
