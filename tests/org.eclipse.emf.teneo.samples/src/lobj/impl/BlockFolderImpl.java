...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Block Folder</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class BlockFolderImpl extends LearningObjectImpl implements BlockFolder {
	...
	/**
	 * The cached value of the '{@link #getBlockFolder() <em>Block Folder</em>}' containment reference
	...
	public NotificationChain basicSetFolderMeta(FolderMeta newFolderMeta, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					LobjPackage.BLOCK_FOLDER__FOLDER_META, oldFolderMeta, newFolderMeta);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newFolderMeta != folderMeta) {
			...
			if (folderMeta != null)
				msgs = ((InternalEObject) folderMeta).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- LobjPackage.BLOCK_FOLDER__FOLDER_META, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.BLOCK_FOLDER__FOLDER_META,
	...
	public EList getBlockFolder() {
		if (blockFolder == null) {
			blockFolder = new EObjectContainmentEList(BlockFolder.class, this,
					LobjPackage.BLOCK_FOLDER__BLOCK_FOLDER);
		}
		return blockFolder;
	}
	...
	public NotificationChain basicSetAccessControl(AccessControl newAccessControl,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					LobjPackage.BLOCK_FOLDER__ACCESS_CONTROL, oldAccessControl, newAccessControl);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newAccessControl != accessControl) {
			...
			if (accessControl != null)
				msgs = ((InternalEObject) accessControl).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- LobjPackage.BLOCK_FOLDER__ACCESS_CONTROL, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					LobjPackage.BLOCK_FOLDER__ACCESS_CONTROL, newAccessControl, newAccessControl));
	}
