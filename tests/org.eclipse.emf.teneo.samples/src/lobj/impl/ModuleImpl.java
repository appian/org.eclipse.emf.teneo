...
public class ModuleImpl extends LearningObjectImpl implements Module {
	...
	public NotificationChain basicSetModuleMeta(ModuleMeta newModuleMeta, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					LobjPackage.MODULE__MODULE_META, oldModuleMeta, newModuleMeta);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setModuleMeta(ModuleMeta newModuleMeta) {
		if (newModuleMeta != moduleMeta) {
			...
			if (moduleMeta != null)
				msgs = ((InternalEObject) moduleMeta).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- LobjPackage.MODULE__MODULE_META, null, msgs);
			if (newModuleMeta != null)
				msgs = ((InternalEObject) newModuleMeta).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
						- LobjPackage.MODULE__MODULE_META, null, msgs);
			msgs = basicSetModuleMeta(newModuleMeta, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.MODULE__MODULE_META,
					newModuleMeta, newModuleMeta));
	}
	...
	public EList getExternalMetadata() {
		if (externalMetadata == null) {
			externalMetadata = new EObjectContainmentEList(ExternalMetadata.class, this,
					LobjPackage.MODULE__EXTERNAL_METADATA);
		}
	...
	public NotificationChain basicSetRootNode(Node newRootNode, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					LobjPackage.MODULE__ROOT_NODE, oldRootNode, newRootNode);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setRootNode(Node newRootNode) {
		if (newRootNode != rootNode) {
			NotificationChain msgs = null;
			if (rootNode != null)
				msgs = ((InternalEObject) rootNode).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- LobjPackage.MODULE__ROOT_NODE, null, msgs);
			if (newRootNode != null)
				msgs = ((InternalEObject) newRootNode).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
						- LobjPackage.MODULE__ROOT_NODE, null, msgs);
			msgs = basicSetRootNode(newRootNode, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.MODULE__ROOT_NODE,
	...
	public void setModuleFile(String newModuleFile) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.MODULE__MODULE_FILE,
					oldModuleFile, moduleFile));
	}
	...
	public void setTreeAsXml(String newTreeAsXml) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.MODULE__TREE_AS_XML,
	...
	public NotificationChain basicSetAccessControl(AccessControl newAccessControl,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					LobjPackage.MODULE__ACCESS_CONTROL, oldAccessControl, newAccessControl);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newAccessControl != accessControl) {
			...
			if (accessControl != null)
				msgs = ((InternalEObject) accessControl).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- LobjPackage.MODULE__ACCESS_CONTROL, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.MODULE__ACCESS_CONTROL,
	...
	public boolean eIsSet(int featureID) {
		...
		case LobjPackage.MODULE__MODULE_FILE:
			return MODULE_FILE_EDEFAULT == null ? moduleFile != null : !MODULE_FILE_EDEFAULT
					.equals(moduleFile);
		case LobjPackage.MODULE__TREE_AS_XML:
