...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Learning Object</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public abstract class LearningObjectImpl extends EObjectImpl implements LearningObject {
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.LEARNING_OBJECT__ID, oldId,
					id));
	}
	...
	public void setTimestamp(Date newTimestamp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.LEARNING_OBJECT__TIMESTAMP,
	...
	public void setSynchronized(boolean newSynchronized) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					LobjPackage.LEARNING_OBJECT__SYNCHRONIZED, oldSynchronized, synchronized_));
	}
