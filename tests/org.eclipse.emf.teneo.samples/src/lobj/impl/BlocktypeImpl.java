...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Blocktype</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public class BlocktypeImpl extends EObjectImpl implements Blocktype {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.BLOCKTYPE__NAME, oldName,
					name));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.BLOCKTYPE__DESCRIPTION,
	...
	public void setCreationDate(Date newCreationDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.BLOCKTYPE__CREATION_DATE,
	...
	public void setStyleRef(String newStyleRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.BLOCKTYPE__STYLE_REF,
					oldStyleRef, styleRef));
	}
	...
	public EList getDomains() {
		if (domains == null) {
			domains = new EObjectWithInverseResolvingEList.ManyInverse(Domain.class, this,
					LobjPackage.BLOCKTYPE__DOMAINS, LobjPackage.DOMAIN__BLOCKTYPES);
		}
		return domains;
	}
