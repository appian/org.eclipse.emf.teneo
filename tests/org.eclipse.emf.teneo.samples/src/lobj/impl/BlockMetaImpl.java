...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Block Meta</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public class BlockMetaImpl extends LearningObjectImpl implements BlockMeta {
	/**
	 * The default value of the '{@link #getLod() <em>Lod</em>}' attribute. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @see #getLod()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getLod() <em>Lod</em>}' attribute. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @see #getLod()
	 * @generated
	...
	/**
	 * This is true if the Lod attribute has been set. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	...
	/**
	 * The cached value of the '{@link #getSimpleDidacMeta() <em>Simple Didac Meta</em>}' containment
	...
	public void setLod(int newLod) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.BLOCK_META__LOD, oldLod,
					lod, !oldLodESet));
	}
	...
	public void unsetLod() {
		...
		lodESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, LobjPackage.BLOCK_META__LOD, oldLod,
					LOD_EDEFAULT, oldLodESet));
	}
	...
	public void setRendering(String newRendering) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.BLOCK_META__RENDERING,
	...
	public void setBlocktype(Blocktype newBlocktype) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.BLOCK_META__BLOCKTYPE,
	...
	public void setCreationDate(Date newCreationDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.BLOCK_META__CREATION_DATE,
	...
	public void setLastModified(Date newLastModified) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.BLOCK_META__LAST_MODIFIED,
	...
	public EList getSimpleDidacMeta() {
		if (simpleDidacMeta == null) {
			simpleDidacMeta = new EObjectContainmentEList(SimpleDidacMeta.class, this,
					LobjPackage.BLOCK_META__SIMPLE_DIDAC_META);
		}
			...
			if (defLang != oldDefLang) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							LobjPackage.BLOCK_META__DEF_LANG, oldDefLang, defLang));
			}
		}
		return defLang;
	}
	...
	public void setDefLang(Language newDefLang) {
		...
		defLang = newDefLang;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.BLOCK_META__DEF_LANG,
					oldDefLang, defLang));
	}
