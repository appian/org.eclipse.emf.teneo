...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Resrc Filetype</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class ResrcFiletypeImpl extends EObjectImpl implements ResrcFiletype {
	/**
	 * The default value of the '{@link #getFiletypeExtension() <em>Filetype Extension</em>}'
	...
	/**
	 * The cached value of the '{@link #getFiletypeExtension() <em>Filetype Extension</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getFiletypeExtension()
	 * @generated
	...
	/**
	 * The default value of the '{@link #isImage() <em>Image</em>}' attribute. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @see #isImage()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #isImage() <em>Image</em>}' attribute. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @see #isImage()
	 * @generated
	...
	/**
	 * The default value of the '{@link #isApplet() <em>Applet</em>}' attribute. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @see #isApplet()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #isApplet() <em>Applet</em>}' attribute. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @see #isApplet()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getFiletypeImageSmall() <em>Filetype Image Small</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getFiletypeImageSmall() <em>Filetype Image Small</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getFiletypeImageSmall()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getFiletypeImageBif() <em>Filetype Image Bif</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	public void setFiletypeExtension(String newFiletypeExtension) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					LobjPackage.RESRC_FILETYPE__FILETYPE_EXTENSION, oldFiletypeExtension, filetypeExtension));
	}
	...
	public void setFiletypeDesc(String newFiletypeDesc) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					LobjPackage.RESRC_FILETYPE__FILETYPE_DESC, oldFiletypeDesc, filetypeDesc));
	}
	...
	public void setImage(boolean newImage) {
		...
		image = newImage;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.RESRC_FILETYPE__IMAGE,
					oldImage, image));
	}
	...
	public void setApplet(boolean newApplet) {
		...
		applet = newApplet;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.RESRC_FILETYPE__APPLET,
					oldApplet, applet));
	}
	...
	public void setFiletypeImageSmall(String newFiletypeImageSmall) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					LobjPackage.RESRC_FILETYPE__FILETYPE_IMAGE_SMALL, oldFiletypeImageSmall,
					filetypeImageSmall));
	}
	...
	public void setFiletypeImageBif(String newFiletypeImageBif) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					LobjPackage.RESRC_FILETYPE__FILETYPE_IMAGE_BIF, oldFiletypeImageBif, filetypeImageBif));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.RESRC_FILETYPE__ID, oldId,
					id));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case LobjPackage.RESRC_FILETYPE__FILETYPE_EXTENSION:
			return FILETYPE_EXTENSION_EDEFAULT == null ? filetypeExtension != null
					: !FILETYPE_EXTENSION_EDEFAULT.equals(filetypeExtension);
		case LobjPackage.RESRC_FILETYPE__FILETYPE_DESC:
			return FILETYPE_DESC_EDEFAULT == null ? filetypeDesc != null : !FILETYPE_DESC_EDEFAULT
					.equals(filetypeDesc);
		case LobjPackage.RESRC_FILETYPE__IMAGE:
		...
		case LobjPackage.RESRC_FILETYPE__FILETYPE_IMAGE_SMALL:
			return FILETYPE_IMAGE_SMALL_EDEFAULT == null ? filetypeImageSmall != null
					: !FILETYPE_IMAGE_SMALL_EDEFAULT.equals(filetypeImageSmall);
		case LobjPackage.RESRC_FILETYPE__FILETYPE_IMAGE_BIF:
			return FILETYPE_IMAGE_BIF_EDEFAULT == null ? filetypeImageBif != null
					: !FILETYPE_IMAGE_BIF_EDEFAULT.equals(filetypeImageBif);
		case LobjPackage.RESRC_FILETYPE__ID:
