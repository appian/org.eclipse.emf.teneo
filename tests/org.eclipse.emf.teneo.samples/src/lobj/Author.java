...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Author</b></em>'. <!--
 * end-user-doc -->
 * 
 * <p>
...
public interface Author extends EObject {
	/**
	 * Returns the value of the '<em><b>Credittype</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Credittype</em>' attribute isn't clear, there really should be more
	 ...
	 * 
	 * @param value
	 *          the new value of the '<em>Credittype</em>' attribute.
	 * @see #getCredittype()
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Person</b></em>' containment reference. <!-- begin-user-doc
	 * -->
	 * <p>
	 * If the meaning of the '<em>Person</em>' containment reference isn't clear, there really should
	 ...
	 * 
	 * @param value
	 *          the new value of the '<em>Person</em>' containment reference.
	 * @see #getPerson()
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link lobj.Author#getId <em>Id</em>}' attribute. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @param value
