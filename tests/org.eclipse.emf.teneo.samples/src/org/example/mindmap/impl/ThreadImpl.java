...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Thread</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public class ThreadImpl extends EObjectImpl implements org.example.mindmap.Thread {
		...
		if (author != null && author.eIsProxy()) {
			...
			if (author != oldAuthor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MindmapPackage.THREAD__AUTHOR,
							oldAuthor, author));
			}
		}
		return author;
	...
	public NotificationChain basicSetAuthor(Resource newAuthor, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MindmapPackage.THREAD__AUTHOR, oldAuthor, newAuthor);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setAuthor(Resource newAuthor) {
		if (newAuthor != author) {
			...
			if (author != null)
				msgs = ((InternalEObject) author).eInverseRemove(this, MindmapPackage.RESOURCE__COMMENTS,
						Resource.class, msgs);
			if (newAuthor != null)
				msgs = ((InternalEObject) newAuthor).eInverseAdd(this, MindmapPackage.RESOURCE__COMMENTS,
						Resource.class, msgs);
			msgs = basicSetAuthor(newAuthor, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MindmapPackage.THREAD__AUTHOR,
					newAuthor, newAuthor));
	}
	...
	public void setPostDate(Object newPostDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MindmapPackage.THREAD__POST_DATE,
	...
	public void setSubject(String newSubject) {
		...
		subject = newSubject;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MindmapPackage.THREAD__SUBJECT,
					oldSubject, subject));
	}
