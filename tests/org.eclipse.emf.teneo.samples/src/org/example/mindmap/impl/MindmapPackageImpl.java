...
public class MindmapPackageImpl extends EPackageImpl implements MindmapPackage {
	...
	public void initializePackageContents() {
		...
		initEClass(threadEClass, org.example.mindmap.Thread.class, "Thread", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getThread_Items(), this.getThreadItem(), null, "items", null, 0, -1, org.example.mindmap.Thread.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getThread_Author(), this.getResource(), this.getResource_Comments(), "author", null, 0, 1, org.example.mindmap.Thread.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getThread_PostDate(), theXMLTypePackage.getDate(), "postDate", null, 0, 1, org.example.mindmap.Thread.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getThread_Subject(), theXMLTypePackage.getString(), "subject", null, 0, 1, org.example.mindmap.Thread.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
