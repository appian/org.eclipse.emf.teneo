 ...
 * </copyright>
 *
 * $Id: MindmapPackageImpl.java,v 1.1 2006/11/23 06:12:10 mtaal Exp $
 */
...
public class MindmapPackageImpl extends EPackageImpl implements MindmapPackage {
	 ...
	 * @see org.example.mindmap.MindmapPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static MindmapPackage init() {
		...
		MindmapPackageImpl theMindmapPackage = (MindmapPackageImpl) (EPackage.Registry.INSTANCE
				.getEPackage(eNS_URI) instanceof MindmapPackageImpl ? EPackage.Registry.INSTANCE
				.getEPackage(eNS_URI) : new MindmapPackageImpl());
	...
	public void initializePackageContents() {
		...
		initEReference(getDocumentRoot_XSISchemaLocation(), ecorePackage.getEStringToStringMapEntry(),
				...
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDocumentRoot_Map(), this.getMap(), null, "map", null, 0, -2, null,
				IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);

		initEClass(mapEClass, Map.class, "Map", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getMap_RootTopics(), this.getTopic(), null, "rootTopics", null, 0, -1,
				Map.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMap_Relations(), this.getRelationship(), null, "relations", null, 0, -1,
				Map.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMap_Resources(), this.getResource(), null, "resources", null, 0, -1,
				Map.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getMap_Title(), theXMLTypePackage.getString(), "title", null, 0, 1, Map.class,
		...
		initEClass(relationshipEClass, Relationship.class, "Relationship", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getRelationship_Label(), theXMLTypePackage.getString(), "label", null, 0, 1,
				Relationship.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				!IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRelationship_Source(), this.getTopic(), null, "source", null, 0, 1,
				Relationship.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRelationship_Target(), this.getTopic(), null, "target", null, 0, 1,
				Relationship.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRelationship_Type(), this.getRelationshipType(), "type", "DEPENDENCY", 0, 1,
				Relationship.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				!IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(resourceEClass, Resource.class, "Resource", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getResource_Comments(), this.getThread(), this.getThread_Author(), "comments",
				null, 0, -1, Resource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResource_Email(), theXMLTypePackage.getString(), "email", null, 0, 1,
				Resource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				!IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getResource_Name(), theXMLTypePackage.getString(), "name", null, 0, 1,
				Resource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				!IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getResource_Topics(), this.getTopic(), this.getTopic_Resources(), "topics",
				null, 0, -1, Resource.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(threadEClass, org.example.mindmap.Thread.class, "Thread", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getThread_Items(), this.getThreadItem(), null, "items", null, 0, -1,
				org.example.mindmap.Thread.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getThread_Author(), this.getResource(), this.getResource_Comments(), "author",
				null, 0, 1, org.example.mindmap.Thread.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getThread_PostDate(), theXMLTypePackage.getDate(), "postDate", null, 0, 1,
				org.example.mindmap.Thread.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getThread_Subject(), theXMLTypePackage.getString(), "subject", null, 0, 1,
				org.example.mindmap.Thread.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(threadItemEClass, ThreadItem.class, "ThreadItem", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getThreadItem_Author(), this.getResource(), null, "author", null, 0, 1,
				ThreadItem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getThreadItem_Body(), theXMLTypePackage.getString(), "body", null, 0, 1,
				ThreadItem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				!IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getThreadItem_ItemPostDate(), theXMLTypePackage.getDate(), "itemPostDate", null,
				0, 1, ThreadItem.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				!IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(topicEClass, Topic.class, "Topic", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTopic_Comments(), this.getThread(), null, "comments", null, 0, -1,
				Topic.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTopic_Duration(), theXMLTypePackage.getFloat(), "duration", "0", 0, 1,
				Topic.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, !IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getTopic_EndDate(), theXMLTypePackage.getDate(), "endDate", null, 0, 1,
				Topic.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				!IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTopic_Name(), theXMLTypePackage.getString(), "name", null, 0, 1, Topic.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getTopic_PercentComplete(), theXMLTypePackage.getFloat(), "percentComplete",
				null, 0, 1, Topic.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID,
				!IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTopic_Priority(), this.getPriority(), "priority", "ZERO", 0, 1, Topic.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getTopic_Resources(), this.getResource(), this.getResource_Topics(),
				"resources", null, 0, -1, Topic.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTopic_StartDate(), theXMLTypePackage.getDate(), "startDate", null, 0, 1,
				Topic.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
				!IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTopic_Subtopics(), this.getTopic(), null, "subtopics", null, 0, -1,
				Topic.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEDataType(priorityObjectEDataType, Priority.class, "PriorityObject", IS_SERIALIZABLE,
				IS_GENERATED_INSTANCE_CLASS);
		initEDataType(relationshipTypeObjectEDataType, RelationshipType.class,
				"RelationshipTypeObject", IS_SERIALIZABLE, IS_GENERATED_INSTANCE_CLASS);
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation(getDocumentRoot_Map(), source, new String[] { "kind", "element", "name", "map",
				"namespace", "##targetNamespace" });
		addAnnotation(mapEClass, source, new String[] { "name", "Map", "kind", "elementOnly" });
		addAnnotation(getMap_RootTopics(), source, new String[] { "kind", "element", "name",
				"rootTopics" });
		addAnnotation(getMap_Relations(), source,
				new String[] { "kind", "element", "name", "relations" });
		addAnnotation(getMap_Resources(), source,
				new String[] { "kind", "element", "name", "resources" });
		addAnnotation(getMap_Title(), source, new String[] { "kind", "attribute", "name", "title" });
		addAnnotation(priorityEEnum, source, new String[] { "name", "Priority" });
		addAnnotation(priorityObjectEDataType, source, new String[] { "name", "Priority:Object",
				"baseType", "Priority" });
		addAnnotation(relationshipEClass, source, new String[] { "name", "Relationship", "kind",
				"empty" });
		addAnnotation(getRelationship_Label(), source, new String[] { "kind", "attribute", "name",
				"label" });
		addAnnotation(getRelationship_Source(), source, new String[] { "kind", "attribute", "name",
				"source" });
		addAnnotation(getRelationship_Target(), source, new String[] { "kind", "attribute", "name",
				"target" });
		addAnnotation(getRelationship_Type(), source, new String[] { "kind", "attribute", "name",
				"type" });
		addAnnotation(relationshipTypeEEnum, source, new String[] { "name", "RelationshipType" });
		addAnnotation(relationshipTypeObjectEDataType, source, new String[] { "name",
				"RelationshipType:Object", "baseType", "RelationshipType" });
		addAnnotation(resourceEClass, source, new String[] { "name", "Resource", "kind", "empty" });
		addAnnotation(getResource_Comments(), source, new String[] { "kind", "attribute", "name",
				"comments" });
		addAnnotation(getResource_Email(), source,
				new String[] { "kind", "attribute", "name", "email" });
		addAnnotation(getResource_Name(), source, new String[] { "kind", "attribute", "name", "name" });
		addAnnotation(getResource_Topics(), source, new String[] { "kind", "attribute", "name",
				"topics" });
		addAnnotation(threadEClass, source, new String[] { "name", "Thread", "kind", "elementOnly" });
		addAnnotation(getThread_Items(), source, new String[] { "kind", "element", "name", "items" });
		addAnnotation(getThread_Author(), source,
				new String[] { "kind", "attribute", "name", "author" });
		addAnnotation(getThread_PostDate(), source, new String[] { "kind", "attribute", "name",
				"postDate" });
		addAnnotation(getThread_Subject(), source, new String[] { "kind", "attribute", "name",
				"subject" });
		addAnnotation(threadItemEClass, source, new String[] { "name", "ThreadItem", "kind", "empty" });
		addAnnotation(getThreadItem_Author(), source, new String[] { "kind", "attribute", "name",
				"author" });
		addAnnotation(getThreadItem_Body(), source,
				new String[] { "kind", "attribute", "name", "body" });
		addAnnotation(getThreadItem_ItemPostDate(), source, new String[] { "kind", "attribute", "name",
				"itemPostDate" });
		addAnnotation(topicEClass, source, new String[] { "name", "Topic", "kind", "elementOnly" });
		addAnnotation(getTopic_Comments(), source,
				new String[] { "kind", "element", "name", "comments" });
		addAnnotation(getTopic_Duration(), source, new String[] { "kind", "attribute", "name",
				"duration" });
		addAnnotation(getTopic_EndDate(), source,
				new String[] { "kind", "attribute", "name", "endDate" });
		addAnnotation(getTopic_Name(), source, new String[] { "kind", "attribute", "name", "name" });
		addAnnotation(getTopic_PercentComplete(), source, new String[] { "kind", "attribute", "name",
				"percentComplete" });
		addAnnotation(getTopic_Priority(), source, new String[] { "kind", "attribute", "name",
				"priority" });
		addAnnotation(getTopic_Resources(), source, new String[] { "kind", "attribute", "name",
				"resources" });
		addAnnotation(getTopic_StartDate(), source, new String[] { "kind", "attribute", "name",
				"startDate" });
		addAnnotation(getTopic_Subtopics(), source, new String[] { "kind", "attribute", "name",
				"subtopics" });
	}
