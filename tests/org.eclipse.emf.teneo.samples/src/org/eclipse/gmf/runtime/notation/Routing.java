 ...
 * <em><b>Routing</b></em>', and utility methods for working with them. <!-- end-user-doc -->
 * 
...
public final class Routing extends AbstractEnumerator {
	...
	/**
	 * The '<em><b>Rectilinear</b></em>' literal value. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The '<em><b>Tree</b></em>' literal value. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #TREE_LITERAL
	 * @model name="Tree"
	 * @generated
	...
	/**
	 * The '<em><b>Rectilinear</b></em>' literal object. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #RECTILINEAR
	 * @generated
	 * @ordered
	 */
	public static final Routing RECTILINEAR_LITERAL = new Routing(RECTILINEAR,
			"Rectilinear", "Rectilinear"); //$NON-NLS-2$//$NON-NLS-1$
	...
	/**
	 * An array of all the '<em><b>Routing</b></em>' enumerators. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 */
	private static final Routing[] VALUES_ARRAY = new Routing[] { MANUAL_LITERAL,
			RECTILINEAR_LITERAL, TREE_LITERAL, };

	/**
	 * A public read-only list of all the '<em><b>Routing</b></em>' enumerators. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	/**
	 * Returns the '<em><b>Routing</b></em>' literal with the specified name. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @generated
	 */
