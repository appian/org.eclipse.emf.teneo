...
public interface Node extends View {
	...
	/**
	 * Sets the value of the '{@link org.eclipse.gmf.runtime.notation.Node#getLayoutConstraint
	 * <em>Layout Constraint</em>}' containment reference. <!-- begin-user-doc -->
	 * <p>
	 * Layout constraints are used by layout managers to properly set the bounds of the node's visuals
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Layout Constraint</em>' containment reference.
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * A utility method to create a <code>LayoutConstraint</code> object from the given
	 * <code>EClass</code> and then sets the node's <em>LayoutConstraint</em> property to the new
	 * object.
	 * </p>
	 * 
	 * @param eClass
	 *          the <code>EClass</code> to be used in creating the <code>LayoutConstraint</code>
	 *          object <!-- end-user-doc -->
	 * @model
	 * @generated
	 */
