...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Image Style</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.gmf.runtime.notation.impl.ImageStyleImpl#getAntiAlias <em>Anti Alias</em>}
 * </li>
 * <li>{@link org.eclipse.gmf.runtime.notation.impl.ImageStyleImpl#getMaintainAspectRatio <em>
 * Maintain Aspect Ratio</em>}</li>
 * <li>{@link org.eclipse.gmf.runtime.notation.impl.ImageStyleImpl#getCropBound <em>Crop Bound</em>}
 * </li>
 * </ul>
 * </p>
 * 
...
public class ImageStyleImpl extends FlatEObjectImpl implements ImageStyle {
	...
	/**
	 * The default value of the '{@link #getMaintainAspectRatio() <em>Maintain Aspect Ratio</em>}'
	...
	/**
	 * The cached value of the '{@link #getMaintainAspectRatio() <em>Maintain Aspect Ratio</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getMaintainAspectRatio()
	 * @generated
	...
	public void setAntiAlias(Boolean newAntiAlias) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					NotationPackage.IMAGE_STYLE__ANTI_ALIAS, oldAntiAlias, antiAlias));
	}
	...
	public void setMaintainAspectRatio(Boolean newMaintainAspectRatio) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					NotationPackage.IMAGE_STYLE__MAINTAIN_ASPECT_RATIO, oldMaintainAspectRatio,
					maintainAspectRatio));
	}
	...
	public void setCropBound(Bounds newCropBound) {
		if (newCropBound != cropBound) {
			...
			if (cropBound != null)
				msgs = ((InternalEObject) cropBound).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- NotationPackage.IMAGE_STYLE__CROP_BOUND, null, msgs);
			if (newCropBound != null)
				msgs = ((InternalEObject) newCropBound).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
						- NotationPackage.IMAGE_STYLE__CROP_BOUND, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					NotationPackage.IMAGE_STYLE__CROP_BOUND, newCropBound, newCropBound));
	}
