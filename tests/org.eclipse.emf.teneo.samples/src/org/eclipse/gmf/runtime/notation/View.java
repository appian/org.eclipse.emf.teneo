 ...
 * visualize that business model. The reason the view object does not have all the properties itself
 * but rather delegates to other abstractions is to allow for easy extension of properties.
 * </p>
 * <!-- end-user-doc -->
 * 
 * <p>
 ...
 * <li>{@link org.eclipse.gmf.runtime.notation.View#getPersistedChildren <em>Persisted Children
 * </em>}</li>
 ...
 * <li>{@link org.eclipse.gmf.runtime.notation.View#getTransientChildren <em>Transient Children
 * </em>}</li>
 * </ul>
 * </p>
 * 
...
public interface View extends EModelElement {
	/**
	 * Returns the value of the '<em><b>Visible</b></em>' attribute. The default value is
	...
	/**
	 * Sets the value of the '{@link org.eclipse.gmf.runtime.notation.View#isVisible <em>Visible</em>}
	 ...
	 * . <!-- begin-user-doc -->
	 * <p>
	 * The view's type is a context-defined unique string representing the kind of the view. It is
	 * usually used if the view is a subview or if it is a top level view that does not have a
	 * business model
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link org.eclipse.gmf.runtime.notation.View#getType <em>Type</em>}'
	...
	/**
	 * Sets the value of the '{@link org.eclipse.gmf.runtime.notation.View#isMutable <em>Mutable</em>}
	 * ' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Returns the value of the '<em><b>Source Edges</b></em>' reference list. The list contents are
	 * of type {@link org.eclipse.gmf.runtime.notation.Edge}. It is bidirectional and its opposite is
	...
	/**
	 * Returns the value of the '<em><b>Target Edges</b></em>' reference list. The list contents are
	 * of type {@link org.eclipse.gmf.runtime.notation.Edge}. It is bidirectional and its opposite is
	...
	/**
	 * Returns the value of the '<em><b>Persisted Children</b></em>' containment reference list. The
	 * list contents are of type {@link org.eclipse.gmf.runtime.notation.Node}. <!-- begin-user-doc
	 * -->
	 * <p>
	...
	/**
	 * Returns the value of the '<em><b>Children</b></em>'list. the returned list is an
	 * <em><b>Unmodifable</b></em> list. The list contents are of type
	 * {@link org.eclipse.gmf.runtime.notation.View}. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns an <em><b>Unmodifable</b></em> list that contains all the visible children in the
	 * Children list. The list contents are of type {@link org.eclipse.gmf.runtime.notation.View}.
	...
	/**
	 * Returns the value of the '<em><b>Styles</b></em>' containment reference list. The list contents
	 * are of type {@link org.eclipse.gmf.runtime.notation.Style}. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link org.eclipse.gmf.runtime.notation.View#getElement
	 * <em>Element</em>}' reference. <!-- begin-user-doc --> This is The referenced business model
	...
	/**
	 * Unsets the value of the '{@link org.eclipse.gmf.runtime.notation.View#getElement
	...
	/**
	 * Returns whether the value of the '{@link org.eclipse.gmf.runtime.notation.View#getElement
	 * <em>Element</em>}' reference is set. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the value of the '<em><b>Transient Children</b></em>' containment reference list. The
	 * list contents are of type {@link org.eclipse.gmf.runtime.notation.Node}. <!-- begin-user-doc
	 * -->
	 * <p>
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * Looks up a style in the view's collection of styles that extends/implements the given
	 * <code>EClass</code>. Thefore the returned style instance is not guaranteed to be unique for
	 * different <code>EClass</code>es
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 * @model
	 ...
	 * 
	 * @param eClass
	 *          the <code>EClass</code> to be used in creating the <code>Node</code> object <!--
	 *          end-user-doc -->
	 * @model
	 * @generated
	 */
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * A utililty method to create a new <code>Style</code> from the given <code>eClass</code>
	 * paramter and then inserts the object in the view's </em>Styles</em> collection
	 * </p>
	 * 
	 * @param eClass
	 *          the <code>EClass</code> to be used in creating the <code>Style</code> object <!--
	 *          end-user-doc -->
	 * @model
	 * @generated
	 */
	 ...
	 * 
	 * @param child
	 *          the '<em>View</em>' to insert. <!-- end-user-doc -->
	 */
	 ...
	 *          the '<em>View</em>' to insert.
	 * @param persisted
	 *          , indicate if the view will be persisted or not <!-- end-user-doc -->
	 */
	 ...
	 * 
	 * @param child
	 *          the '<em>View</em>' to remove <!-- end-user-doc -->
	 */
