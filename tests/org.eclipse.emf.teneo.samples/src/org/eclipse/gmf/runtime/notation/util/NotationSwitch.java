 ...
 * call {@link #doSwitch doSwitch(object)} to invoke the <code>caseXXX</code> method for each class
 * of the model, starting with the actual class of the object and proceeding up the inheritance
