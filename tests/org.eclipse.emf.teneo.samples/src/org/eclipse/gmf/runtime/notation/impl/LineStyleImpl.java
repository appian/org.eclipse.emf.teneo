...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Line Style</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public class LineStyleImpl extends FlatEObjectImpl implements LineStyle {
	...
	public void setLineColor(int newLineColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotationPackage.LINE_STYLE__LINE_COLOR,
