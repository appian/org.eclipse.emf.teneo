...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Connector Style</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.gmf.runtime.notation.impl.ConnectorStyleImpl#getRouting <em>Routing</em>}</li>
 * <li>{@link org.eclipse.gmf.runtime.notation.impl.ConnectorStyleImpl#getSmoothness <em>Smoothness
 * </em>}</li>
 * <li>{@link org.eclipse.gmf.runtime.notation.impl.ConnectorStyleImpl#isAvoidObstructions <em>Avoid
 * Obstructions</em>}</li>
 * <li>{@link org.eclipse.gmf.runtime.notation.impl.ConnectorStyleImpl#isClosestDistance <em>Closest
 * Distance</em>}</li>
 * <li>{@link org.eclipse.gmf.runtime.notation.impl.ConnectorStyleImpl#getJumpLinkStatus <em>Jump
 * Link Status</em>}</li>
 * <li>{@link org.eclipse.gmf.runtime.notation.impl.ConnectorStyleImpl#getJumpLinkType <em>Jump Link
 * Type</em>}</li>
 * <li>{@link org.eclipse.gmf.runtime.notation.impl.ConnectorStyleImpl#isJumpLinksReverse <em>Jump
 * Links Reverse</em>}</li>
 * <li>{@link org.eclipse.gmf.runtime.notation.impl.ConnectorStyleImpl#getLineColor <em>Line Color
 * </em>}</li>
 * </ul>
 * </p>
 * 
...
public class ConnectorStyleImpl extends FlatEObjectImpl implements ConnectorStyle {
	...
	/**
	 * The default value of the '{@link #isAvoidObstructions() <em>Avoid Obstructions</em>}'
	 ...
	 * <em>Avoid Obstructions</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isAvoidObstructions()
	 * @generated
	 * @ordered
	...
	/**
	 * The flag representing the value of the '{@link #isClosestDistance() <em>Closest Distance</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isClosestDistance()
	 * @generated
	...
	/**
	 * The flag representing the value of the '{@link #isJumpLinksReverse()
	 * <em>Jump Links Reverse</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isJumpLinksReverse()
	 * @generated
	 * @ordered
	...
	public void setRouting(Routing newRouting) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					NotationPackage.CONNECTOR_STYLE__ROUTING, oldRouting, routing));
	}
	...
	public void setSmoothness(Smoothness newSmoothness) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					NotationPackage.CONNECTOR_STYLE__SMOOTHNESS, oldSmoothness, smoothness));
	}
	...
	public void setAvoidObstructions(boolean newAvoidObstructions) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					NotationPackage.CONNECTOR_STYLE__AVOID_OBSTRUCTIONS, oldAvoidObstructions,
	...
	public void setClosestDistance(boolean newClosestDistance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					NotationPackage.CONNECTOR_STYLE__CLOSEST_DISTANCE, oldClosestDistance, newClosestDistance));
	}
	...
	public void setJumpLinkStatus(JumpLinkStatus newJumpLinkStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					NotationPackage.CONNECTOR_STYLE__JUMP_LINK_STATUS, oldJumpLinkStatus, jumpLinkStatus));
	}
	...
	public void setJumpLinkType(JumpLinkType newJumpLinkType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					NotationPackage.CONNECTOR_STYLE__JUMP_LINK_TYPE, oldJumpLinkType, jumpLinkType));
	}
	...
	public void setJumpLinksReverse(boolean newJumpLinksReverse) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					NotationPackage.CONNECTOR_STYLE__JUMP_LINKS_REVERSE, oldJumpLinksReverse,
					newJumpLinksReverse));
	}
	...
	public void setLineColor(int newLineColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					NotationPackage.CONNECTOR_STYLE__LINE_COLOR, oldLineColor, lineColor));
	}
