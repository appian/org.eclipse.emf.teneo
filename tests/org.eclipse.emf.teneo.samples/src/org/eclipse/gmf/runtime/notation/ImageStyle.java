...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Image Style</b></em>'. <!--
 * end-user-doc -->
 * 
 * <p>
 ...
 * <li>{@link org.eclipse.gmf.runtime.notation.ImageStyle#getMaintainAspectRatio <em>Maintain Aspect
 * Ratio</em>}</li>
...
public interface ImageStyle extends Style {
	/**
	 * Returns the value of the '<em><b>Anti Alias</b></em>' attribute. The default value is
	 * <code>"true"</code>. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Anti Alias</em>' attribute isn't clear, there really should be more
	...
	/**
	 * Sets the value of the '{@link org.eclipse.gmf.runtime.notation.ImageStyle#getAntiAlias
	 * <em>Anti Alias</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Anti Alias</em>' attribute.
	 * @see #getAntiAlias()
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Maintain Aspect Ratio</b></em>' attribute. The default value
	 * is <code>"true"</code>. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Maintain Aspect Ratio</em>' attribute isn't clear, there really
	 ...
	 * <em>Maintain Aspect Ratio</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Maintain Aspect Ratio</em>' attribute.
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Crop Bound</em>' containment reference isn't clear, there really
	 * should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link org.eclipse.gmf.runtime.notation.ImageStyle#getCropBound
	 * <em>Crop Bound</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Crop Bound</em>' containment reference.
	 * @see #getCropBound()
	 * @generated
	 */
