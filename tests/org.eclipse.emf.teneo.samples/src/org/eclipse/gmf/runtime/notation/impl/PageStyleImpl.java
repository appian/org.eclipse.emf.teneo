...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Page Style</b></em>'. <!--
 * end-user-doc -->
 * <p>
 ...
 * <li>{@link org.eclipse.gmf.runtime.notation.impl.PageStyleImpl#getPageHeight <em>Page Height
 * </em>}</li>
 * </ul>
 * </p>
 * 
...
public class PageStyleImpl extends FlatEObjectImpl implements PageStyle {
	...
	public void setPageX(int newPageX) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotationPackage.PAGE_STYLE__PAGE_X,
					oldPageX, pageX));
	}
	...
	public void setPageY(int newPageY) {
		...
		pageY = newPageY;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotationPackage.PAGE_STYLE__PAGE_Y,
					oldPageY, pageY));
	}
	...
	public void setPageWidth(int newPageWidth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotationPackage.PAGE_STYLE__PAGE_WIDTH,
	...
	public void setPageHeight(int newPageHeight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					NotationPackage.PAGE_STYLE__PAGE_HEIGHT, oldPageHeight, pageHeight));
	}
