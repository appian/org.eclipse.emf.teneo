...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Title Style</b></em>'.
 * <p>
...
public interface TitleStyle extends Style {
	/**
	 * Returns the value of the '<em><b>Show Title</b></em>' attribute. The default value is
	...
	/**
	 * Sets the value of the '{@link org.eclipse.gmf.runtime.notation.TitleStyle#isShowTitle
	 * <em>Show Title</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Show Title</em>' attribute.
	 * @see #isShowTitle()
	 * @generated
	 */
