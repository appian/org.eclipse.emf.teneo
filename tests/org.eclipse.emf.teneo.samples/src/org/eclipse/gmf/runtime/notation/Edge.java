...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Edge</b></em>'.
 * <p>
...
public interface Edge extends View {
	 ...
	 * opposite is '{@link org.eclipse.gmf.runtime.notation.View#getSourceEdges <em>Source Edges</em>}
	 * '. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link org.eclipse.gmf.runtime.notation.Edge#getSource <em>Source</em>}'
	 ...
	 * opposite is '{@link org.eclipse.gmf.runtime.notation.View#getTargetEdges <em>Target Edges</em>}
	 * '. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link org.eclipse.gmf.runtime.notation.Edge#getTarget <em>Target</em>}'
	 * reference. <!-- begin-user-doc -->
	 * <p>
	 * The edge's taregt is the view at the target of the edge
	 * </p>
	 ...
	 * begin-user-doc -->
	 * <p>
	 * A bendpoint is a routing constraint installed on edges to suggest that their routing pass
	...
	/**
	 * Sets the value of the '{@link org.eclipse.gmf.runtime.notation.Edge#getBendpoints
	 ...
	 * 
	 * @param value
	 *          the new value of the '<em>Bendpoints</em>' containment reference.
	 * @see #getBendpoints()
	 * @generated
	 */
	 ...
	 * begin-user-doc -->
	 * <p>
	 * A source anchor is a routing constraint installed on edges to identify where the source view
	 * should anchor that edge.
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link org.eclipse.gmf.runtime.notation.Edge#getSourceAnchor
	 * <em>Source Anchor</em>}' containment reference. <!-- begin-user-doc -->
	 * <p>
	 * A source anchor is a routing constraint installed on edges to identify where the source view
	 * should anchor that edge.
	 * </p>
	 ...
	 * 
	 * @param value
	 *          the new value of the '<em>Source Anchor</em>' containment reference.
	 * @see #getSourceAnchor()
	 * @generated
	 */
	 ...
	 * begin-user-doc -->
	 * <p>
	 * A target anchor is a routing constraint installed on edges to identify where the target view
	 * should anchor that edge.
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link org.eclipse.gmf.runtime.notation.Edge#getTargetAnchor
	 * <em>Target Anchor</em>}' containment reference. <!-- begin-user-doc -->
	 * <p>
	 * A target anchor is a routing constraint installed on edges to identify where the target view
	 * should anchor that edge.
	 * </p>
	 ...
	 * 
	 * @param value
	 *          the new value of the '<em>Target Anchor</em>' containment reference.
	 * @see #getTargetAnchor()
	 * @generated
	 */
	 ...
	 * 
	 * @param eClass
	 *          the <code>EClass</code> to be used in creating the <code>Bendpoints</code> object <!--
	 *          end-user-doc -->
	 * @model
	 * @generated
	 */
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * A utility method to create an <code>Anchor</code> object from the given <code>EClass</code> and
	 * then sets the edge's <em>SourceAnchor</em> property to the new object.
	 * </p>
	 * 
	 * @param eClass
	 *          the <code>EClass</code> to be used in creating the <code>Anchor</code> object <!--
	 *          end-user-doc -->
	 * @model
	 * @generated
	 */
	 ...
	 * <p>
	 * A utility method to create an <code>Anchor</code> object from the given <code>EClass</code> and
	 * then sets the edge's <em>TargetAnchor</em> property to the new object.
	 * </p>
	 * 
	 * @param eClass
	 *          the <code>EClass</code> to be used in creating the <code>Anchor</code> object <!--
