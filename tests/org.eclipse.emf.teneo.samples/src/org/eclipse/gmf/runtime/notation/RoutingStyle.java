...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Routing Style</b></em>'.
 * <p>
...
public interface RoutingStyle extends Style {
	...
	/**
	 * Returns the value of the '<em><b>Routing</b></em>' attribute. The default value is
	 * <code>"Manual"</code>. The literals are from the enumeration
	...
	/**
	 * Sets the value of the '{@link org.eclipse.gmf.runtime.notation.RoutingStyle#getRouting
	...
	/**
	 * Returns the value of the '<em><b>Smoothness</b></em>' attribute. The default value is
	...
	/**
	 * Sets the value of the '{@link org.eclipse.gmf.runtime.notation.RoutingStyle#getSmoothness
	...
	/**
	 * Returns the value of the '<em><b>Avoid Obstructions</b></em>' attribute. The default value is
	 ...
	 * 
	 * @param value
	 *          the new value of the '<em>Avoid Obstructions</em>' attribute.
	...
	/**
	 * Returns the value of the '<em><b>Closest Distance</b></em>' attribute. The default value is
	 * <code>"false"</code>. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link org.eclipse.gmf.runtime.notation.RoutingStyle#isClosestDistance
	 ...
	 * 
	 * @param value
	 *          the new value of the '<em>Closest Distance</em>' attribute.
	...
	/**
	 * Returns the value of the '<em><b>Jump Link Status</b></em>' attribute. The default value is
	 * <code>"None"</code>. The literals are from the enumeration
	...
	/**
	 * Sets the value of the '{@link org.eclipse.gmf.runtime.notation.RoutingStyle#getJumpLinkStatus
	...
	/**
	 * Returns the value of the '<em><b>Jump Link Type</b></em>' attribute. The default value is
	 * <code>"Semicircle"</code>. The literals are from the enumeration
	 * {@link org.eclipse.gmf.runtime.notation.JumpLinkType}. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link org.eclipse.gmf.runtime.notation.RoutingStyle#getJumpLinkType
	...
	/**
	 * Returns the value of the '<em><b>Jump Links Reverse</b></em>' attribute. The default value is
	 * <code>"false"</code>. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link org.eclipse.gmf.runtime.notation.RoutingStyle#isJumpLinksReverse
	 ...
	 * 
	 * @param value
	 *          the new value of the '<em>Jump Links Reverse</em>' attribute.
