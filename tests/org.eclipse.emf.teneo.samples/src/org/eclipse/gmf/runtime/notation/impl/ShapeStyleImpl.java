...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Shape Style</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.gmf.runtime.notation.impl.ShapeStyleImpl#getFontColor <em>Font Color</em>}
 * </li>
 * <li>{@link org.eclipse.gmf.runtime.notation.impl.ShapeStyleImpl#getFontName <em>Font Name</em>}</li>
 * <li>{@link org.eclipse.gmf.runtime.notation.impl.ShapeStyleImpl#getFontHeight <em>Font Height
 * </em>}</li>
 ...
 * <li>{@link org.eclipse.gmf.runtime.notation.impl.ShapeStyleImpl#isStrikeThrough <em>Strike
 * Through</em>}</li>
 * <li>{@link org.eclipse.gmf.runtime.notation.impl.ShapeStyleImpl#getDescription <em>Description
 * </em>}</li>
 * <li>{@link org.eclipse.gmf.runtime.notation.impl.ShapeStyleImpl#getFillColor <em>Fill Color</em>}
 * </li>
 * <li>{@link org.eclipse.gmf.runtime.notation.impl.ShapeStyleImpl#getLineColor <em>Line Color</em>}
 * </li>
 * </ul>
 * </p>
 * 
...
public class ShapeStyleImpl extends FlatEObjectImpl implements ShapeStyle {
	...
	/**
	 * The default value of the '{@link #isBold() <em>Bold</em>}' attribute. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @see #isBold()
	 * @generated
	...
	/**
	 * The flag representing the value of the '{@link #isStrikeThrough() <em>Strike Through</em>}'
	...
	public void setFontName(String newFontName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotationPackage.SHAPE_STYLE__FONT_NAME,
	...
	public void setFontHeight(int newFontHeight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					NotationPackage.SHAPE_STYLE__FONT_HEIGHT, oldFontHeight, fontHeight));
	}
	...
	public void setBold(boolean newBold) {
		...
		if (newBold)
			...
			eFlags &= ~BOLD_EFLAG;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotationPackage.SHAPE_STYLE__BOLD,
					oldBold, newBold));
	}
	...
	public void setItalic(boolean newItalic) {
		...
		if (newItalic)
			...
			eFlags &= ~ITALIC_EFLAG;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotationPackage.SHAPE_STYLE__ITALIC,
					oldItalic, newItalic));
	}
	...
	public void setUnderline(boolean newUnderline) {
		...
		if (newUnderline)
			...
			eFlags &= ~UNDERLINE_EFLAG;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotationPackage.SHAPE_STYLE__UNDERLINE,
					oldUnderline, newUnderline));
	}
	...
	public void setStrikeThrough(boolean newStrikeThrough) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					NotationPackage.SHAPE_STYLE__STRIKE_THROUGH, oldStrikeThrough, newStrikeThrough));
	}
	...
	public void setFontColor(int newFontColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					NotationPackage.SHAPE_STYLE__FONT_COLOR, oldFontColor, fontColor));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					NotationPackage.SHAPE_STYLE__DESCRIPTION, oldDescription, description));
	}
	...
	public void setFillColor(int newFillColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					NotationPackage.SHAPE_STYLE__FILL_COLOR, oldFillColor, fillColor));
	}
	...
	public void setLineColor(int newLineColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					NotationPackage.SHAPE_STYLE__LINE_COLOR, oldLineColor, lineColor));
	}
