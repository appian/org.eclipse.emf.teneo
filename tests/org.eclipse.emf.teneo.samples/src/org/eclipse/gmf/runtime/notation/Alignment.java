 ...
 * <em><b>Alignment</b></em>', and utility methods for working with them. <!-- end-user-doc -->
 * 
...
public final class Alignment extends AbstractEnumerator {
	...
	/**
	 * An array of all the '<em><b>Alignment</b></em>' enumerators. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 */
	private static final Alignment[] VALUES_ARRAY = new Alignment[] { LEFT_LITERAL, RIGHT_LITERAL,
			CENTER_LITERAL, TOP_LITERAL, BOTTOM_LITERAL, };

	/**
	 * A public read-only list of all the '<em><b>Alignment</b></em>' enumerators. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	/**
	 * Returns the '<em><b>Alignment</b></em>' literal with the specified name. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
