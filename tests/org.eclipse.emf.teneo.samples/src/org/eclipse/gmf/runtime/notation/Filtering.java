 ...
 * <em><b>Filtering</b></em>', and utility methods for working with them. <!-- end-user-doc -->
 * 
...
public final class Filtering extends AbstractEnumerator {
	...
	/**
	 * The '<em><b>Automatic</b></em>' literal value. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 ...
	 * @ordered
	 */
	public static final Filtering AUTOMATIC_LITERAL = new Filtering(AUTOMATIC,
			"Automatic", "Automatic"); //$NON-NLS-2$//$NON-NLS-1$

	/**
	 * An array of all the '<em><b>Filtering</b></em>' enumerators. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 */
	...
	/**
	 * A public read-only list of all the '<em><b>Filtering</b></em>' enumerators. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	/**
	 * Returns the '<em><b>Filtering</b></em>' literal with the specified name. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
