 ...
 * <em><b>Smoothness</b></em>', and utility methods for working with them. <!-- end-user-doc -->
 * 
...
public final class Smoothness extends AbstractEnumerator {
	...
	/**
	 * The '<em><b>Less</b></em>' literal value. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #LESS_LITERAL
	 * @model name="Less"
	 * @generated
	...
	/**
	 * The '<em><b>More</b></em>' literal value. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #MORE_LITERAL
	 * @model name="More"
	 * @generated
	...
	/**
	 * The '<em><b>More</b></em>' literal object. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #MORE
	 * @generated
	 * @ordered
	...
	/**
	 * An array of all the '<em><b>Smoothness</b></em>' enumerators. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 */
	private static final Smoothness[] VALUES_ARRAY = new Smoothness[] { NONE_LITERAL, NORMAL_LITERAL,
			LESS_LITERAL, MORE_LITERAL, };
	...
	/**
	 * Returns the '<em><b>Smoothness</b></em>' literal with the specified name. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
