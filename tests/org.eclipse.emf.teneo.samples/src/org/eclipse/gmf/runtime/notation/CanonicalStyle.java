...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Canonical Style</b></em>'.
 * <p>
 * Canonical style is a style to be installed on views that need to be synchronized with business
 * model (i.e. notation model would be in synch with business model). Definition of 'in synch' is
 * user-defined.
 * </p>
 * <!-- end-user-doc -->
 * 
...
public interface CanonicalStyle extends Style {
	/**
	 * Returns the value of the '<em><b>Canonical</b></em>' attribute. The default value is
	...
	/**
	 * Sets the value of the '{@link org.eclipse.gmf.runtime.notation.CanonicalStyle#isCanonical
	 * <em>Canonical</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Canonical</em>' attribute.
	 * @see #isCanonical()
	 * @generated
	 */
