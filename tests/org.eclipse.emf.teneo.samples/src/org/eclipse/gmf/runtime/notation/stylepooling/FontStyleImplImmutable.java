...
/**
 * FontStyleImplImmutable is used by FontStyleImplImmutable in order to share common data among the
 * various FontStyleImpl created in the notation.
 * 
...
public class FontStyleImplImmutable extends AbstractStyleImmutable {
	...
	public FontStyleImplImmutable(String name, int height, int color, boolean bStrike,
	...
	static public FontStyleImplImmutable getFontStyle(String sNm, int height, int color,
			boolean bStrike, boolean bUnder, boolean bItalic, boolean bBold) {
		Integer myKey = new Integer(FontStyleImplImmutable.getFontKey(sNm, height, color, bStrike,
				bUnder, bItalic, bBold));
		...
		if (myStylePool.containsKey(myKey)) {
			...
			FontStyleImplImmutable myValue = new FontStyleImplImmutable(sNm, height, color, bStrike,
					bUnder, bItalic, bBold);
	 ...
	 * @return
	 */
	static public int getFontKey(String name, int height, int color, boolean bStrike, boolean bUnder,
			boolean bItalic, boolean bBold) {
