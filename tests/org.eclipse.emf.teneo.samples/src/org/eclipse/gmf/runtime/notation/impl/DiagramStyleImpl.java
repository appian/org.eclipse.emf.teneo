...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Diagram Style</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * <li>{@link org.eclipse.gmf.runtime.notation.impl.DiagramStyleImpl#getPageWidth <em>Page Width
 * </em>}</li>
 * <li>{@link org.eclipse.gmf.runtime.notation.impl.DiagramStyleImpl#getPageHeight <em>Page Height
 * </em>}</li>
 * <li>{@link org.eclipse.gmf.runtime.notation.impl.DiagramStyleImpl#getHorizontalGuides <em>
 * Horizontal Guides</em>}</li>
 * <li>{@link org.eclipse.gmf.runtime.notation.impl.DiagramStyleImpl#getVerticalGuides <em>Vertical
 * Guides</em>}</li>
 * <li>{@link org.eclipse.gmf.runtime.notation.impl.DiagramStyleImpl#getDescription <em>Description
 * </em>}</li>
 * </ul>
 * </p>
 * 
...
public class DiagramStyleImpl extends FlatEObjectImpl implements DiagramStyle {
	/**
	 * The default value of the '{@link #getPageX() <em>Page X</em>}' attribute. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @see #getPageX()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getPageX() <em>Page X</em>}' attribute. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @see #getPageX()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getPageY() <em>Page Y</em>}' attribute. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @see #getPageY()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getPageY() <em>Page Y</em>}' attribute. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @see #getPageY()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getHorizontalGuides() <em>Horizontal Guides</em>}' containment
	...
	/**
	 * The cached value of the '{@link #getVerticalGuides() <em>Vertical Guides</em>}' containment
	 * reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	public void setPageX(int newPageX) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotationPackage.DIAGRAM_STYLE__PAGE_X,
					oldPageX, pageX));
	}
	...
	public void setPageY(int newPageY) {
		...
		pageY = newPageY;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotationPackage.DIAGRAM_STYLE__PAGE_Y,
					oldPageY, pageY));
	}
	...
	public void setPageWidth(int newPageWidth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					NotationPackage.DIAGRAM_STYLE__PAGE_WIDTH, oldPageWidth, pageWidth));
	}
	...
	public void setPageHeight(int newPageHeight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					NotationPackage.DIAGRAM_STYLE__PAGE_HEIGHT, oldPageHeight, pageHeight));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					NotationPackage.DIAGRAM_STYLE__DESCRIPTION, oldDescription, description));
	}
