 ...
 * <em><b>Jump Link Status</b></em>', and utility methods for working with them. <!-- end-user-doc
 * -->
 * 
...
public final class JumpLinkStatus extends AbstractEnumerator {
	...
	/**
	 * The '<em><b>All</b></em>' literal value. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #ALL_LITERAL
	 * @model name="All"
	 * @generated
	...
	/**
	 * An array of all the '<em><b>Jump Link Status</b></em>' enumerators. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	private static final JumpLinkStatus[] VALUES_ARRAY = new JumpLinkStatus[] { NONE_LITERAL,
			ALL_LITERAL, BELOW_LITERAL, ABOVE_LITERAL, };
