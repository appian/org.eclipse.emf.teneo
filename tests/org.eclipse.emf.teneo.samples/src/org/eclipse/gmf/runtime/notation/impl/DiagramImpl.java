 ...
 * <li>{@link org.eclipse.gmf.runtime.notation.impl.DiagramImpl#getPersistedEdges <em>Persisted
 * Edges</em>}</li>
 * <li>{@link org.eclipse.gmf.runtime.notation.impl.DiagramImpl#getTransientEdges <em>Transient
 * Edges</em>}</li>
 * </ul>
 * </p>
 * 
...
public class DiagramImpl extends ViewImpl implements Diagram {
	...
	/**
	 * The flag representing whether the Measurement Unit attribute has been set. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	...
	/**
	 * The cached value of the '{@link #getPersistedEdges() <em>Persisted Edges</em>}' containment
	...
	/**
	 * The cached value of the '{@link #getTransientEdges() <em>Transient Edges</em>}' containment
	 * reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotationPackage.DIAGRAM__NAME, oldName,
					name));
	}
	...
	/**
	 * <!-- begin-user-doc --> Set the Measurement Unit for this Diagram, the Measure ment unit can be
	 * set only once, the set method will not set the value if it was already set <!-- end-user-doc
	 * -->
	 */
		...
		if (!isSetMeasurementUnit()) {
			...
			if (eNotificationRequired())
				eNotify(new ENotificationImpl(this, Notification.SET,
						NotationPackage.DIAGRAM__MEASUREMENT_UNIT, oldMeasurementUnit, measurementUnit,
	...
	public EList getPersistedEdges() {
		if (persistedEdges == null) {
			persistedEdges = new EObjectContainmentEList(Edge.class, this,
					NotationPackage.DIAGRAM__PERSISTED_EDGES);
		}
	...
	public EList getTransientEdges() {
		if (transientEdges == null) {
			transientEdges = new EObjectContainmentEList(Edge.class, this,
					NotationPackage.DIAGRAM__TRANSIENT_EDGES);
		}
