...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Fill Style</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public class FillStyleImpl extends FlatEObjectImpl implements FillStyle {
	...
	public void setFillColor(int newFillColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotationPackage.FILL_STYLE__FILL_COLOR,
