 ...
 * <li>{@link org.eclipse.gmf.runtime.notation.impl.ViewImpl#getPersistedChildren <em>Persisted
 * Children</em>}</li>
 ...
 * <li>{@link org.eclipse.gmf.runtime.notation.impl.ViewImpl#getTransientChildren <em>Transient
 * Children</em>}</li>
 * </ul>
 * </p>
 * 
...
public abstract class ViewImpl extends EModelElementImpl implements View {
	...
	/**
	 * The cached value of the '{@link #getPersistedChildren() <em>Persisted Children</em>}'
	...
	/**
	 * The flag representing whether the Element reference has been set. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	...
	/**
	 * The cached value of the '{@link #getTransientChildren() <em>Transient Children</em>}'
	 * containment reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	public void setVisible(boolean newVisible) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotationPackage.VIEW__VISIBLE,
	...
	public void setType(String newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotationPackage.VIEW__TYPE, oldType,
					type));
	}
	...
	public void setMutable(boolean newMutable) {
		...
		if (newMutable)
			...
			eFlags &= ~MUTABLE_EFLAG;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotationPackage.VIEW__MUTABLE,
					oldMutable, newMutable));
	}
	...
	public EList getSourceEdges() {
		if (sourceEdges == null) {
			sourceEdges = new EObjectWithInverseEList(Edge.class, this,
					NotationPackage.VIEW__SOURCE_EDGES, NotationPackage.EDGE__SOURCE);
		}
		return sourceEdges;
	}
	...
	public EList getTargetEdges() {
		if (targetEdges == null) {
			targetEdges = new EObjectWithInverseEList(Edge.class, this,
					NotationPackage.VIEW__TARGET_EDGES, NotationPackage.EDGE__TARGET);
		}
		return targetEdges;
	}
	...
	public EList getPersistedChildren() {
		if (persistedChildren == null) {
			persistedChildren = new EObjectContainmentEList(Node.class, this,
					NotationPackage.VIEW__PERSISTED_CHILDREN);
		}
	...
	public EObject getElement() {
		...
		if (element != null && element.eIsProxy()) {
			...
			if (element != oldElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, NotationPackage.VIEW__ELEMENT,
							oldElement, element));
			}
		}
	...
	public void setElement(EObject newElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotationPackage.VIEW__ELEMENT,
					oldElement, element, !oldElementESet));
	}
	...
	public void unsetElement() {
		...
		eFlags &= ~ELEMENT_ESETFLAG;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, NotationPackage.VIEW__ELEMENT,
					oldElement, null, oldElementESet));
	}
	...
	public Diagram getDiagram() {
		...
		return diagram != null && diagram.eIsProxy() ? (Diagram) eResolveProxy((InternalEObject) diagram)
				: diagram;
	}
	...
	public EList getTransientChildren() {
		if (transientChildren == null) {
			transientChildren = new EObjectContainmentEList(Node.class, this,
					NotationPackage.VIEW__TRANSIENT_CHILDREN);
		}
