...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Filtering Style</b></em>'.
 * <p>
 ...
 * <li>{@link org.eclipse.gmf.runtime.notation.FilteringStyle#getFilteringKeys <em>Filtering Keys
 * </em>}</li>
 * <li>{@link org.eclipse.gmf.runtime.notation.FilteringStyle#getFilteredObjects <em>Filtered
 * Objects</em>}</li>
 * </ul>
 * </p>
 * 
...
public interface FilteringStyle extends Style {
	/**
	 * Returns the value of the '<em><b>Filtering</b></em>' attribute. The default value is
	...
	/**
	 * Sets the value of the '{@link org.eclipse.gmf.runtime.notation.FilteringStyle#getFiltering
	...
	/**
	 * Returns the value of the '<em><b>Filtering Keys</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	 * The property is an unordered list of string keys to filter on. The keys string are user-defined
	 * and normally used when the <em>Filtering</em> property is set to <em>Automatic</em>
	 * 
	 * The value is a non-modifiable list of <code>java.lang.String</code> objects Any attempt to
	 * change the returned list will result in <code>UnsupportedOperationException</code> thrown;
	...
	/**
	 * Sets the value of the '{@link org.eclipse.gmf.runtime.notation.FilteringStyle#getFilteringKeys
	 ...
	 * 
	 * @param value
	 *          the new value of the '<em>Filtering Keys</em>' attribute. The value cannot be
	 *          <code>null</code>
	 * @see #getFilteringKeys()
	 * @throws NullPointerException
	 *           if the passed list is <code>null</code>
	 * @throws IllegalArgumentException
	 *           if one or more objects in the passed list is not of type
	...
	/**
	 * Returns the value of the '<em><b>Filtered Objects</b></em>' reference list. The list contents
