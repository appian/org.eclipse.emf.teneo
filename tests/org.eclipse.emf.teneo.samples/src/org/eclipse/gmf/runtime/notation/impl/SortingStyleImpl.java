...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Sorting Style</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.gmf.runtime.notation.impl.SortingStyleImpl#getSorting <em>Sorting</em>}</li>
 * <li>{@link org.eclipse.gmf.runtime.notation.impl.SortingStyleImpl#getSortingKeys <em>Sorting Keys
 * </em>}</li>
 * <li>{@link org.eclipse.gmf.runtime.notation.impl.SortingStyleImpl#getSortedObjects <em>Sorted
 * Objects</em>}</li>
 * </ul>
 * </p>
 * 
...
public class SortingStyleImpl extends FlatEObjectImpl implements SortingStyle {
	...
	public void setSorting(Sorting newSorting) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotationPackage.SORTING_STYLE__SORTING,
					oldSorting, sorting));
	}
	...
	public void setSortingKeys(Map newSortingKeys) {
			...
			for (Iterator i = newSortingKeys.keySet().iterator(); i.hasNext();) {
				...
				if (!(key instanceof String))
					throw new IllegalArgumentException(
							"One or more keys in the map is not of type java.lang.String"); //$NON-NLS-1$
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					NotationPackage.SORTING_STYLE__SORTING_KEYS, oldSortingKeys, sortingKeys));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case NotationPackage.SORTING_STYLE__SORTING_KEYS:
			return SORTING_KEYS_EDEFAULT == null ? sortingKeys != null : !SORTING_KEYS_EDEFAULT
					.equals(sortingKeys);
		case NotationPackage.SORTING_STYLE__SORTED_OBJECTS:
