...
public class BoundsImpl extends LocationImpl implements Bounds {
	...
	public void setWidth(int newWidth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotationPackage.BOUNDS__WIDTH,
					oldWidth, width));
	}
	...
	public void setHeight(int newHeight) {
		...
		height = newHeight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotationPackage.BOUNDS__HEIGHT,
					oldHeight, height));
	}
