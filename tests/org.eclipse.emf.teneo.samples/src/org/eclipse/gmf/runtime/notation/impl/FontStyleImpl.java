...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Font Style</b></em>'. <!--
 * end-user-doc -->
 * <p>
 ...
 * <li>{@link org.eclipse.gmf.runtime.notation.impl.FontStyleImpl#getFontHeight <em>Font Height
 * </em>}</li>
 ...
 * <li>{@link org.eclipse.gmf.runtime.notation.impl.FontStyleImpl#isStrikeThrough <em>Strike Through
 * </em>}</li>
 * </ul>
 * </p>
 * 
...
public class FontStyleImpl extends FlatEObjectImpl implements FontStyle {
	...
	public void setFontName(String newFontName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotationPackage.FONT_STYLE__FONT_NAME,
	...
	public void setFontHeight(int newFontHeight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					NotationPackage.FONT_STYLE__FONT_HEIGHT, oldFontHeight, fontHeight));
	}
	...
	public void setBold(boolean newBold) {
		...
		if (newBold)
			...
			eFlags &= ~BOLD_EFLAG;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotationPackage.FONT_STYLE__BOLD,
					oldBold, newBold));
	}
	...
	public void setItalic(boolean newItalic) {
		...
		if (newItalic)
			...
			eFlags &= ~ITALIC_EFLAG;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotationPackage.FONT_STYLE__ITALIC,
					oldItalic, newItalic));
	}
	...
	public void setUnderline(boolean newUnderline) {
		...
		if (newUnderline)
			...
			eFlags &= ~UNDERLINE_EFLAG;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotationPackage.FONT_STYLE__UNDERLINE,
	...
	public void setStrikeThrough(boolean newStrikeThrough) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					NotationPackage.FONT_STYLE__STRIKE_THROUGH, oldStrikeThrough, newStrikeThrough));
	}
	...
	public void setFontColor(int newFontColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotationPackage.FONT_STYLE__FONT_COLOR,
