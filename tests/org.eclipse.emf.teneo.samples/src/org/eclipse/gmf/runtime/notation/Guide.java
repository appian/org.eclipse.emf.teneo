...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Guide</b></em>'.
 * <p>
 * A guide is a constraint on the x-y layout of nodes. A guide is defined by a position along one
 * the of the diagram rulers. Nodes attached to a guide can be attached by a varierty of alignments
 * </p>
 * <!-- end-user-doc -->
 * 
 * <p>
...
public interface Guide extends EObject {
	/**
	 * Returns the value of the '<em><b>Position</b></em>' attribute. The default value is
	...
	/**
	 * Sets the value of the '{@link org.eclipse.gmf.runtime.notation.Guide#getPosition
