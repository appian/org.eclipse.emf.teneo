...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Size</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public class SizeImpl extends FlatEObjectImpl implements Size {
	...
	public void setWidth(int newWidth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotationPackage.SIZE__WIDTH, oldWidth,
					width));
	}
	...
	public void setHeight(int newHeight) {
		...
		height = newHeight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotationPackage.SIZE__HEIGHT,
					oldHeight, height));
	}
