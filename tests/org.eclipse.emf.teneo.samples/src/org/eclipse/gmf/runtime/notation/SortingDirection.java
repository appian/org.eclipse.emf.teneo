 ...
 * <em><b>Sorting Direction</b></em>', and utility methods for working with them. <!-- end-user-doc
 * -->
 * 
...
public final class SortingDirection extends AbstractEnumerator {
	 ...
	 * @ordered
	 */
	public static final SortingDirection ASCENDING_LITERAL = new SortingDirection(ASCENDING,
			"Ascending", "Ascending"); //$NON-NLS-2$//$NON-NLS-1$
	 ...
	 * @ordered
	 */
	public static final SortingDirection DESCENDING_LITERAL = new SortingDirection(DESCENDING,
			"Descending", "Descending"); //$NON-NLS-2$//$NON-NLS-1$

	/**
	 * An array of all the '<em><b>Sorting Direction</b></em>' enumerators. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @generated
	 */
