...
public interface Diagram extends View {
	...
	/**
	 * Sets the value of the '{@link org.eclipse.gmf.runtime.notation.Diagram#getName <em>Name</em>}'
	...
	/**
	 * Returns the value of the '<em><b>Measurement Unit</b></em>' attribute. The default value is
	 * <code>"Himetric"</code>. The literals are from the enumeration
	 * {@link org.eclipse.gmf.runtime.notation.MeasurementUnit}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Measurement Unit</em>' attribute isn't clear, there really should be
	...
	/**
	 * Sets the value of the '{@link org.eclipse.gmf.runtime.notation.Diagram#getMeasurementUnit
	 * <em>Measurement Unit</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Measurement Unit</em>' attribute.
	 * @see org.eclipse.gmf.runtime.notation.MeasurementUnit
	 * @see #isSetMeasurementUnit()
	 * @see #unsetMeasurementUnit()
	...
	/**
	 * Unsets the value of the '{@link org.eclipse.gmf.runtime.notation.Diagram#getMeasurementUnit
	 * <em>Measurement Unit</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isSetMeasurementUnit()
	 * @see #getMeasurementUnit()
	...
	/**
	 * Returns the value of the '<em><b>Edges</b></em>' list. The list contents are of type
	...
	/**
	 * Returns the value of the '<em><b>Persisted Edges</b></em>' containment reference list. The list
	 * contents are of type {@link org.eclipse.gmf.runtime.notation.Edge}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Persisted Edges</em>' containment reference list isn't clear, there
	...
	/**
	 * Returns the value of the '<em><b>Transient Edges</b></em>' containment reference list. The list
	 * contents are of type {@link org.eclipse.gmf.runtime.notation.Edge}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Transient Edges</em>' containment reference list isn't clear, there
	 * really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * 
	 * @param eClass
	 *          the <code>EClass</code> to be used in creating the <code>Edge</code> object <!--
	 *          end-user-doc -->
	 * @model
	 * @generated
	 */
	 ...
	 *          the '<em>Edge</em>' to insert.
	 * @param persisted
	 *          , indicate if the Edge will be persisted or not <!-- end-user-doc -->
	 */
