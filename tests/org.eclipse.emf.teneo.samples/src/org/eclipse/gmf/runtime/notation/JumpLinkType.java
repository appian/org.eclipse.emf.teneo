 ...
 * <em><b>Jump Link Type</b></em>', and utility methods for working with them. <!-- end-user-doc -->
 * 
...
public final class JumpLinkType extends AbstractEnumerator {
	/**
	 * The '<em><b>Semicircle</b></em>' literal value. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The '<em><b>Square</b></em>' literal value. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #SQUARE_LITERAL
	 * @model name="Square"
	 * @generated
	...
	/**
	 * The '<em><b>Chamfered</b></em>' literal value. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The '<em><b>Semicircle</b></em>' literal object. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #SEMICIRCLE
	 * @generated
	 * @ordered
	 */
	public static final JumpLinkType SEMICIRCLE_LITERAL = new JumpLinkType(SEMICIRCLE,
			"Semicircle", "Semicircle"); //$NON-NLS-2$//$NON-NLS-1$
	...
	/**
	 * The '<em><b>Chamfered</b></em>' literal object. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #CHAMFERED
	 * @generated
	 * @ordered
	 */
	public static final JumpLinkType CHAMFERED_LITERAL = new JumpLinkType(CHAMFERED,
			"Chamfered", "Chamfered"); //$NON-NLS-2$//$NON-NLS-1$

	/**
	 * An array of all the '<em><b>Jump Link Type</b></em>' enumerators. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 */
	private static final JumpLinkType[] VALUES_ARRAY = new JumpLinkType[] { SEMICIRCLE_LITERAL,
			SQUARE_LITERAL, CHAMFERED_LITERAL, };
