...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Node Entry</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public class NodeEntryImpl extends FlatEObjectImpl implements BasicEMap.Entry {
			...
			if (key != oldKey) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							NotationPackage.NODE_ENTRY__KEY, oldKey, key));
			}
		}
		return key;
	}
	...
	public void setTypedKey(Node newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotationPackage.NODE_ENTRY__KEY,
					oldKey, key));
	}
	...
	public void setTypedValue(Alignment newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotationPackage.NODE_ENTRY__VALUE,
					oldValue, value));
	}
