 ...
 * <em><b>Sorting</b></em>', and utility methods for working with them. <!-- end-user-doc -->
 * 
...
public final class Sorting extends AbstractEnumerator {
	...
	/**
	 * An array of all the '<em><b>Sorting</b></em>' enumerators. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 */
	private static final Sorting[] VALUES_ARRAY = new Sorting[] { NONE_LITERAL, MANUAL_LITERAL,
			AUTOMATIC_LITERAL, };

	/**
	 * A public read-only list of all the '<em><b>Sorting</b></em>' enumerators. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	/**
	 * Returns the '<em><b>Sorting</b></em>' literal with the specified name. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @generated
	 */
