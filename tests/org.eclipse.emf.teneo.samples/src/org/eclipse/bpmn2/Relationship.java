...
public interface Relationship extends BaseElement {
	/**
	 * Returns the value of the '<em><b>Sources</b></em>' reference list. The list contents are of
	 * type {@link org.eclipse.emf.ecore.EObject}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Sources</em>' reference list isn't clear, there really should be
	 ...
	 * enumeration {@link org.eclipse.bpmn2.RelationshipDirection}. <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @model ordered="false" extendedMetaData="kind='attribute' name='direction'"
	 * @generated
	 */
	RelationshipDirection getDirection();

	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.Relationship#getDirection <em>Direction</em>}'
	 ...
	 * @model required="true" ordered="false" extendedMetaData="kind='attribute' name='type'"
	 * @generated
	 */
	String getType();
