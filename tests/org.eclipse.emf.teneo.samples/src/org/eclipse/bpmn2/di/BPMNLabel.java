...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>BPMN Label</b></em>'. <!--
 * end-user-doc -->
 * 
 * <p>
...
public interface BPMNLabel extends Label {
	/**
	 * Returns the value of the '<em><b>Label Style</b></em>' reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Label Style</em>' reference isn't clear, there really should be more
	 ...
	 * @model ordered="false" extendedMetaData="kind='attribute' name='labelStyle'"
	 * @generated
	 */
	BPMNLabelStyle getLabelStyle();

	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.di.BPMNLabel#getLabelStyle
	 * <em>Label Style</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Label Style</em>' reference.
	 * @see #getLabelStyle()
	 * @generated
	 */
