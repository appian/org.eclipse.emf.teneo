 ...
 * <ul>
 * <li>{@link org.eclipse.bpmn2.CorrelationSubscription#getCorrelationPropertyBinding <em>
 * Correlation Property Binding</em>}</li>
 * <li>{@link org.eclipse.bpmn2.CorrelationSubscription#getCorrelationKeyRef <em>Correlation Key Ref
 * </em>}</li>
 * </ul>
 * </p>
 * 
...
public interface CorrelationSubscription extends BaseElement {
	 ...
	 * list. The list contents are of type {@link org.eclipse.bpmn2.CorrelationPropertyBinding}. <!--
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Correlation Property Binding</em>' containment reference list isn't
	...
	/**
	 * Returns the value of the '<em><b>Correlation Key Ref</b></em>' reference. <!-- begin-user-doc
	 * -->
	 * <p>
	 * If the meaning of the '<em>Correlation Key Ref</em>' reference isn't clear, there really should
	...
	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.CorrelationSubscription#getCorrelationKeyRef
	 * <em>Correlation Key Ref</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Correlation Key Ref</em>' reference.
