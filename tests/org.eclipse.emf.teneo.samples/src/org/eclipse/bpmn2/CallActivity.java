...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Call Activity</b></em>'.
 * <!-- end-user-doc -->
 * 
 * <p>
...
public interface CallActivity extends Activity {
	/**
	 * Returns the value of the '<em><b>Called Element Ref</b></em>' reference. <!-- begin-user-doc
	 * -->
	 * <p>
	 * If the meaning of the '<em>Called Element Ref</em>' reference isn't clear, there really should
	 ...
	 * @model ordered="false" extendedMetaData="kind='attribute' name='calledElement'"
	 * @generated
	 */
	CallableElement getCalledElementRef();

	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.CallActivity#getCalledElementRef
	 * <em>Called Element Ref</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Called Element Ref</em>' reference.
