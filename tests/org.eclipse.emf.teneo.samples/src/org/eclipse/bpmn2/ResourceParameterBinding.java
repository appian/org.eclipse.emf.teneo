...
public interface ResourceParameterBinding extends BaseElement {
	 ...
	 *        "kind='element' name='expression' namespace='http://www.omg.org/spec/BPMN/20100524/MODEL' group='http://www.omg.org/spec/BPMN/20100524/MODEL#expression'"
	 * @generated
	 */
	Expression getExpression();

	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.ResourceParameterBinding#getExpression
	...
	/**
	 * Returns the value of the '<em><b>Parameter Ref</b></em>' reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Parameter Ref</em>' reference isn't clear, there really should be
	 ...
	 * @model required="true" ordered="false" extendedMetaData="kind='attribute' name='parameterRef'"
	 * @generated
	 */
	ResourceParameter getParameterRef();

	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.ResourceParameterBinding#getParameterRef
	 * <em>Parameter Ref</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Parameter Ref</em>' reference.
	 * @see #getParameterRef()
	 * @generated
	 */
