...
public interface Association extends Artifact {
	/**
	 * Returns the value of the '<em><b>Association Direction</b></em>' attribute. The default value
	 * is <code>"None"</code>. The literals are from the enumeration
	 * {@link org.eclipse.bpmn2.AssociationDirection}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Association Direction</em>' attribute isn't clear, there really
	...
	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.Association#getAssociationDirection
	 * <em>Association Direction</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Association Direction</em>' attribute.
	 * @see org.eclipse.bpmn2.AssociationDirection
	...
	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.Association#getSourceRef <em>Source Ref</em>}'
	...
	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.Association#getTargetRef <em>Target Ref</em>}'
	 * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
