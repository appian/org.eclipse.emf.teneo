...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Escalation</b></em>'. <!--
 * end-user-doc -->
 * 
 * <p>
...
public interface Escalation extends RootElement {
	/**
	 * Returns the value of the '<em><b>Escalation Code</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Escalation Code</em>' attribute isn't clear, there really should be
	 ...
	 * @model ordered="false" extendedMetaData="kind='attribute' name='escalationCode'"
	 * @generated
	 */
	String getEscalationCode();

	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.Escalation#getEscalationCode
	 * <em>Escalation Code</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Escalation Code</em>' attribute.
	...
	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.Escalation#getStructureRef
