...
public interface Operation extends BaseElement {
	/**
	 * Returns the value of the '<em><b>In Message Ref</b></em>' reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>In Message Ref</em>' reference isn't clear, there really should be
	 ...
	 *        "kind='element' name='inMessageRef' namespace='http://www.omg.org/spec/BPMN/20100524/MODEL'"
	 * @generated
	 */
	Message getInMessageRef();

	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.Operation#getInMessageRef
	 * <em>In Message Ref</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>In Message Ref</em>' reference.
	 * @see #getInMessageRef()
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Out Message Ref</b></em>' reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Out Message Ref</em>' reference isn't clear, there really should be
	 * more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 *        "kind='element' name='outMessageRef' namespace='http://www.omg.org/spec/BPMN/20100524/MODEL'"
	 * @generated
	 */
	Message getOutMessageRef();

	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.Operation#getOutMessageRef
	 * <em>Out Message Ref</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Out Message Ref</em>' reference.
	...
	/**
	 * Returns the value of the '<em><b>Error Refs</b></em>' reference list. The list contents are of
	 * type {@link org.eclipse.bpmn2.Error}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Error Refs</em>' reference list isn't clear, there really should be
	 * more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * @model ordered="false" extendedMetaData=
	 *        "kind='element' name='errorRef' namespace='http://www.omg.org/spec/BPMN/20100524/MODEL'"
	 * @generated
	 */
	List<org.eclipse.bpmn2.Error> getErrorRefs();

	/**
	 * Returns the value of the '<em><b>Implementation Ref</b></em>' reference. <!-- begin-user-doc
	 * -->
	 * <p>
	 * If the meaning of the '<em>Implementation Ref</em>' reference isn't clear, there really should
	 ...
	 * @model ordered="false" extendedMetaData="kind='attribute' name='implementationRef'"
	 * @generated
	 */
	Object getImplementationRef();

	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.Operation#getImplementationRef
	 * <em>Implementation Ref</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Implementation Ref</em>' reference.
