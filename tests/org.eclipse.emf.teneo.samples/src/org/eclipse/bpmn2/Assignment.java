...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Assignment</b></em>'. <!--
 * end-user-doc -->
 * 
 * <p>
...
public interface Assignment extends BaseElement {
	 ...
	 * <p>
	 * If the meaning of the '<em>From</em>' containment reference isn't clear, there really should be
	 ...
	 *        "kind='element' name='from' namespace='http://www.omg.org/spec/BPMN/20100524/MODEL'"
	 * @generated
	 */
	Expression getFrom();

	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.Assignment#getFrom <em>From</em>}' containment
	 ...
	 * @model containment="true" required="true" ordered="false" extendedMetaData=
	 *        "kind='element' name='to' namespace='http://www.omg.org/spec/BPMN/20100524/MODEL'"
	 * @generated
	 */
	Expression getTo();

	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.Assignment#getTo <em>To</em>}' containment
	 * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
