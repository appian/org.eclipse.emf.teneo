...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Lane</b></em>'. <!--
 * end-user-doc -->
 * 
 * <p>
...
public interface Lane extends BaseElement {
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Partition Element</em>' containment reference isn't clear, there
	 ...
	 *        "kind='element' name='partitionElement' namespace='http://www.omg.org/spec/BPMN/20100524/MODEL'"
	 * @generated
	 */
	BaseElement getPartitionElement();

	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.Lane#getPartitionElement
	 * <em>Partition Element</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @param value
	 *          the new value of the '<em>Partition Element</em>' containment reference.
	...
	/**
	 * Returns the value of the '<em><b>Flow Node Refs</b></em>' reference list. The list contents are
	 * of type {@link org.eclipse.bpmn2.FlowNode}. It is bidirectional and its opposite is '
	 * {@link org.eclipse.bpmn2.FlowNode#getLanes <em>Lanes</em>}'. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Flow Node Refs</em>' reference list isn't clear, there really should
	 ...
	 * @model opposite="lanes" resolveProxies="false" ordered="false" extendedMetaData=
	 *        "kind='element' name='flowNodeRef' namespace='http://www.omg.org/spec/BPMN/20100524/MODEL'"
	 * @generated
	 */
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Child Lane Set</em>' containment reference isn't clear, there really
	 ...
	 * @model containment="true" ordered="false" extendedMetaData=
	 *        "kind='element' name='childLaneSet' namespace='http://www.omg.org/spec/BPMN/20100524/MODEL'"
	 * @generated
	 */
	LaneSet getChildLaneSet();

	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.Lane#getChildLaneSet <em>Child Lane Set</em>}'
	 * containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Child Lane Set</em>' containment reference.
	 * @see #getChildLaneSet()
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Partition Element Ref</b></em>' reference. <!-- begin-user-doc
	 * -->
	 * <p>
	 * If the meaning of the '<em>Partition Element Ref</em>' reference isn't clear, there really
	 * should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * @model ordered="false" extendedMetaData="kind='attribute' name='partitionElementRef'"
	 * @generated
	 */
	BaseElement getPartitionElementRef();

	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.Lane#getPartitionElementRef
	 * <em>Partition Element Ref</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Partition Element Ref</em>' reference.
