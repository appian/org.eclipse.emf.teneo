...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Partner Entity</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class PartnerEntityImpl extends RootElementImpl implements PartnerEntity {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.PARTNER_ENTITY__NAME,
					oldName, name));
	}
