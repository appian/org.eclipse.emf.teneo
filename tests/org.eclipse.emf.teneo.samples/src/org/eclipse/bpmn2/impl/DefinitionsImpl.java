...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Definitions</b></em>'. <!--
 * end-user-doc -->
 * <p>
 ...
 * <li>{@link org.eclipse.bpmn2.impl.DefinitionsImpl#getExpressionLanguage <em>Expression Language
 * </em>}</li>
...
public class DefinitionsImpl extends BaseElementImpl implements Definitions {
	...
	/**
	 * The cached value of the '{@link #getRootElements() <em>Root Elements</em>}' containment
	...
	/**
	 * The cached value of the '{@link #getRelationships() <em>Relationships</em>}' containment
	 * reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The default value of the '{@link #getExpressionLanguage() <em>Expression Language</em>}'
	...
	/**
	 * The cached value of the '{@link #getExpressionLanguage() <em>Expression Language</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getExpressionLanguage()
	 * @generated
	...
	public void setExporter(String newExporter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.DEFINITIONS__EXPORTER,
	...
	public void setExpressionLanguage(String newExpressionLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Bpmn2Package.DEFINITIONS__EXPRESSION_LANGUAGE, oldExpressionLanguage, expressionLanguage));
	}
