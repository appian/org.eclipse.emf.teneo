 ...
 * <li>{@link org.eclipse.bpmn2.impl.LaneImpl#getPartitionElementRef <em>Partition Element Ref</em>}
 * </li>
 * </ul>
 * </p>
 * 
...
public class LaneImpl extends BaseElementImpl implements Lane {
	/**
	 * The cached value of the '{@link #getPartitionElement() <em>Partition Element</em>}' containment
	...
	/**
	 * The cached value of the '{@link #getChildLaneSet() <em>Child Lane Set</em>}' containment
	 * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getChildLaneSet()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getPartitionElementRef() <em>Partition Element Ref</em>}'
	 * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	public void setPartitionElement(BaseElement newPartitionElement) {
		if (newPartitionElement != partitionElement) {
			...
			if (partitionElement != null)
				msgs = ((InternalEObject) partitionElement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- Bpmn2Package.LANE__PARTITION_ELEMENT, null, msgs);
			if (newPartitionElement != null)
				msgs = ((InternalEObject) newPartitionElement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
						- Bpmn2Package.LANE__PARTITION_ELEMENT, null, msgs);
			msgs = basicSetPartitionElement(newPartitionElement, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.LANE__PARTITION_ELEMENT,
	...
	public void setChildLaneSet(LaneSet newChildLaneSet) {
		if (newChildLaneSet != childLaneSet) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.LANE__CHILD_LANE_SET,
					newChildLaneSet, newChildLaneSet));
	}
			...
			if (partitionElementRef != oldPartitionElementRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							Bpmn2Package.LANE__PARTITION_ELEMENT_REF, oldPartitionElementRef, partitionElementRef));
			}
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID,
		...
		case Bpmn2Package.LANE__FLOW_NODE_REFS:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getFlowNodeRefs()).basicAdd(
					otherEnd, msgs);
		}
