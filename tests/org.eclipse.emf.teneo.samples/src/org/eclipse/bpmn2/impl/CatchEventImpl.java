...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Catch Event</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.bpmn2.impl.CatchEventImpl#getDataOutputs <em>Data Outputs</em>}</li>
 * <li>{@link org.eclipse.bpmn2.impl.CatchEventImpl#getDataOutputAssociation <em>Data Output
 * Association</em>}</li>
 ...
 * <li>{@link org.eclipse.bpmn2.impl.CatchEventImpl#getEventDefinitionRefs <em>Event Definition Refs
 * </em>}</li>
...
public abstract class CatchEventImpl extends EventImpl implements CatchEvent {
	/**
	 * The cached value of the '{@link #getDataOutputs() <em>Data Outputs</em>}' containment reference
	...
	/**
	 * The cached value of the '{@link #getDataOutputAssociation() <em>Data Output Association</em>}'
	...
	/**
	 * The cached value of the '{@link #getEventDefinitions() <em>Event Definitions</em>}' containment
	...
	/**
	 * The cached value of the '{@link #getEventDefinitionRefs() <em>Event Definition Refs</em>}'
	 * reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	public List<DataOutputAssociation> getDataOutputAssociation() {
		if (dataOutputAssociation == null) {
			dataOutputAssociation = new EObjectContainmentEList<DataOutputAssociation>(
					DataOutputAssociation.class, this, Bpmn2Package.CATCH_EVENT__DATA_OUTPUT_ASSOCIATION);
		}
	...
	public void setOutputSet(OutputSet newOutputSet) {
		if (newOutputSet != outputSet) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Bpmn2Package.CATCH_EVENT__OUTPUT_SET,
					newOutputSet, newOutputSet));
	}
	...
	public List<EventDefinition> getEventDefinitions() {
		if (eventDefinitions == null) {
			eventDefinitions = new EObjectContainmentEList<EventDefinition>(EventDefinition.class, this,
	...
	public List<EventDefinition> getEventDefinitionRefs() {
		if (eventDefinitionRefs == null) {
			eventDefinitionRefs = new EObjectResolvingEList<EventDefinition>(EventDefinition.class, this,
	...
	public void setParallelMultiple(boolean newParallelMultiple) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Bpmn2Package.CATCH_EVENT__PARALLEL_MULTIPLE, oldParallelMultiple, parallelMultiple));
	}
