 ...
 * <li>{@link org.eclipse.bpmn2.impl.ExtensionAttributeDefinitionImpl#isIsReference <em>Is Reference
 * </em>}</li>
 * <li>{@link org.eclipse.bpmn2.impl.ExtensionAttributeDefinitionImpl#getExtensionDefinition <em>
 * Extension Definition</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class ExtensionAttributeDefinitionImpl extends EObjectImpl implements
	...
	public void setIsReference(boolean newIsReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Bpmn2Package.EXTENSION_ATTRIBUTE_DEFINITION__IS_REFERENCE, oldIsReference, isReference));
	}
