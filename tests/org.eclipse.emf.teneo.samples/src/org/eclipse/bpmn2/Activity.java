...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Activity</b></em>'. <!--
 * end-user-doc -->
 * 
 * <p>
 ...
 * <li>{@link org.eclipse.bpmn2.Activity#getDataOutputAssociations <em>Data Output Associations
 * </em>}</li>
...
public interface Activity extends FlowNode {
	...
	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.Activity#getIoSpecification
	...
	/**
	 * Returns the value of the '<em><b>Boundary Event Refs</b></em>' reference list. The list
	 * contents are of type {@link org.eclipse.bpmn2.BoundaryEvent}. It is bidirectional and its
	 * opposite is '{@link org.eclipse.bpmn2.BoundaryEvent#getAttachedToRef <em>Attached To Ref</em>}
	 * '. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Boundary Event Refs</em>' reference list isn't clear, there really
	 ...
	 * @model opposite="attachedToRef" resolveProxies="false" transient="true" derived="true"
	 *        ordered="false"
	 * @generated
	 */
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Data Input Associations</em>' containment reference list isn't
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Data Output Associations</em>' containment reference list isn't
	 * clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * @model containment="true" ordered="false" extendedMetaData=
	 *        "kind='element' name='loopCharacteristics' namespace='http://www.omg.org/spec/BPMN/20100524/MODEL' group='http://www.omg.org/spec/BPMN/20100524/MODEL#loopCharacteristics'"
	 * @generated
	 */
	LoopCharacteristics getLoopCharacteristics();

	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.Activity#getLoopCharacteristics
	...
	/**
	 * Returns the value of the '<em><b>Completion Quantity</b></em>' attribute. The default value is
	 * <code>"1"</code>. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Completion Quantity</em>' attribute isn't clear, there really should
	...
	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.Activity#getCompletionQuantity
	 * <em>Completion Quantity</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Completion Quantity</em>' attribute.
	...
	/**
	 * Returns the value of the '<em><b>Default</b></em>' reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Default</em>' reference isn't clear, there really should be more of
	 * a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.Activity#getDefault <em>Default</em>}'
	...
	/**
	 * Returns the value of the '<em><b>Is For Compensation</b></em>' attribute. The default value is
	 * <code>"false"</code>. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Is For Compensation</em>' attribute isn't clear, there really should
	 * be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.Activity#isIsForCompensation
	 * <em>Is For Compensation</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Returns the value of the '<em><b>Start Quantity</b></em>' attribute. The default value is
	 * <code>"1"</code>. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Start Quantity</em>' attribute isn't clear, there really should be
	 ...
	 * @model default="1" ordered="false" extendedMetaData="kind='attribute' name='startQuantity'"
	 * @generated
	 */
	int getStartQuantity();

	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.Activity#getStartQuantity
	 * <em>Start Quantity</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Start Quantity</em>' attribute.
