...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Event Based Gateway</b></em>
 * '. <!-- end-user-doc -->
 * 
 * <p>
...
public interface EventBasedGateway extends Gateway {
	/**
	 * Returns the value of the '<em><b>Event Gateway Type</b></em>' attribute. The default value is
	 * <code>"Exclusive"</code>. The literals are from the enumeration
	 * {@link org.eclipse.bpmn2.EventBasedGatewayType}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Event Gateway Type</em>' attribute isn't clear, there really should
	...
	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.EventBasedGateway#getEventGatewayType
	 * <em>Event Gateway Type</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.EventBasedGateway#isInstantiate
	 * <em>Instantiate</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
