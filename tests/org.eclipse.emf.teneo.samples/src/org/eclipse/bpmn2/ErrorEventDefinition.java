...
public interface ErrorEventDefinition extends EventDefinition {
	/**
	 * Returns the value of the '<em><b>Error Ref</b></em>' reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Error Ref</em>' reference isn't clear, there really should be more
	 ...
	 * @model ordered="false" extendedMetaData="kind='attribute' name='errorRef'"
	 * @generated
	 */
	org.eclipse.bpmn2.Error getErrorRef();

	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.ErrorEventDefinition#getErrorRef
	 * <em>Error Ref</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Error Ref</em>' reference.
	 * @see #getErrorRef()
	 * @generated
	 */
