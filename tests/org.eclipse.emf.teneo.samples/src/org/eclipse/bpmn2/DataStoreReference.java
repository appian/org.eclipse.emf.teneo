 ...
 * <em><b>Data Store Reference</b></em>'. <!-- end-user-doc -->
 * 
 * <p>
...
public interface DataStoreReference extends FlowElement, ItemAwareElement {
	/**
	 * Returns the value of the '<em><b>Data Store Ref</b></em>' reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Data Store Ref</em>' reference isn't clear, there really should be
	 ...
	 * @model ordered="false" extendedMetaData="kind='attribute' name='dataStoreRef'"
	 * @generated
	 */
	DataStore getDataStoreRef();

	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.DataStoreReference#getDataStoreRef
	 * <em>Data Store Ref</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Data Store Ref</em>' reference.
	 * @see #getDataStoreRef()
	 * @generated
	 */
