...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Data Input</b></em>'. <!--
 * end-user-doc -->
 * 
 * <p>
 ...
 * <li>{@link org.eclipse.bpmn2.DataInput#getInputSetWithWhileExecuting <em>Input Set With While
 * Executing</em>}</li>
...
public interface DataInput extends ItemAwareElement {
	/**
	 * Returns the value of the '<em><b>Input Set With Optional</b></em>' reference list. The list
	 * contents are of type {@link org.eclipse.bpmn2.InputSet}. It is bidirectional and its opposite
	 * is '{@link org.eclipse.bpmn2.InputSet#getOptionalInputRefs <em>Optional Input Refs</em>}'. <!--
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Input Set With Optional</em>' reference list isn't clear, there
	...
	/**
	 * Returns the value of the '<em><b>Input Set With While Executing</b></em>' reference list. The
	 * list contents are of type {@link org.eclipse.bpmn2.InputSet}. It is bidirectional and its
	 * opposite is '{@link org.eclipse.bpmn2.InputSet#getWhileExecutingInputRefs
	 * <em>While Executing Input Refs</em>}'. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.DataInput#isIsCollection
