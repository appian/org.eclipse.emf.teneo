 ...
 * <ul>
 * <li>{@link org.eclipse.bpmn2.ConversationAssociation#getInnerConversationNodeRef <em>Inner
 * Conversation Node Ref</em>}</li>
 * <li>{@link org.eclipse.bpmn2.ConversationAssociation#getOuterConversationNodeRef <em>Outer
 * Conversation Node Ref</em>}</li>
 * </ul>
 * </p>
 * 
...
public interface ConversationAssociation extends BaseElement {
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Inner Conversation Node Ref</em>' reference isn't clear, there
	 ...
	 * 
	 * @param value
	 *          the new value of the '<em>Inner Conversation Node Ref</em>' reference.
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Outer Conversation Node Ref</em>' reference isn't clear, there
	 * really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * 
	 * @param value
	 *          the new value of the '<em>Outer Conversation Node Ref</em>' reference.
