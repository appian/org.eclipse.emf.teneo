...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Conversation Node</b></em>'.
 * <!-- end-user-doc -->
 * 
 * <p>
...
public interface ConversationNode extends BaseElement, InteractionNode {
	...
	/**
	 * Returns the value of the '<em><b>Message Flow Refs</b></em>' reference list. The list contents
	 * are of type {@link org.eclipse.bpmn2.MessageFlow}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Message Flow Refs</em>' reference list isn't clear, there really
	 * should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 *        "kind='element' name='messageFlowRef' namespace='http://www.omg.org/spec/BPMN/20100524/MODEL'"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.ConversationNode#getName <em>Name</em>}'
