 ...
 * <em><b>Complex Behavior Definition</b></em>'. <!-- end-user-doc -->
 * 
 * <p>
...
public interface ComplexBehaviorDefinition extends BaseElement {
	 ...
	 *        "kind='element' name='condition' namespace='http://www.omg.org/spec/BPMN/20100524/MODEL'"
	 * @generated
	 */
	FormalExpression getCondition();

	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.ComplexBehaviorDefinition#getCondition
	 ...
	 *        "kind='element' name='event' namespace='http://www.omg.org/spec/BPMN/20100524/MODEL'"
	 * @generated
	 */
	ImplicitThrowEvent getEvent();

	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.ComplexBehaviorDefinition#getEvent
	 * <em>Event</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
