...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Sequence Flow</b></em>'.
 * <!-- end-user-doc -->
 * 
 * <p>
...
public interface SequenceFlow extends FlowElement {
	 ...
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Condition Expression</em>' containment reference isn't clear, there
	 ...
	 *        "kind='element' name='conditionExpression' namespace='http://www.omg.org/spec/BPMN/20100524/MODEL'"
	 * @generated
	 */
	Expression getConditionExpression();

	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.SequenceFlow#getConditionExpression
	...
	/**
	 * Returns the value of the '<em><b>Is Immediate</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Is Immediate</em>' attribute isn't clear, there really should be
	 ...
	 * @model ordered="false" extendedMetaData="kind='attribute' name='isImmediate'"
	 * @generated
	 */
	boolean isIsImmediate();

	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.SequenceFlow#isIsImmediate
	 * <em>Is Immediate</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Returns the value of the '<em><b>Source Ref</b></em>' reference. It is bidirectional and its
	 * opposite is '{@link org.eclipse.bpmn2.FlowNode#getOutgoing <em>Outgoing</em>}'. <!--
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Source Ref</em>' reference isn't clear, there really should be more
	...
	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.SequenceFlow#getSourceRef <em>Source Ref</em>}'
	...
	/**
	 * Returns the value of the '<em><b>Target Ref</b></em>' reference. It is bidirectional and its
	 * opposite is '{@link org.eclipse.bpmn2.FlowNode#getIncoming <em>Incoming</em>}'. <!--
	 * begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.SequenceFlow#getTargetRef <em>Target Ref</em>}'
	 * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
