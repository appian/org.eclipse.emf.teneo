...
public interface Group extends Artifact {
	/**
	 * Returns the value of the '<em><b>Category Value Ref</b></em>' reference. <!-- begin-user-doc
	 * -->
	 * <p>
	 * If the meaning of the '<em>Category Value Ref</em>' reference isn't clear, there really should
	 ...
	 * @model ordered="false" extendedMetaData="kind='attribute' name='categoryValueRef'"
	 * @generated
	 */
	CategoryValue getCategoryValueRef();

	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.Group#getCategoryValueRef
	 * <em>Category Value Ref</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Category Value Ref</em>' reference.
