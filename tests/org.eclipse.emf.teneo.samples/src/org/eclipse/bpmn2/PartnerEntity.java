...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Partner Entity</b></em>'.
 * <!-- end-user-doc -->
 * 
 * <p>
...
public interface PartnerEntity extends RootElement {
	/**
	 * Returns the value of the '<em><b>Participant Ref</b></em>' reference list. The list contents
	 * are of type {@link org.eclipse.bpmn2.Participant}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Participant Ref</em>' reference list isn't clear, there really
	...
	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.PartnerEntity#getName <em>Name</em>}'
