...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Sub Process</b></em>'. <!--
 * end-user-doc -->
 * 
 * <p>
...
public interface SubProcess extends Activity, FlowElementsContainer {
	...
	/**
	 * Returns the value of the '<em><b>Triggered By Event</b></em>' attribute. The default value is
	 * <code>"false"</code>. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Triggered By Event</em>' attribute isn't clear, there really should
	...
	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.SubProcess#isTriggeredByEvent
	 * <em>Triggered By Event</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Triggered By Event</em>' attribute.
