...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Item Aware Element</b></em>
 * '. <!-- end-user-doc -->
 * 
 * <p>
...
public interface ItemAwareElement extends BaseElement {
	...
	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.ItemAwareElement#getDataState
	 * <em>Data State</em>}' containment reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Returns the value of the '<em><b>Item Subject Ref</b></em>' reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Item Subject Ref</em>' reference isn't clear, there really should be
	 ...
	 * @model ordered="false" extendedMetaData="kind='attribute' name='itemSubjectRef'"
	 * @generated
	 */
	ItemDefinition getItemSubjectRef();

	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.ItemAwareElement#getItemSubjectRef
	 * <em>Item Subject Ref</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
