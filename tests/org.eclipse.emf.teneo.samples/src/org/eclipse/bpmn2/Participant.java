...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Participant</b></em>'. <!--
 * end-user-doc -->
 * 
 * <p>
 ...
 * <li>{@link org.eclipse.bpmn2.Participant#getParticipantMultiplicity <em>Participant Multiplicity
 * </em>}</li>
...
public interface Participant extends BaseElement, InteractionNode {
	/**
	 * Returns the value of the '<em><b>Interface Refs</b></em>' reference list. The list contents are
	 * of type {@link org.eclipse.bpmn2.Interface}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Interface Refs</em>' reference list isn't clear, there really should
	 ...
	 *        "kind='element' name='interfaceRef' namespace='http://www.omg.org/spec/BPMN/20100524/MODEL'"
	 * @generated
	 */
	List<Interface> getInterfaceRefs();

	/**
	 * Returns the value of the '<em><b>End Point Refs</b></em>' reference list. The list contents are
	 * of type {@link org.eclipse.bpmn2.EndPoint}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>End Point Refs</em>' reference list isn't clear, there really should
	 * be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * @model ordered="false" extendedMetaData=
	 *        "kind='element' name='endPointRef' namespace='http://www.omg.org/spec/BPMN/20100524/MODEL'"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.Participant#getParticipantMultiplicity
	...
	/**
	 * Returns the value of the '<em><b>Process Ref</b></em>' reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Process Ref</em>' reference isn't clear, there really should be more
	 ...
	 * @model ordered="false" extendedMetaData="kind='attribute' name='processRef'"
	 * @generated
	 */
	org.eclipse.bpmn2.Process getProcessRef();

	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.Participant#getProcessRef <em>Process Ref</em>}
	 * ' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Process Ref</em>' reference.
	 * @see #getProcessRef()
	 * @generated
	 */
