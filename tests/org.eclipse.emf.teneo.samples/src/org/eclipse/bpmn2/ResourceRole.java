...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Resource Role</b></em>'.
 * <!-- end-user-doc -->
 * 
 * <p>
 ...
 * <li>{@link org.eclipse.bpmn2.ResourceRole#getResourceParameterBindings <em>Resource Parameter
 * Bindings</em>}</li>
 * <li>{@link org.eclipse.bpmn2.ResourceRole#getResourceAssignmentExpression <em>Resource Assignment
 * Expression</em>}</li>
...
public interface ResourceRole extends BaseElement {
	/**
	 * Returns the value of the '<em><b>Resource Ref</b></em>' reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Resource Ref</em>' reference isn't clear, there really should be
	 ...
	 *        "kind='element' name='resourceRef' namespace='http://www.omg.org/spec/BPMN/20100524/MODEL'"
	 * @generated
	 */
	Resource getResourceRef();

	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.ResourceRole#getResourceRef
	 * <em>Resource Ref</em>}' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Resource Ref</em>' reference.
	 * @see #getResourceRef()
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Resource Parameter Bindings</b></em>' containment reference
	 * list. The list contents are of type {@link org.eclipse.bpmn2.ResourceParameterBinding}. <!--
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Resource Parameter Bindings</em>' containment reference list isn't
	...
	/**
	 * Sets the value of the '{@link org.eclipse.bpmn2.ResourceRole#getResourceAssignmentExpression
