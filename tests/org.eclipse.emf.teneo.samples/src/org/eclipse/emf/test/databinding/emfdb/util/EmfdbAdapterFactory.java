...
public class EmfdbAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected EmfdbSwitch<Adapter> modelSwitch = new EmfdbSwitch<Adapter>() {
		@Override
	 ...
	 * {@link org.eclipse.emf.test.databinding.emfdb.Family <em>Family</em>}'. <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link org.eclipse.emf.test.databinding.emfdb.Person <em>Person</em>}'. <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases; it's useful to
	 * ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link org.eclipse.emf.test.databinding.emfdb.Note <em>Note</em>}'. <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases; it's useful to
	 * ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
