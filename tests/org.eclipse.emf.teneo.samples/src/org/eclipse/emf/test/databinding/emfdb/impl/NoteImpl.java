 ...
 * </copyright>
 *
 * $Id: NoteImpl.java,v 1.1 2009/08/23 16:04:40 mtaal Exp $
 */
 ...
 * <ul>
 * <li>{@link org.eclipse.emf.test.databinding.emfdb.impl.NoteImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class NoteImpl extends EObjectImpl implements Note {
	...
	protected EClass eStaticClass() {
		return EmfdbPackage.Literals.NOTE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfdbPackage.NOTE__NAME, oldName, name));
	}
