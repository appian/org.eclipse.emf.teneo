 ...
 * </copyright>
 *
 * $Id: EdatatypeColumnSwitch.java,v 1.2 2007/02/08 23:09:25 mtaal Exp $
 */
 ...
 * @generated
 */
public class EdatatypeColumnSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case EdatatypeColumnPackage.BOOK: {
