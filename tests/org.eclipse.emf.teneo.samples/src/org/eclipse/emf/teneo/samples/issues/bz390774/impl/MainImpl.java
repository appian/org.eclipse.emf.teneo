 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.samples.issues.bz390774.impl.MainImpl#getSecondary <em>Secondary</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.samples.issues.bz390774.impl.MainImpl#getTest <em>Test</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MainImpl extends EObjectImpl implements Main {
	...
	protected EClass eStaticClass() {
		return Bz390774Package.Literals.MAIN;
	}
		...
		if (secondary != null && secondary.eIsProxy()) {
			...
			if (secondary != oldSecondary) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Bz390774Package.MAIN__SECONDARY, oldSecondary, secondary));
			}
		}
		return secondary;
	}
	...
	public void setSecondary(Secondary newSecondary) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bz390774Package.MAIN__SECONDARY, oldSecondary, secondary));
	}
	...
	public void setTest(String newTest) {
		...
		test = newTest;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bz390774Package.MAIN__TEST, oldTest, test));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Bz390774Package.MAIN__SECONDARY:
				if (resolve) return getSecondary();
				return basicGetSecondary();
			case Bz390774Package.MAIN__TEST:
				return getTest();
		}
