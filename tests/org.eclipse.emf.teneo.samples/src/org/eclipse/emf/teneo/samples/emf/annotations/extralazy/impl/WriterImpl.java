 ...
 * </copyright>
 *
 * $Id: WriterImpl.java,v 1.1 2007/07/09 12:55:20 mtaal Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.samples.emf.annotations.extralazy.impl.WriterImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WriterImpl extends EObjectImpl implements Writer {
	...
	protected EClass eStaticClass() {
		return ExtralazyPackage.Literals.WRITER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtralazyPackage.WRITER__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExtralazyPackage.WRITER__NAME:
				return getName();
		}
