 ...
 * </copyright>
 *
 * $Id: ChildImpl.java,v 1.1 2011/01/20 17:13:39 mtaal Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.samples.emf.annotations.hbcascade.impl.ChildImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ChildImpl extends EObjectImpl implements Child {
	...
	protected EClass eStaticClass() {
		return HbCascadePackage.Literals.CHILD;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HbCascadePackage.CHILD__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case HbCascadePackage.CHILD__NAME:
				return getName();
		}
