 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.samples.emf.annotations.forcedidbag.impl.UserImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.samples.emf.annotations.forcedidbag.impl.UserImpl#getRoles <em>Roles</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UserImpl extends EObjectImpl implements User {
	...
	protected EClass eStaticClass() {
		return ForcedidbagPackage.Literals.USER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ForcedidbagPackage.USER__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ForcedidbagPackage.USER__NAME:
				return getName();
			case ForcedidbagPackage.USER__ROLES:
				return getRoles();
		}
