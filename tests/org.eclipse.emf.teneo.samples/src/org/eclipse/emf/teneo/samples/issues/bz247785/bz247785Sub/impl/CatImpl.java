 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.samples.issues.bz247785.bz247785Sub.impl.CatImpl#getOwner <em>Owner</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CatImpl extends AnimalImpl implements Cat {
	...
	protected EClass eStaticClass() {
		return Bz247785SubPackage.Literals.CAT;
	}
		...
		if (owner != null && owner.eIsProxy()) {
			...
			if (owner != oldOwner) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Bz247785SubPackage.CAT__OWNER, oldOwner, owner));
			}
		}
		return owner;
	}
	...
	public NotificationChain basicSetOwner(Owner newOwner, NotificationChain msgs) {
		...
		owner = newOwner;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Bz247785SubPackage.CAT__OWNER, oldOwner, newOwner);
	...
	public void setOwner(Owner newOwner) {
		if (newOwner != owner) {
			...
			if (owner != null)
				msgs = ((InternalEObject)owner).eInverseRemove(this, Bz247785Package.OWNER__OWNED_CATS, Owner.class, msgs);
			if (newOwner != null)
				msgs = ((InternalEObject)newOwner).eInverseAdd(this, Bz247785Package.OWNER__OWNED_CATS, Owner.class, msgs);
			msgs = basicSetOwner(newOwner, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bz247785SubPackage.CAT__OWNER, newOwner, newOwner));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Bz247785SubPackage.CAT__OWNER:
				if (owner != null)
					msgs = ((InternalEObject)owner).eInverseRemove(this, Bz247785Package.OWNER__OWNED_CATS, Owner.class, msgs);
