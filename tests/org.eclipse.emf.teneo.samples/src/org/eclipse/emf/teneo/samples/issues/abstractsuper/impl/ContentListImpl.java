 ...
 * </copyright>
 *
 * $Id: ContentListImpl.java,v 1.1 2008/03/10 22:19:02 mtaal Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.samples.issues.abstractsuper.impl.ContentListImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.samples.issues.abstractsuper.impl.ContentListImpl#getAddress <em>Address</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.samples.issues.abstractsuper.impl.ContentListImpl#getPrice <em>Price</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ContentListImpl extends EObjectImpl implements ContentList {
	...
	protected EClass eStaticClass() {
		return AbstractsuperPackage.Literals.CONTENT_LIST;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractsuperPackage.CONTENT_LIST__NAME, oldName, name));
	}
	...
	public EList<Address> getAddress() {
		if (address == null) {
			address = new EObjectEList<Address>(Address.class, this, AbstractsuperPackage.CONTENT_LIST__ADDRESS);
		}
		return address;
	}
	...
	public EList<Price> getPrice() {
		if (price == null) {
			price = new EObjectEList<Price>(Price.class, this, AbstractsuperPackage.CONTENT_LIST__PRICE);
		}
		return price;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AbstractsuperPackage.CONTENT_LIST__NAME:
				return getName();
			case AbstractsuperPackage.CONTENT_LIST__ADDRESS:
				return getAddress();
			case AbstractsuperPackage.CONTENT_LIST__PRICE:
				return getPrice();
		}
