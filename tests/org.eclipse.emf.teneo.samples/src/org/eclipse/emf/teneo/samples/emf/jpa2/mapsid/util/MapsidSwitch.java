...
public class MapsidSwitch<T> {
	 ...
	 * @generated
	 */
	protected static MapsidPackage modelPackage;
	...
	public MapsidSwitch() {
		if (modelPackage == null) {
			modelPackage = MapsidPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MapsidPackage.ADDRESS: {
				Address address = (Address)theEObject;
				T result = caseAddress(address);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MapsidPackage.HOUSE: {
				House house = (House)theEObject;
				T result = caseHouse(house);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MapsidPackage.HUMAN: {
				Human human = (Human)theEObject;
				T result = caseHuman(human);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MapsidPackage.HUMAN_CLONE: {
				HumanClone humanClone = (HumanClone)theEObject;
				T result = caseHumanClone(humanClone);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MapsidPackage.NAME: {
				Name name = (Name)theEObject;
				T result = caseName(name);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MapsidPackage.PERSON: {
				Person person = (Person)theEObject;
				T result = casePerson(person);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MapsidPackage.PERSON_IDENTIFIER: {
				PersonIdentifier personIdentifier = (PersonIdentifier)theEObject;
				T result = casePersonIdentifier(personIdentifier);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Human Clone</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Human Clone</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseHumanClone(HumanClone object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Person Identifier</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Person Identifier</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePersonIdentifier(PersonIdentifier object) {
		return null;
	}
