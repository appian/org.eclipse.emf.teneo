 ...
 * </copyright>
 *
 * $Id: Bz282414Switch.java,v 1.1 2009/07/05 00:09:05 mtaal Exp $
 */
 ...
 * <!-- end-user-doc -->
 * @see org.eclipse.emf.teneo.samples.issues.bz282414.Bz282414Package
 * @generated
 */
public class Bz282414Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Bz282414Package.BAR: {
				Bar bar = (Bar)theEObject;
				T result = caseBar(bar);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Bz282414Package.BAR_KEY: {
				BarKey barKey = (BarKey)theEObject;
				T result = caseBarKey(barKey);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Bz282414Package.FOO: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Bar Key</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Bar Key</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBarKey(BarKey object) {
		return null;
	}
