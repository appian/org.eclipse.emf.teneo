 ...
 * </copyright>
 *
 * $Id: Bz288963Switch.java,v 1.1 2009/09/12 04:47:31 mtaal Exp $
 */
...
public class Bz288963Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Bz288963Package.BOOK: {
				Book book = (Book)theEObject;
				T result = caseBook(book);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Bz288963Package.DOCUMENT_ROOT: {
				DocumentRoot documentRoot = (DocumentRoot)theEObject;
				T result = caseDocumentRoot(documentRoot);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Bz288963Package.FOOTNOTE: {
				Footnote footnote = (Footnote)theEObject;
				T result = caseFootnote(footnote);
				if (result == null) result = caseParagraph(footnote);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Bz288963Package.INDENTEDPARA: {
				Indentedpara indentedpara = (Indentedpara)theEObject;
				T result = caseIndentedpara(indentedpara);
				if (result == null) result = caseParagraph(indentedpara);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Bz288963Package.PARAGRAPH: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Indentedpara</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Indentedpara</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseIndentedpara(Indentedpara object) {
		return null;
	}
