...
public class AssociationoverridePackageImpl extends EPackageImpl implements AssociationoverridePackage {
	 ...
	 * @see org.eclipse.emf.teneo.samples.emf.jpa2.associationoverride.AssociationoverridePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * 
	 * <p>This method is used to initialize {@link AssociationoverridePackage#eINSTANCE} when that field is accessed.
	...
	public static AssociationoverridePackage init() {
		...
		AssociationoverridePackageImpl theAssociationoverridePackage = (AssociationoverridePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof AssociationoverridePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new AssociationoverridePackageImpl());
		...
		EPackage.Registry.INSTANCE.put(AssociationoverridePackage.eNS_URI, theAssociationoverridePackage);
	...
	protected void createTeneoAnnotations() {
		...
		addAnnotation
		  (employeeEClass, 
		   source, 
		   new String[] {
			 "appinfo", "@AssociationOverride(name=\"address\" joinTable=@JoinTable(name=\"abc\" joinColumns=@JoinColumn(name=\"employee_addr_id\")))"
		   });				
		addAnnotation
		  (personEClass, 
		   source, 
