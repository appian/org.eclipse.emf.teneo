...
public class EmapPackageImpl extends EPackageImpl implements EmapPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getDateToCategoryMapEntry_Value(), this.getCategory(), "value", null, 0, 1, Map.Entry.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
