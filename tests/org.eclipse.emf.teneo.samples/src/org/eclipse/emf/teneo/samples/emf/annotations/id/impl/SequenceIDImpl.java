 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.samples.emf.annotations.id.impl.SequenceIDImpl#getMyid <em>Myid</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SequenceIDImpl extends EObjectImpl implements SequenceID {
	...
	protected EClass eStaticClass() {
		return IdPackage.Literals.SEQUENCE_ID;
	}
	...
	public void setMyid(long newMyid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IdPackage.SEQUENCE_ID__MYID, oldMyid, myid, !oldMyidESet));
	}
	...
	public void unsetMyid() {
		...
		myidESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, IdPackage.SEQUENCE_ID__MYID, oldMyid, MYID_EDEFAULT, oldMyidESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IdPackage.SEQUENCE_ID__MYID:
				return getMyid();
		}
