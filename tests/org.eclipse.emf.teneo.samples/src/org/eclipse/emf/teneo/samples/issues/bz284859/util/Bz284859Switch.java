 ...
 * </copyright>
 *
 * $Id: Bz284859Switch.java,v 1.1 2009/10/09 22:59:58 mtaal Exp $
 */
...
public class Bz284859Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Bz284859Package.BAR: {
				Bar bar = (Bar)theEObject;
				T result = caseBar(bar);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Bz284859Package.FOO: {
				Foo foo = (Foo)theEObject;
				T result = caseFoo(foo);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Bz284859Package.BAR_DERIVED: {
				BarDerived barDerived = (BarDerived)theEObject;
				T result = caseBarDerived(barDerived);
				if (result == null) result = caseBar(barDerived);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Bar Derived</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Bar Derived</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBarDerived(BarDerived object) {
		return null;
	}
