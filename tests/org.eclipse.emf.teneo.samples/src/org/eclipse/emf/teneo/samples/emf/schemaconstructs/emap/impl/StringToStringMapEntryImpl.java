 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.samples.emf.schemaconstructs.emap.impl.StringToStringMapEntryImpl#getTypedKey <em>Key</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.samples.emf.schemaconstructs.emap.impl.StringToStringMapEntryImpl#getTypedValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StringToStringMapEntryImpl extends EObjectImpl implements BasicEMap.Entry<String,String> {
	...
	public void setTypedKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmapPackage.STRING_TO_STRING_MAP_ENTRY__KEY, oldKey, key));
	}
	...
	public void setTypedValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmapPackage.STRING_TO_STRING_MAP_ENTRY__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EmapPackage.STRING_TO_STRING_MAP_ENTRY__KEY:
				return getTypedKey();
			case EmapPackage.STRING_TO_STRING_MAP_ENTRY__VALUE:
