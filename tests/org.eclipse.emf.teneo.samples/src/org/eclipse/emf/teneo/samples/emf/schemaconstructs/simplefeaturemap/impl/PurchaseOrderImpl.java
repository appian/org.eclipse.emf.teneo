 ...
 * </copyright>
 *
 * $Id: PurchaseOrderImpl.java,v 1.1 2006/07/11 16:57:13 mtaal Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.samples.emf.schemaconstructs.simplefeaturemap.impl.PurchaseOrderImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PurchaseOrderImpl extends EObjectImpl implements PurchaseOrder {
	...
	protected EClass eStaticClass() {
		return SimplefeaturemapPackage.eINSTANCE.getPurchaseOrder();
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimplefeaturemapPackage.PURCHASE_ORDER__NAME, oldName, name));
	}
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			case SimplefeaturemapPackage.PURCHASE_ORDER__NAME:
				return getName();
		}
