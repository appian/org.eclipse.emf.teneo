...
public class IntegerdiscriminatorSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case IntegerdiscriminatorPackage.SUPER: {
				Super super_ = (Super)theEObject;
				T result = caseSuper(super_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IntegerdiscriminatorPackage.SUB: {
				Sub sub = (Sub)theEObject;
				T result = caseSub(sub);
				if (result == null) result = caseSuper(sub);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IntegerdiscriminatorPackage.OTHER_SUB: {
				OtherSub otherSub = (OtherSub)theEObject;
				T result = caseOtherSub(otherSub);
				if (result == null) result = caseSuper(otherSub);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IntegerdiscriminatorPackage.ABSTRACT_SUB: {
				AbstractSub abstractSub = (AbstractSub)theEObject;
				T result = caseAbstractSub(abstractSub);
				if (result == null) result = caseSuper(abstractSub);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Other Sub</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Other Sub</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOtherSub(OtherSub object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Abstract Sub</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Abstract Sub</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
