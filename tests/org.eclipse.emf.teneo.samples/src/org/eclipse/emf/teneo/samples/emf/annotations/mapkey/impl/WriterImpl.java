 ...
 * </copyright>
 *
 * $Id: WriterImpl.java,v 1.1 2007/03/18 19:19:26 mtaal Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.samples.emf.annotations.mapkey.impl.WriterImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WriterImpl extends EObjectImpl implements Writer {
	...
	protected EClass eStaticClass() {
		return MapkeyPackage.Literals.WRITER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MapkeyPackage.WRITER__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MapkeyPackage.WRITER__NAME:
				return getName();
		}
