 ...
 * </copyright>
 *
 * $Id: AttroverridesecondarytableSwitch.java,v 1.1 2008/07/13 13:12:37 mtaal Exp $
 */
...
public class AttroverridesecondarytableSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case AttroverridesecondarytablePackage.PERSON: {
				Person person = (Person)theEObject;
				T result = casePerson(person);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AttroverridesecondarytablePackage.EMPLOYEE: {
			...
			case AttroverridesecondarytablePackage.NON_EMPLOYEE: {
				NonEmployee nonEmployee = (NonEmployee)theEObject;
				T result = caseNonEmployee(nonEmployee);
				if (result == null) result = casePerson(nonEmployee);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AttroverridesecondarytablePackage.COUNTRY: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Non Employee</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Non Employee</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNonEmployee(NonEmployee object) {
		return null;
	}
...
} //AttroverridesecondarytableSwitch
