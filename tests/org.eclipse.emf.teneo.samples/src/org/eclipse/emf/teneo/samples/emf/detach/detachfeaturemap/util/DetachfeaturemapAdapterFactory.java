 ...
 * </copyright>
 *
 * $Id: DetachfeaturemapAdapterFactory.java,v 1.1 2006/07/11 16:57:00 mtaal Exp $
 */
...
public class DetachfeaturemapAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected DetachfeaturemapSwitch modelSwitch =
		new DetachfeaturemapSwitch() {
			...
			public Object caseSpecialPerson(SpecialPerson object) {
				return createSpecialPersonAdapter();
			}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.teneo.samples.emf.detach.detachfeaturemap.Contacts <em>Contacts</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.teneo.samples.emf.detach.detachfeaturemap.Person <em>Person</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.teneo.samples.emf.detach.detachfeaturemap.SpecialPerson <em>Special Person</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
...
} //DetachfeaturemapAdapterFactory
