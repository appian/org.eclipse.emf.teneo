 ...
 * </copyright>
 *
 * $Id: Bz284859AdapterFactory.java,v 1.1 2009/10/09 22:59:58 mtaal Exp $
 */
...
public class Bz284859AdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected Bz284859Switch<Adapter> modelSwitch =
		new Bz284859Switch<Adapter>() {
			@Override
			...
			@Override
			public Adapter caseBarDerived(BarDerived object) {
				return createBarDerivedAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.teneo.samples.issues.bz284859.Bar <em>Bar</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.teneo.samples.issues.bz284859.Foo <em>Foo</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.teneo.samples.issues.bz284859.BarDerived <em>Bar Derived</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
