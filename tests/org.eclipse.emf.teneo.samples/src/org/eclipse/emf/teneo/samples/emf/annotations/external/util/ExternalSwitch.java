 ...
 * </copyright>
 *
 * $Id: ExternalSwitch.java,v 1.1 2008/12/16 20:40:24 mtaal Exp $
 */
...
public class ExternalSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ExternalPackage.EXTERNAL_TEST: {
				ExternalTest externalTest = (ExternalTest)theEObject;
				T result = caseExternalTest(externalTest);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ExternalPackage.EXTERNAL_OBJECT: {
				ExternalObject externalObject = (ExternalObject)theEObject;
				T result = caseExternalObject(externalObject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseExternalTest(ExternalTest object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseExternalObject(ExternalObject object) {
		return null;
	}
