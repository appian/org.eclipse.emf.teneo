 ...
 * </copyright>
 *
 * $Id: SecondarytablehibernateSwitch.java,v 1.5 2010/02/06 18:17:47 mtaal Exp $
 */
 ...
 * @generated
 */
public class SecondarytablehibernateSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public SecondarytablehibernateSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SecondarytablehibernatePackage.PERSON: {
