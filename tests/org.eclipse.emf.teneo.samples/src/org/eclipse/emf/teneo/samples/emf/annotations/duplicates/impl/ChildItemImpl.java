 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.samples.emf.annotations.duplicates.impl.ChildItemImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ChildItemImpl extends EObjectImpl implements ChildItem {
	/**
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DuplicatesPackage.CHILD_ITEM__NAME, oldName, name));
	}
