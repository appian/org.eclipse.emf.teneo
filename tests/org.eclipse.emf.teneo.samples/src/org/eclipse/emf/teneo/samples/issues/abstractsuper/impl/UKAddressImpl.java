 ...
 * </copyright>
 *
 * $Id: UKAddressImpl.java,v 1.1 2008/03/10 22:19:02 mtaal Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.samples.issues.abstractsuper.impl.UKAddressImpl#getPostcode <em>Postcode</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UKAddressImpl extends AddressImpl implements UKAddress {
	...
	protected EClass eStaticClass() {
		return AbstractsuperPackage.Literals.UK_ADDRESS;
	}
	...
	public void setPostcode(String newPostcode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractsuperPackage.UK_ADDRESS__POSTCODE, oldPostcode, postcode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AbstractsuperPackage.UK_ADDRESS__POSTCODE:
				return getPostcode();
		}
