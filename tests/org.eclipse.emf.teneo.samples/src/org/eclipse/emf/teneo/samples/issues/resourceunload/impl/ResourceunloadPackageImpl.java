 ...
 * </copyright>
 *
 * $Id: ResourceunloadPackageImpl.java,v 1.1 2008/04/16 21:08:13 mtaal Exp $
 */
...
public class ResourceunloadPackageImpl extends EPackageImpl implements ResourceunloadPackage {
	 ...
	 * @see org.eclipse.emf.teneo.samples.issues.resourceunload.ResourceunloadPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private ResourceunloadPackageImpl() {
		super(eNS_URI, ResourceunloadFactory.eINSTANCE);
	}
	...
	public static ResourceunloadPackage init() {
		if (isInited) return (ResourceunloadPackage)EPackage.Registry.INSTANCE.getEPackage(ResourceunloadPackage.eNS_URI);

		// Obtain or create and register package
		ResourceunloadPackageImpl theResourceunloadPackage = (ResourceunloadPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof ResourceunloadPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new ResourceunloadPackageImpl());
		...
		theResourceunloadPackage.createPackageContents();

		// Initialize created meta-data
		theResourceunloadPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theResourceunloadPackage.freeze();

		return theResourceunloadPackage;
	}
