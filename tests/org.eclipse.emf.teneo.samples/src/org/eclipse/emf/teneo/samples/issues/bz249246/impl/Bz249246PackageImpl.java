 ...
 * </copyright>
 *
 * $Id: Bz249246PackageImpl.java,v 1.1 2008/10/12 11:24:38 mtaal Exp $
 */
...
public class Bz249246PackageImpl extends EPackageImpl implements Bz249246Package {
	 ...
	 * @see org.eclipse.emf.teneo.samples.issues.bz249246.Bz249246Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Bz249246PackageImpl() {
		super(eNS_URI, Bz249246Factory.eINSTANCE);
	}
	...
	public static Bz249246Package init() {
		if (isInited) return (Bz249246Package)EPackage.Registry.INSTANCE.getEPackage(Bz249246Package.eNS_URI);

		// Obtain or create and register package
		Bz249246PackageImpl theBz249246Package = (Bz249246PackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof Bz249246PackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new Bz249246PackageImpl());
		...
		theBz249246Package.createPackageContents();

		// Initialize created meta-data
		theBz249246Package.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theBz249246Package.freeze();

		return theBz249246Package;
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getStudent_Id(), theXMLTypePackage.getID(), "id", null, 1, 1, Student.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
