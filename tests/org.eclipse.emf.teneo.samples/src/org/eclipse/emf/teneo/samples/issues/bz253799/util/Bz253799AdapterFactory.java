 ...
 * </copyright>
 *
 * $Id: Bz253799AdapterFactory.java,v 1.1 2008/11/15 21:37:31 mtaal Exp $
 */
...
public class Bz253799AdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected Bz253799Switch<Adapter> modelSwitch =
		new Bz253799Switch<Adapter>() {
			@Override
			public Adapter caseOne(One object) {
				return createOneAdapter();
			}
			@Override
			public Adapter caseTwo(Two object) {
				return createTwoAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.teneo.samples.issues.bz253799.One <em>One</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.teneo.samples.issues.bz253799.Two <em>Two</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
