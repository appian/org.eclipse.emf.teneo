 ...
 * </copyright>
 *
 * $Id: NavAdapterFactory.java,v 1.1 2008/03/19 22:25:41 mtaal Exp $
 */
...
public class NavAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected NavSwitch<Adapter> modelSwitch =
		new NavSwitch<Adapter>() {
			@Override
			public Adapter caseNavElement(NavElement object) {
				return createNavElementAdapter();
			}
			@Override
			public Adapter caseNavigationTree(NavigationTree object) {
				return createNavigationTreeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.teneo.samples.issues.nav.NavElement <em>Element</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.teneo.samples.issues.nav.NavigationTree <em>Navigation Tree</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.teneo.samples.issues.nav.PageParams <em>Page Params</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.teneo.samples.issues.nav.RenderParam <em>Render Param</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
