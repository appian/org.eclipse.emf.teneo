 ...
 * </copyright>
 *
 * $Id: WriterImpl.java,v 1.1 2007/07/11 14:40:34 mtaal Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.samples.emf.annotations.entity.impl.WriterImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WriterImpl extends EObjectImpl implements Writer {
	...
	protected EClass eStaticClass() {
		return EntityPackage.Literals.WRITER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EntityPackage.WRITER__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EntityPackage.WRITER__NAME:
				return getName();
		}
