 ...
 * </copyright>
 *
 * $Id: ExternalAdapterFactory.java,v 1.1 2008/12/16 20:40:24 mtaal Exp $
 */
...
public class ExternalAdapterFactory extends AdapterFactoryImpl {
	...
	protected ExternalSwitch<Adapter> modelSwitch =
		new ExternalSwitch<Adapter>() {
			@Override
			public Adapter caseExternalTest(ExternalTest object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.teneo.samples.emf.annotations.external.ExternalTest <em>Test</em>}'.
	 * <!-- begin-user-doc -->
