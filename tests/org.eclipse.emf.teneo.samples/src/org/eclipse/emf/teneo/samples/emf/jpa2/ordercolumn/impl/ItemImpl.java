 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.samples.emf.jpa2.ordercolumn.impl.ItemImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.samples.emf.jpa2.ordercolumn.impl.ItemImpl#getNumber <em>Number</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.samples.emf.jpa2.ordercolumn.impl.ItemImpl#getName2 <em>Name2</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ItemImpl extends EObjectImpl implements Item {
	...
	protected EClass eStaticClass() {
		return OrdercolumnPackage.Literals.ITEM;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OrdercolumnPackage.ITEM__NAME, oldName, name));
	}
	...
	public void setNumber(long newNumber) {
		...
		number = newNumber;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OrdercolumnPackage.ITEM__NUMBER, oldNumber, number));
	}
	...
	public void setName2(String newName2) {
		...
		name2 = newName2;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OrdercolumnPackage.ITEM__NAME2, oldName2, name2));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OrdercolumnPackage.ITEM__NAME:
				return getName();
			case OrdercolumnPackage.ITEM__NUMBER:
				return getNumber();
			case OrdercolumnPackage.ITEM__NAME2:
				return getName2();
		}
