 ...
 * </copyright>
 *
 * $Id: InternationalPriceImpl.java,v 1.1 2008/03/10 22:19:02 mtaal Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.samples.issues.abstractsuper.impl.InternationalPriceImpl#getCurrency <em>Currency</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InternationalPriceImpl extends PriceImpl implements InternationalPrice {
	...
	public void setCurrency(String newCurrency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AbstractsuperPackage.INTERNATIONAL_PRICE__CURRENCY, oldCurrency, currency));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AbstractsuperPackage.INTERNATIONAL_PRICE__CURRENCY:
				return getCurrency();
		}
