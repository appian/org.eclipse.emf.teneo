...
public class AssociationoverrideFactoryImpl extends EFactoryImpl implements AssociationoverrideFactory {
	...
	public static AssociationoverrideFactory init() {
		try {
			AssociationoverrideFactory theAssociationoverrideFactory = (AssociationoverrideFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.eclipse.org/emf/teneo/samples/emf/jpa2/associationoverride"); 
