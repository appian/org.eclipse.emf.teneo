...
import org.eclipse.emf.teneo.samples.issues.bz390775.Bz390775Factory;
 ...
 * @generated
 */
public class Bz390775PackageImpl extends EPackageImpl implements Bz390775Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see org.eclipse.emf.teneo.samples.issues.bz390775.Bz390775Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Bz390775PackageImpl() {
		super(eNS_URI, Bz390775Factory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Bz390775Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Bz390775Package init() {
		if (isInited) return (Bz390775Package)EPackage.Registry.INSTANCE.getEPackage(Bz390775Package.eNS_URI);

		// Obtain or create and register package
		Bz390775PackageImpl theBz390775Package = (Bz390775PackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Bz390775PackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Bz390775PackageImpl());

		isInited = true;

		// Create package meta-data objects
		theBz390775Package.createPackageContents();

		// Initialize created meta-data
		theBz390775Package.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theBz390775Package.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Bz390775Package.eNS_URI, theBz390775Package);
		return theBz390775Package;
	}
	 ...
	 * @generated
	 */
	public Bz390775Factory getBz390775Factory() {
		return (Bz390775Factory)getEFactoryInstance();
	}
