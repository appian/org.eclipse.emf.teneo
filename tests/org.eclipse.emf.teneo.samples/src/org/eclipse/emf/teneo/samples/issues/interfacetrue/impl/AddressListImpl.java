 ...
 * </copyright>
 *
 * $Id: AddressListImpl.java,v 1.1 2008/09/17 20:28:01 mtaal Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.samples.issues.interfacetrue.impl.AddressListImpl#getAddresses <em>Addresses</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AddressListImpl extends EObjectImpl implements AddressList {
	...
	protected EClass eStaticClass() {
		return InterfacetruePackage.Literals.ADDRESS_LIST;
	}
	...
	public EList<Address> getAddresses() {
		if (addresses == null) {
			addresses = new EObjectResolvingEList<Address>(Address.class, this, InterfacetruePackage.ADDRESS_LIST__ADDRESSES);
		}
		return addresses;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case InterfacetruePackage.ADDRESS_LIST__ADDRESSES:
				return getAddresses();
		}
