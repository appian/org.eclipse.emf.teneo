 ...
 * </copyright>
 *
 * $Id: StringToWriterMapEntryImpl.java,v 1.1 2007/03/18 19:19:26 mtaal Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.samples.emf.annotations.mapkey.impl.StringToWriterMapEntryImpl#getTypedKey <em>Key</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.samples.emf.annotations.mapkey.impl.StringToWriterMapEntryImpl#getTypedValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StringToWriterMapEntryImpl extends EObjectImpl implements BasicEMap.Entry<String,Writer> {
	...
	protected EClass eStaticClass() {
		return MapkeyPackage.Literals.STRING_TO_WRITER_MAP_ENTRY;
	}
	...
	public void setTypedKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MapkeyPackage.STRING_TO_WRITER_MAP_ENTRY__KEY, oldKey, key));
	}
	...
	public void setTypedValue(Writer newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MapkeyPackage.STRING_TO_WRITER_MAP_ENTRY__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MapkeyPackage.STRING_TO_WRITER_MAP_ENTRY__KEY:
				return getTypedKey();
			case MapkeyPackage.STRING_TO_WRITER_MAP_ENTRY__VALUE:
