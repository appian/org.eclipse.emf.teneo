...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Font</b></em>'. <!--
 * end-user-doc -->
 * 
 * <p>
...
public interface Font extends EObject {
	/**
	 * Returns the value of the '<em><b>Is Bold</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Is Bold</em>' attribute isn't clear, there really should be more of
	 * a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * @model ordered="false" extendedMetaData="kind='attribute' name='isBold'"
	 * @generated
	 */
	boolean isIsBold();
	 ...
	 * 
	 * @param value
	 *          the new value of the '<em>Is Bold</em>' attribute.
	 * @see #isIsBold()
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Is Italic</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Is Italic</em>' attribute isn't clear, there really should be more
	 ...
	 * @model ordered="false" extendedMetaData="kind='attribute' name='isItalic'"
	 * @generated
	 */
	boolean isIsItalic();
	...
	/**
	 * Returns the value of the '<em><b>Is Strike Through</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Is Strike Through</em>' attribute isn't clear, there really should
	 ...
	 * @model ordered="false" extendedMetaData="kind='attribute' name='isStrikeThrough'"
	 * @generated
	 */
	boolean isIsStrikeThrough();

	/**
	 * Sets the value of the '{@link org.eclipse.dd.dc.Font#isIsStrikeThrough
	 * <em>Is Strike Through</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Is Strike Through</em>' attribute.
	...
	/**
	 * Returns the value of the '<em><b>Is Underline</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Is Underline</em>' attribute isn't clear, there really should be
	 ...
	 * @model ordered="false" extendedMetaData="kind='attribute' name='isUnderline'"
	 * @generated
	 */
	boolean isIsUnderline();

	/**
	 * Sets the value of the '{@link org.eclipse.dd.dc.Font#isIsUnderline <em>Is Underline</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Is Underline</em>' attribute.
	 * @see #isIsUnderline()
	 * @generated
	 */
	 ...
	 * @model ordered="false" extendedMetaData="kind='attribute' name='size'"
	 * @generated
	 */
	float getSize();
	...
	/**
	 * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc --> size >= 0
	 * 
	 * @param diagnostics
