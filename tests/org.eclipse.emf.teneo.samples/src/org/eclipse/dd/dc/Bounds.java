...
public interface Bounds extends EObject {
	 ...
	 * @model required="true" ordered="false" extendedMetaData="kind='attribute' name='height'"
	 * @generated
	 */
	float getHeight();
	 ...
	 * @model required="true" ordered="false" extendedMetaData="kind='attribute' name='width'"
	 * @generated
	 */
	float getWidth();
	 ...
	 * @model default="0" required="true" ordered="false" extendedMetaData="kind='attribute' name='x'"
	 * @generated
	 */
	float getX();
	 ...
	 * @model default="0" required="true" ordered="false" extendedMetaData="kind='attribute' name='y'"
	 * @generated
	 */
	float getY();
