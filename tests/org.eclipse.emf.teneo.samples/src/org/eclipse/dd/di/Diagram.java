 ...
 * @model abstract="true" extendedMetaData="name='Diagram' kind='empty'"
 * @generated
 */
public interface Diagram extends EObject {
	 ...
	 * @model ordered="false" extendedMetaData="kind='attribute' name='documentation'"
	 * @generated
	 */
	String getDocumentation();

	/**
	 * Sets the value of the '{@link org.eclipse.dd.di.Diagram#getDocumentation
	...
	/**
	 * Returns the value of the '<em><b>Owned Style</b></em>' reference list. The list contents are of
	 * type {@link org.eclipse.dd.di.Style}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Owned Style</em>' reference list isn't clear, there really should be
	 * more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the value of the '<em><b>Root Element</b></em>' reference. It is bidirectional and its
	 * opposite is '{@link org.eclipse.dd.di.DiagramElement#getOwningDiagram <em>Owning Diagram</em>}
	 * '. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Root Element</em>' reference isn't clear, there really should be
	 * more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * @model opposite="owningDiagram" resolveProxies="false" required="true" transient="true"
	 ...
	 * <p>
	 * If the meaning of the '<em>Resolution</em>' attribute isn't clear, there really should be more
	 ...
	 * @model ordered="false" extendedMetaData="kind='attribute' name='resolution'"
	 * @generated
	 */
	float getResolution();

	/**
	 * Sets the value of the '{@link org.eclipse.dd.di.Diagram#getResolution <em>Resolution</em>}'
