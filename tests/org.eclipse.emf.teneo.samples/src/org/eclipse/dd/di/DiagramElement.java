...
public interface DiagramElement extends EObject {
	/**
	 * Returns the value of the '<em><b>Owning Diagram</b></em>' reference. It is bidirectional and
	 * its opposite is '{@link org.eclipse.dd.di.Diagram#getRootElement <em>Root Element</em>}'. <!--
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Owning Diagram</em>' reference isn't clear, there really should be
	 ...
	 * @model opposite="rootElement" resolveProxies="false" transient="true" changeable="false"
	...
	/**
	 * Returns the value of the '<em><b>Owning Element</b></em>' reference. It is bidirectional and
	 * its opposite is '{@link org.eclipse.dd.di.DiagramElement#getOwnedElement
	 * <em>Owned Element</em>}'. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Owning Element</em>' reference isn't clear, there really should be
	 * more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * @model opposite="ownedElement" resolveProxies="false" transient="true" changeable="false"
	...
	/**
	 * Returns the value of the '<em><b>Owned Element</b></em>' reference list. The list contents are
	 * of type {@link org.eclipse.dd.di.DiagramElement}. It is bidirectional and its opposite is '
	 * {@link org.eclipse.dd.di.DiagramElement#getOwningElement <em>Owning Element</em>}'. <!--
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Owned Element</em>' reference list isn't clear, there really should
	 ...
	 * @model opposite="owningElement" resolveProxies="false" transient="true" changeable="false"
	 *        derived="true" ordered="false"
	 * @generated
	 */
	 ...
	 * <p>
	 * If the meaning of the '<em>Model Element</em>' reference isn't clear, there really should be
	 * more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the value of the '<em><b>Style</b></em>' reference. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Style</em>' reference isn't clear, there really should be more of a
	 * description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
