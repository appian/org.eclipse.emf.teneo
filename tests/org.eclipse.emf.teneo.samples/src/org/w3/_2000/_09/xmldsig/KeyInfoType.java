...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Key Info Type</b></em>'.
 * <!-- end-user-doc -->
 * 
 * <p>
...
public interface KeyInfoType extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Key Name</b></em>' attribute list. The list contents are of
	 * type {@link java.lang.String}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Key Name</em>' attribute list isn't clear, there really should be
	 ...
	 *        "kind='element' name='KeyName' namespace='##targetNamespace' group='#group:1'"
	 * @generated
	 */
	EList<String> getKeyName();

	/**
	 * Returns the value of the '<em><b>Key Value</b></em>' containment reference list. The list
	 * contents are of type {@link org.w3._2000._09.xmldsig.KeyValueType}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Key Value</em>' containment reference list isn't clear, there really
	 ...
	 *        "kind='element' name='KeyValue' namespace='##targetNamespace' group='#group:1'"
	 * @generated
	 */
	EList<KeyValueType> getKeyValue();

	/**
	 * Returns the value of the '<em><b>Retrieval Method</b></em>' containment reference list. The
	 * list contents are of type {@link org.w3._2000._09.xmldsig.RetrievalMethodType}. <!--
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Retrieval Method</em>' containment reference list isn't clear, there
	 ...
	 * @model containment="true" transient="true" volatile="true" derived="true" extendedMetaData=
	 *        "kind='element' name='RetrievalMethod' namespace='##targetNamespace' group='#group:1'"
	 * @generated
	 */
	EList<RetrievalMethodType> getRetrievalMethod();

	/**
	 * Returns the value of the '<em><b>X509 Data</b></em>' containment reference list. The list
	 * contents are of type {@link org.w3._2000._09.xmldsig.X509DataType}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>X509 Data</em>' containment reference list isn't clear, there really
	 * should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * @model containment="true" transient="true" volatile="true" derived="true" extendedMetaData=
	 *        "kind='element' name='X509Data' namespace='##targetNamespace' group='#group:1'"
	 * @generated
	 */
	EList<X509DataType> getX509Data();

	/**
	 * Returns the value of the '<em><b>PGP Data</b></em>' containment reference list. The list
	 * contents are of type {@link org.w3._2000._09.xmldsig.PGPDataType}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>PGP Data</em>' containment reference list isn't clear, there really
	 * should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * @model containment="true" transient="true" volatile="true" derived="true" extendedMetaData=
	 *        "kind='element' name='PGPData' namespace='##targetNamespace' group='#group:1'"
	 * @generated
	 */
	EList<PGPDataType> getPGPData();

	/**
	 * Returns the value of the '<em><b>SPKI Data</b></em>' containment reference list. The list
	 * contents are of type {@link org.w3._2000._09.xmldsig.SPKIDataType}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>SPKI Data</em>' containment reference list isn't clear, there really
	 * should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * @model containment="true" transient="true" volatile="true" derived="true" extendedMetaData=
	 *        "kind='element' name='SPKIData' namespace='##targetNamespace' group='#group:1'"
	 * @generated
	 */
	EList<SPKIDataType> getSPKIData();

	/**
	 * Returns the value of the '<em><b>Mgmt Data</b></em>' attribute list. The list contents are of
	 * type {@link java.lang.String}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Mgmt Data</em>' attribute list isn't clear, there really should be
	 * more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * @model unique="false" dataType="org.eclipse.emf.ecore.xml.type.String" transient="true"
	 *        volatile="true" derived="true" extendedMetaData=
	 *        "kind='element' name='MgmtData' namespace='##targetNamespace' group='#group:1'"
	 * @generated
	 */
	 ...
	 *        "kind='elementWildcard' wildcards='##other' name=':9' processing='lax' group='#group:1'"
	 * @generated
	 */
	FeatureMap getAny();
	...
	/**
	 * Sets the value of the '{@link org.w3._2000._09.xmldsig.KeyInfoType#getId <em>Id</em>}'
