...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Signed Info Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.w3._2000._09.xmldsig.impl.SignedInfoTypeImpl#getCanonicalizationMethod <em>
 * Canonicalization Method</em>}</li>
 * <li>{@link org.w3._2000._09.xmldsig.impl.SignedInfoTypeImpl#getSignatureMethod <em>Signature
 * Method</em>}</li>
...
public class SignedInfoTypeImpl extends EObjectImpl implements SignedInfoType {
	/**
	 * The cached value of the '{@link #getCanonicalizationMethod() <em>Canonicalization Method</em>}'
	...
	/**
	 * The cached value of the '{@link #getSignatureMethod() <em>Signature Method</em>}' containment
	...
	public NotificationChain basicSetCanonicalizationMethod(
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					XmldsigPackage.SIGNED_INFO_TYPE__CANONICALIZATION_METHOD, oldCanonicalizationMethod,
	...
	public void setCanonicalizationMethod(CanonicalizationMethodType newCanonicalizationMethod) {
		if (newCanonicalizationMethod != canonicalizationMethod) {
			...
			if (canonicalizationMethod != null)
				msgs = ((InternalEObject) canonicalizationMethod).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - XmldsigPackage.SIGNED_INFO_TYPE__CANONICALIZATION_METHOD,
						null, msgs);
			if (newCanonicalizationMethod != null)
				msgs = ((InternalEObject) newCanonicalizationMethod).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - XmldsigPackage.SIGNED_INFO_TYPE__CANONICALIZATION_METHOD,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					XmldsigPackage.SIGNED_INFO_TYPE__CANONICALIZATION_METHOD, newCanonicalizationMethod,
					newCanonicalizationMethod));
	}
	...
	public NotificationChain basicSetSignatureMethod(SignatureMethodType newSignatureMethod,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					XmldsigPackage.SIGNED_INFO_TYPE__SIGNATURE_METHOD, oldSignatureMethod, newSignatureMethod);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setSignatureMethod(SignatureMethodType newSignatureMethod) {
		if (newSignatureMethod != signatureMethod) {
			...
			if (signatureMethod != null)
				msgs = ((InternalEObject) signatureMethod).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
						- XmldsigPackage.SIGNED_INFO_TYPE__SIGNATURE_METHOD, null, msgs);
			if (newSignatureMethod != null)
				msgs = ((InternalEObject) newSignatureMethod).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
						- XmldsigPackage.SIGNED_INFO_TYPE__SIGNATURE_METHOD, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					XmldsigPackage.SIGNED_INFO_TYPE__SIGNATURE_METHOD, newSignatureMethod, newSignatureMethod));
	}
	...
	public EList<ReferenceType> getReference() {
		if (reference == null) {
			reference = new EObjectContainmentEList<ReferenceType>(ReferenceType.class, this,
					XmldsigPackage.SIGNED_INFO_TYPE__REFERENCE);
		}
		return reference;
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmldsigPackage.SIGNED_INFO_TYPE__ID,
					oldId, id));
	}
