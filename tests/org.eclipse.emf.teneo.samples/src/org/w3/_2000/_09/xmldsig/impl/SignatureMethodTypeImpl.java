 ...
 * <em><b>Signature Method Type</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.w3._2000._09.xmldsig.impl.SignatureMethodTypeImpl#getMixed <em>Mixed</em>}</li>
 * <li>{@link org.w3._2000._09.xmldsig.impl.SignatureMethodTypeImpl#getHMACOutputLength <em>HMAC
 * Output Length</em>}</li>
 * <li>{@link org.w3._2000._09.xmldsig.impl.SignatureMethodTypeImpl#getAny <em>Any</em>}</li>
 * <li>{@link org.w3._2000._09.xmldsig.impl.SignatureMethodTypeImpl#getAlgorithm <em>Algorithm</em>}
 * </li>
 * </ul>
 * </p>
 * 
...
public class SignatureMethodTypeImpl extends EObjectImpl implements SignatureMethodType {
	...
	/**
	 * The default value of the '{@link #getHMACOutputLength() <em>HMAC Output Length</em>}'
	...
	public BigInteger getHMACOutputLength() {
		return (BigInteger) getMixed().get(
				XmldsigPackage.Literals.SIGNATURE_METHOD_TYPE__HMAC_OUTPUT_LENGTH, true);
	}
	...
	public void setHMACOutputLength(BigInteger newHMACOutputLength) {
		((FeatureMap.Internal) getMixed()).set(
				XmldsigPackage.Literals.SIGNATURE_METHOD_TYPE__HMAC_OUTPUT_LENGTH, newHMACOutputLength);
	}
	...
	public FeatureMap getAny() {
		return (FeatureMap) getMixed().<FeatureMap.Entry> list(
				XmldsigPackage.Literals.SIGNATURE_METHOD_TYPE__ANY);
	}
	...
	public void setAlgorithm(String newAlgorithm) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					XmldsigPackage.SIGNATURE_METHOD_TYPE__ALGORITHM, oldAlgorithm, algorithm));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case XmldsigPackage.SIGNATURE_METHOD_TYPE__HMAC_OUTPUT_LENGTH:
			return HMAC_OUTPUT_LENGTH_EDEFAULT == null ? getHMACOutputLength() != null
					: !HMAC_OUTPUT_LENGTH_EDEFAULT.equals(getHMACOutputLength());
		case XmldsigPackage.SIGNATURE_METHOD_TYPE__ANY:
