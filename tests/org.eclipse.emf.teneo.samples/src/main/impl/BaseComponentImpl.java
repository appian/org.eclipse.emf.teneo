...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Base Component</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class BaseComponentImpl extends EObjectImpl implements BaseComponent {
	...
	public BaseGroup getGroup() {
		if (eContainerFeatureID != MainPackage.BASE_COMPONENT__GROUP) return null;
	...
	public void setGroup(BaseGroup newGroup) {
		if (newGroup != eInternalContainer() || (eContainerFeatureID != MainPackage.BASE_COMPONENT__GROUP && newGroup != null)) {
			...
			if (newGroup != null)
				msgs = ((InternalEObject)newGroup).eInverseAdd(this, MainPackage.BASE_GROUP__COMPONENTS, BaseGroup.class, msgs);
			msgs = basicSetGroup(newGroup, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.BASE_COMPONENT__GROUP, newGroup, newGroup));
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.BASE_COMPONENT__NAME, oldName, name));
	}
	...
	public void setId(Long newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.BASE_COMPONENT__ID, oldId, id));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID) {
			case MainPackage.BASE_COMPONENT__GROUP:
				return eInternalContainer().eInverseRemove(this, MainPackage.BASE_GROUP__COMPONENTS, BaseGroup.class, msgs);
		}
