...
public class BaseObjectImpl extends BaseComponentImpl implements BaseObject {
	/**
	 * The cached value of the '{@link #getObject1() <em>Object1</em>}' reference. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @see #getObject1()
	 * @generated
			...
			if (object1 != oldObject1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							MainPackage.BASE_OBJECT__OBJECT1, oldObject1, object1));
			}
		}
		return object1;
	}
	...
	public NotificationChain basicSetObject1(ChildObject1 newObject1, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MainPackage.BASE_OBJECT__OBJECT1, oldObject1, newObject1);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setObject1(ChildObject1 newObject1) {
		if (newObject1 != object1) {
			...
			if (object1 != null)
				msgs = ((InternalEObject) object1).eInverseRemove(this,
						MainPackage.CHILD_OBJECT1__LINKED_OBJECT, ChildObject1.class, msgs);
			if (newObject1 != null)
				msgs = ((InternalEObject) newObject1).eInverseAdd(this,
						MainPackage.CHILD_OBJECT1__LINKED_OBJECT, ChildObject1.class, msgs);
			msgs = basicSetObject1(newObject1, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MainPackage.BASE_OBJECT__OBJECT1,
