...
public interface MainFactory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>Child Object2</em>'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Child Object1</em>'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Base Group</em>'. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Base Component</em>'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Child Object3</em>'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Child Object4</em>'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
