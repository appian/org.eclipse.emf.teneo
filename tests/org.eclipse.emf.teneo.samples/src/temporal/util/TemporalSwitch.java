 ...
 * </copyright>
 *
 * $Id: TemporalSwitch.java,v 1.1 2008/04/17 11:33:39 mtaal Exp $
 */
...
public class TemporalSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		...
		case TemporalPackage.VERSION_HOLDER: {
			VersionHolder versionHolder = (VersionHolder) theEObject;
			Object result = caseVersionHolder(versionHolder);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Version Holder</em>'. <!--
	 * begin-user-doc --> This implementation returns null; returning a non-null result will terminate
	 * the switch. <!-- end-user-doc -->
	 * 
	 * @param object
	 *          the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Version Holder</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public Object caseVersionHolder(VersionHolder object) {
		return null;
	}
