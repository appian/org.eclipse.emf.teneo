...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Version Holder</b></em>'.
 * <!-- end-user-doc -->
 * 
 * <p>
...
public interface VersionHolder extends EObject {
	/**
	 * Returns the value of the '<em><b>Versions</b></em>' reference list. The list contents are of
	 * type {@link temporal.Temporal}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Versions</em>' reference list isn't clear, there really should be
	...
	/**
	 * Returns the value of the '<em><b>Index Of Continuity</b></em>' attribute. The default value is
	 * <code>"0"</code>. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Index Of Continuity</em>' attribute isn't clear, there really should
	...
	/**
	 * Sets the value of the '{@link temporal.VersionHolder#getIndexOfContinuity
	 * <em>Index Of Continuity</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *          the new value of the '<em>Index Of Continuity</em>' attribute.
