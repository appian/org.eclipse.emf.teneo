...
/**
 * This is the baseclass for all generated class. It is used to hook in a TemporalEStoreImpl.
 * 
 * 
 * @author jcmcote
 * 
...
public class TemporalBaseEObjectImpl extends DynamicEStoreEObjectImpl {
	...
	/**
	 * Overriden to prevent base class from caching the values returned from the EStore. We want to be
	 * able to control the retrieval of data through the getters.
	 */
	...
	/**
	 * JCC: added this to support versioning of containment features. To version the containment
	 * reference we need to hook into the setter for it. This method is overriden to give us access to
	 * the setting of the containment reference. What this method does is try to find a version to
	 * delegate this setter to. If a version is found it delegates the setter to it. If this is the
	 * version on which it should be performed it does not delegate (it passes the request to its base
	 * class).
	 */
	...
	/**
	 * JCC: added this to support versioning of containment features. To version the containment
	 * reference we need to hook into the getter for it. This method is overriden to give us access to
	 * the getter of the containment reference. What this method does is try to find a version to
	 * delegate this getter to. If a version is found it delegates the getter to it. If this is the
	 * version on which it should be performed it does not delegate (it passes the request to its base
	 * class).
	 */
	...
	/**
	 * JCC: added this to support versioning of containment features. Does it really need to be
	 * overrided?
	 */
	@Override
