...
public class ExtlibraryAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected ExtlibrarySwitch modelSwitch = new ExtlibrarySwitch() {
	...
	/**
	 * Creates a new adapter for an object of class '{@link extlibrary.CirculatingItem
	 * <em>Circulating Item</em>}'. <!-- begin-user-doc --> This default implementation returns null
	...
	/**
	 * Creates a new adapter for an object of class '{@link extlibrary.AudioVisualItem
	 * <em>Audio Visual Item</em>}'. <!-- begin-user-doc --> This default implementation returns null
	 * so that we can easily ignore cases; it's useful to ignore a case when inheritance will catch
	 * all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '{@link extlibrary.BookOnTape
	 * <em>Book On Tape</em>}'. <!-- begin-user-doc --> This default implementation returns null so
	...
	/**
	 * Creates a new adapter for an object of class '{@link extlibrary.VideoCassette
	 * <em>Video Cassette</em>}'. <!-- begin-user-doc --> This default implementation returns null so
	 * that we can easily ignore cases; it's useful to ignore a case when inheritance will catch all
	 * the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '{@link extlibrary.Addressable
	 * <em>Addressable</em>}'. <!-- begin-user-doc --> This default implementation returns null so
	 * that we can easily ignore cases; it's useful to ignore a case when inheritance will catch all
	 * the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
