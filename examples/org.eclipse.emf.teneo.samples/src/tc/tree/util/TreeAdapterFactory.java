 ...
 * </copyright>
 *
 * $Id: TreeAdapterFactory.java,v 1.1 2007/07/09 12:55:20 mtaal Exp $
 */
...
public class TreeAdapterFactory extends AdapterFactoryImpl {
	...
	protected TreeSwitch<Adapter> modelSwitch =
		new TreeSwitch<Adapter>() {
			@Override
			public Adapter caseBigTree(BigTree object) {
				return createBigTreeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link tc.tree.BigTree <em>Big Tree</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createBigTreeAdapter() {
		return null;
	}
