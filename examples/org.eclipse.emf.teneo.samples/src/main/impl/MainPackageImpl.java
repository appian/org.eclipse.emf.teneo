...
public class MainPackageImpl extends EPackageImpl implements MainPackage {
	...
	public static MainPackage init() {
		...
		MainPackageImpl theMainPackage = (MainPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof MainPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new MainPackageImpl());
	...
	public void initializePackageContents() {
		...
		initEClass(childObject2EClass, ChildObject2.class, "ChildObject2", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getChildObject2_Length(), ecorePackage.getEIntegerObject(), "length", null, 0, 1, ChildObject2.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(childObject1EClass, ChildObject1.class, "ChildObject1", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getChildObject1_LinkedObject(), this.getBaseObject(), this.getBaseObject_Object1(), "linkedObject", null, 0, 1, ChildObject1.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(baseObjectEClass, BaseObject.class, "BaseObject", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getBaseObject_Object1(), this.getChildObject1(), this.getChildObject1_LinkedObject(), "object1", null, 0, 1, BaseObject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(baseGroupEClass, BaseGroup.class, "BaseGroup", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getBaseGroup_Components(), this.getBaseComponent(), this.getBaseComponent_Group(), "components", null, 0, -1, BaseGroup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(baseComponentEClass, BaseComponent.class, "BaseComponent", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getBaseComponent_Group(), this.getBaseGroup(), this.getBaseGroup_Components(), "group", null, 0, 1, BaseComponent.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getBaseComponent_Name(), ecorePackage.getEString(), "name", null, 0, 1, BaseComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getBaseComponent_Id(), ecorePackage.getELongObject(), "Id", null, 0, 1, BaseComponent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(childObject3EClass, ChildObject3.class, "ChildObject3", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getChildObject3_Width(), ecorePackage.getEIntegerObject(), "width", null, 0, 1, ChildObject3.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(childObject4EClass, ChildObject4.class, "ChildObject4", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getChildObject4_Thickness(), ecorePackage.getEIntegerObject(), "thickness", null, 0, 1, ChildObject4.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
