 ...
 * </copyright>
 *
 * $Id: SomeResourceImpl.java,v 1.1.2.2 2007/03/18 22:34:03 mtaal Exp $
 */
...
public class SomeResourceImpl extends SomeBaseClassImpl implements SomeResource {
	...
	public EList getNameValuePairs() {
		if (nameValuePairs == null) {
			nameValuePairs = new EObjectResolvingEList(NameValuePair.class, this, TestinheritancePackage.SOME_RESOURCE__NAME_VALUE_PAIRS);
		}
