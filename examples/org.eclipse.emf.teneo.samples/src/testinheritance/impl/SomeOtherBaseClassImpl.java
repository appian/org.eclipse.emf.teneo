 ...
 * </copyright>
 *
 * $Id: SomeOtherBaseClassImpl.java,v 1.1.2.2 2007/03/18 22:34:03 mtaal Exp $
 */
...
public class SomeOtherBaseClassImpl extends EObjectImpl implements SomeOtherBaseClass {
	 ...
	 * @ordered
	 */
	protected EList nameValuePairs = null;
	 ...
	 * @generated
	 */
	public EList getNameValuePairs() {
		if (nameValuePairs == null) {
			nameValuePairs = new EObjectResolvingEList(NameValuePair.class, this, TestinheritancePackage.SOME_OTHER_BASE_CLASS__NAME_VALUE_PAIRS);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case TestinheritancePackage.SOME_OTHER_BASE_CLASS__NAME_VALUE_PAIRS:
				...
				getNameValuePairs().addAll((Collection)newValue);
				return;
		}
