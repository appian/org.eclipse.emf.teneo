 ...
 * </copyright>
 *
 * $Id: ResrcFolder.java,v 1.1 2006/11/23 06:12:07 mtaal Exp $
 */
package lobj;
 ...
 * @model extendedMetaData="name='resrcFolder' kind='elementOnly'"
 * @generated
 */
public interface ResrcFolder extends LearningObject {
	 ...
	 *        extendedMetaData="kind='element' name='resrcFolder' namespace='##targetNamespace'"
	 ...
	 *        extendedMetaData="kind='attribute' name='deleteScheduled'"
	 * @generated
	 */
	 ...
	 *        extendedMetaData="kind='element' name='resrcFile' namespace='##targetNamespace'"
	 *        annotation="http://annotation.elver.org/Indexed value='false'"
	 * @generated
	 */
	EList getResrcFile();
