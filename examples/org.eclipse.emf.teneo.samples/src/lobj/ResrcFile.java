 ...
 * </copyright>
 *
 * $Id: ResrcFile.java,v 1.1 2006/11/23 06:12:07 mtaal Exp $
 */
package lobj;
 ...
 * @model extendedMetaData="name='resrcFile' kind='elementOnly'"
 * @generated
 */
public interface ResrcFile extends LearningObject {
	 ...
	 * @model unique="false" dataType="org.eclipse.emf.ecore.xml.type.Base64Binary"
	 *        extendedMetaData="kind='attribute' name='file_tn'"
	 * @generated
	 */
	byte[] getFile_tn();
	 ...
	 *        extendedMetaData="kind='element' name='hypetextContent' namespace='##targetNamespace'"
