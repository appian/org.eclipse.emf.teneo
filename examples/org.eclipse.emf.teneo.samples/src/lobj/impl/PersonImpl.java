 ...
 * </copyright>
 *
 * $Id: PersonImpl.java,v 1.1 2006/11/23 06:12:09 mtaal Exp $
 */
package lobj.impl;
...
public class PersonImpl extends EObjectImpl implements Person {
	...
	public void setHonorific(String newHonorific) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.PERSON__HONORIFIC, oldHonorific, honorific));
	}
	...
	public void setFirstname(String newFirstname) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.PERSON__FIRSTNAME, oldFirstname, firstname));
	}
	...
	public void setSurname(String newSurname) {
		...
		surname = newSurname;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.PERSON__SURNAME, oldSurname, surname));
	}
	...
	public void setContrib(String newContrib) {
		...
		contrib = newContrib;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.PERSON__CONTRIB, oldContrib, contrib));
	}
	...
	public EList getAffiliations() {
		if (affiliations == null) {
			affiliations = new EObjectContainmentEList(Affiliation.class, this, LobjPackage.PERSON__AFFILIATIONS);
		}
		return affiliations;
	}
	...
	public void setPersonblurb(String newPersonblurb) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.PERSON__PERSONBLURB, oldPersonblurb, personblurb));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case LobjPackage.PERSON__PERSONBLURB:
				return PERSONBLURB_EDEFAULT == null ? personblurb != null : !PERSONBLURB_EDEFAULT.equals(personblurb);
		}
