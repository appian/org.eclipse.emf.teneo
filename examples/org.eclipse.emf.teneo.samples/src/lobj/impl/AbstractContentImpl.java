...
public abstract class AbstractContentImpl extends LearningObjectImpl implements AbstractContent {
	...
	public NotificationChain basicSetSource(Source newSource, NotificationChain msgs) {
		...
		source = newSource;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LobjPackage.ABSTRACT_CONTENT__SOURCE, oldSource, newSource);
	...
	public void setSource(Source newSource) {
		if (newSource != source) {
			...
			if (source != null)
				msgs = ((InternalEObject)source).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LobjPackage.ABSTRACT_CONTENT__SOURCE, null, msgs);
			if (newSource != null)
				msgs = ((InternalEObject)newSource).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LobjPackage.ABSTRACT_CONTENT__SOURCE, null, msgs);
			msgs = basicSetSource(newSource, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.ABSTRACT_CONTENT__SOURCE, newSource, newSource));
	}
