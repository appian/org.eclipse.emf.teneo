 ...
 * </copyright>
 *
 * $Id: NoteImpl.java,v 1.1 2006/11/23 06:12:09 mtaal Exp $
 */
package lobj.impl;
...
public class NoteImpl extends EObjectImpl implements Note {
	...
	public void setNoteAuthor(String newNoteAuthor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.NOTE__NOTE_AUTHOR, oldNoteAuthor, noteAuthor));
	}
	...
	public void setContent(String newContent) {
		...
		content = newContent;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.NOTE__CONTENT, oldContent, content));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case LobjPackage.NOTE__NOTE_AUTHOR:
				return NOTE_AUTHOR_EDEFAULT == null ? noteAuthor != null : !NOTE_AUTHOR_EDEFAULT.equals(noteAuthor);
			case LobjPackage.NOTE__CONTENT:
