 ...
 * </copyright>
 *
 * $Id: PublisherImpl.java,v 1.1 2006/11/23 06:12:09 mtaal Exp $
 */
package lobj.impl;
...
public class PublisherImpl extends EObjectImpl implements Publisher {
	...
	public void setPublishername(String newPublishername) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.PUBLISHER__PUBLISHERNAME, oldPublishername, publishername));
	}
	...
	public NotificationChain basicSetAddress(Address newAddress, NotificationChain msgs) {
		...
		address = newAddress;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LobjPackage.PUBLISHER__ADDRESS, oldAddress, newAddress);
	...
	public void setAddress(Address newAddress) {
		if (newAddress != address) {
			...
			if (address != null)
				msgs = ((InternalEObject)address).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LobjPackage.PUBLISHER__ADDRESS, null, msgs);
			if (newAddress != null)
				msgs = ((InternalEObject)newAddress).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LobjPackage.PUBLISHER__ADDRESS, null, msgs);
			msgs = basicSetAddress(newAddress, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.PUBLISHER__ADDRESS, newAddress, newAddress));
	}
