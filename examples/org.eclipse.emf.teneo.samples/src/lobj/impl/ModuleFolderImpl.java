 ...
 * </copyright>
 *
 * $Id: ModuleFolderImpl.java,v 1.1 2006/11/23 06:12:09 mtaal Exp $
 */
package lobj.impl;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Module Folder</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class ModuleFolderImpl extends LearningObjectImpl implements ModuleFolder {
	...
	public NotificationChain basicSetFolderMeta(FolderMeta newFolderMeta, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LobjPackage.MODULE_FOLDER__FOLDER_META, oldFolderMeta, newFolderMeta);
	...
	public void setFolderMeta(FolderMeta newFolderMeta) {
		if (newFolderMeta != folderMeta) {
			...
			if (folderMeta != null)
				msgs = ((InternalEObject)folderMeta).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LobjPackage.MODULE_FOLDER__FOLDER_META, null, msgs);
			if (newFolderMeta != null)
				msgs = ((InternalEObject)newFolderMeta).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LobjPackage.MODULE_FOLDER__FOLDER_META, null, msgs);
			msgs = basicSetFolderMeta(newFolderMeta, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.MODULE_FOLDER__FOLDER_META, newFolderMeta, newFolderMeta));
	}
	...
	public EList getModuleFolder() {
		if (moduleFolder == null) {
			moduleFolder = new EObjectContainmentEList(ModuleFolder.class, this, LobjPackage.MODULE_FOLDER__MODULE_FOLDER);
		}
		return moduleFolder;
	}
	...
	public NotificationChain basicSetAccessControl(AccessControl newAccessControl, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, LobjPackage.MODULE_FOLDER__ACCESS_CONTROL, oldAccessControl, newAccessControl);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAccessControl(AccessControl newAccessControl) {
		if (newAccessControl != accessControl) {
			...
			if (accessControl != null)
				msgs = ((InternalEObject)accessControl).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - LobjPackage.MODULE_FOLDER__ACCESS_CONTROL, null, msgs);
			if (newAccessControl != null)
				msgs = ((InternalEObject)newAccessControl).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - LobjPackage.MODULE_FOLDER__ACCESS_CONTROL, null, msgs);
			msgs = basicSetAccessControl(newAccessControl, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.MODULE_FOLDER__ACCESS_CONTROL, newAccessControl, newAccessControl));
	}
