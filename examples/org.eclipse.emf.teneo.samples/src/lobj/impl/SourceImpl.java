 ...
 * </copyright>
 *
 * $Id: SourceImpl.java,v 1.1 2006/11/23 06:12:09 mtaal Exp $
 */
package lobj.impl;
 ...
 *   <li>{@link lobj.impl.SourceImpl#getDate <em>Date</em>}</li>
...
public class SourceImpl extends EObjectImpl implements Source {
	...
	public void setDate(Object newDate) {
		...
		date = newDate;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LobjPackage.SOURCE__DATE, oldDate, date));
	}
