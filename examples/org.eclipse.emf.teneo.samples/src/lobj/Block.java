 ...
 * </copyright>
 *
 * $Id: Block.java,v 1.1 2006/11/23 06:12:08 mtaal Exp $
 */
package lobj;
 ...
 *   <li>{@link lobj.Block#getSource <em>Source</em>}</li>
...
public interface Block extends LearningObject {
	 ...
	 *        extendedMetaData="kind='element' name='blockMeta' namespace='##targetNamespace'"
	 * @generated
	 */
	 ...
	 * @see lobj.LobjPackage#getBlock_Source()
	...
	/**
	 * Sets the value of the '{@link lobj.Block#getSource <em>Source</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
