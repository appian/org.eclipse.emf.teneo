 ...
 * </copyright>
 *
 * $Id: BlockFolder.java,v 1.1 2006/11/23 06:12:08 mtaal Exp $
 */
package lobj;
 ...
 * @model extendedMetaData="name='blockFolder' kind='elementOnly'"
 * @generated
 */
public interface BlockFolder extends LearningObject {
	 ...
	 *        extendedMetaData="kind='element' name='blockFolder' namespace='##targetNamespace'"
	 ...
	 *        extendedMetaData="kind='element' name='block' namespace='##targetNamespace'"
	 *        annotation="http://annotation.elver.org/Indexed value='false'"
	 * @generated
	 */
	EList getBlock();
