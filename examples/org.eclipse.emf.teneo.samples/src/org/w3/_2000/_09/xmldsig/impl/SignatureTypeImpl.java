...
public class SignatureTypeImpl extends EObjectImpl implements SignatureType {
	 ...
	 * @generated
	 */
	public NotificationChain basicSetSignatureValue(SignatureValueType newSignatureValue, NotificationChain msgs) {
		SignatureValueType oldSignatureValue = signatureValue;
		signatureValue = newSignatureValue;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XmldsigPackage.SIGNATURE_TYPE__SIGNATURE_VALUE, oldSignatureValue, newSignatureValue);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSignatureValue(SignatureValueType newSignatureValue) {
		if (newSignatureValue != signatureValue) {
			...
			if (signatureValue != null)
				msgs = ((InternalEObject)signatureValue).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XmldsigPackage.SIGNATURE_TYPE__SIGNATURE_VALUE, null, msgs);
			if (newSignatureValue != null)
				msgs = ((InternalEObject)newSignatureValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XmldsigPackage.SIGNATURE_TYPE__SIGNATURE_VALUE, null, msgs);
			msgs = basicSetSignatureValue(newSignatureValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmldsigPackage.SIGNATURE_TYPE__SIGNATURE_VALUE, newSignatureValue, newSignatureValue));
	}
