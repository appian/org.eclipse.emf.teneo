 ...
 * </copyright>
 *
 * $Id: AttroverridesecondarytableAdapterFactory.java,v 1.1 2008/07/13 13:12:37 mtaal Exp $
 */
...
public class AttroverridesecondarytableAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected AttroverridesecondarytableSwitch<Adapter> modelSwitch =
		new AttroverridesecondarytableSwitch<Adapter>() {
			@Override
			...
			@Override
			public Adapter caseNonEmployee(NonEmployee object) {
				return createNonEmployeeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.teneo.samples.emf.annotations.attroverridesecondarytable.Address <em>Address</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.teneo.samples.emf.annotations.attroverridesecondarytable.Person <em>Person</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.teneo.samples.emf.annotations.attroverridesecondarytable.Employee <em>Employee</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.teneo.samples.emf.annotations.attroverridesecondarytable.NonEmployee <em>Non Employee</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.teneo.samples.emf.annotations.attroverridesecondarytable.Country <em>Country</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
...
} //AttroverridesecondarytableAdapterFactory
