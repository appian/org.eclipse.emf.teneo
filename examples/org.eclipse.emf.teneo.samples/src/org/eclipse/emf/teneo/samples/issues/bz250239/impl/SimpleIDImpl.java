 ...
 * </copyright>
 *
 * $Id: SimpleIDImpl.java,v 1.1 2008/10/27 13:18:30 mtaal Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.samples.issues.bz250239.impl.SimpleIDImpl#getAutoID <em>Auto ID</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SimpleIDImpl extends EObjectImpl implements SimpleID {
	...
	public void setAutoID(long newAutoID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bz250239Package.SIMPLE_ID__AUTO_ID, oldAutoID, autoID, !oldAutoIDESet));
	}
	...
	public void unsetAutoID() {
		...
		autoIDESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Bz250239Package.SIMPLE_ID__AUTO_ID, oldAutoID, AUTO_ID_EDEFAULT, oldAutoIDESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Bz250239Package.SIMPLE_ID__AUTO_ID:
