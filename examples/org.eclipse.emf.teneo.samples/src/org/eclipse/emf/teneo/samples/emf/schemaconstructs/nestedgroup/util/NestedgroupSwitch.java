 ...
 * </copyright>
 *
 * $Id: NestedgroupSwitch.java,v 1.1 2006/07/11 16:57:04 mtaal Exp $
 */
 ...
 * @generated
 */
public class NestedgroupSwitch {
	/**
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case NestedgroupPackage.A: {
				A a = (A)theEObject;
				Object result = caseA(a);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NestedgroupPackage.CTYPE: {
				CType cType = (CType)theEObject;
				Object result = caseCType(cType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NestedgroupPackage.ELEMENT: {
	...
	/**
	 * Returns the result of interpretting the object as an instance of '<em>CType</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpretting the object as an instance of '<em>CType</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
