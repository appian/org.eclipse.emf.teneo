 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.samples.issues.nav.impl.PageParamsImpl#getRenderParam <em>Render Param</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.samples.issues.nav.impl.PageParamsImpl#getPageHeader <em>Page Header</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PageParamsImpl extends EObjectImpl implements PageParams {
	...
	public EList<RenderParam> getRenderParam() {
		if (renderParam == null) {
			renderParam = new EObjectContainmentEList<RenderParam>(RenderParam.class, this, NavPackage.PAGE_PARAMS__RENDER_PARAM);
		}
		return renderParam;
	}
	...
	public EList<String> getPageHeader() {
		if (pageHeader == null) {
			pageHeader = new EDataTypeEList<String>(String.class, this, NavPackage.PAGE_PARAMS__PAGE_HEADER);
		}
		return pageHeader;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case NavPackage.PAGE_PARAMS__RENDER_PARAM:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case NavPackage.PAGE_PARAMS__PAGE_HEADER:
