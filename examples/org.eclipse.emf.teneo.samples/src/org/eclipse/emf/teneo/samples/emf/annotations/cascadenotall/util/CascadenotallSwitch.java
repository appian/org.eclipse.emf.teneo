 ...
 * </copyright>
 *
 * $Id: CascadenotallSwitch.java,v 1.2 2007/02/08 23:09:21 mtaal Exp $
 */
 ...
 * @generated
 */
public class CascadenotallSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CascadenotallPackage.BOOK: {
				Book book = (Book)theEObject;
				T result = caseBook(book);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CascadenotallPackage.LIBRARY: {
				Library library = (Library)theEObject;
				T result = caseLibrary(library);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CascadenotallPackage.WRITER: {
