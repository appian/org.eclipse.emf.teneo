 ...
 * </copyright>
 *
 * $Id: SupplierTypeImpl.java,v 1.3 2007/02/08 23:09:24 mtaal Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.samples.emf.sample.product.impl.SupplierTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.samples.emf.sample.product.impl.SupplierTypeImpl#getNoOfEmployees <em>No Of Employees</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SupplierTypeImpl extends EObjectImpl implements SupplierType {
	...
	protected EClass eStaticClass() {
		return ProductPackage.Literals.SUPPLIER_TYPE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProductPackage.SUPPLIER_TYPE__NAME, oldName, name));
	}
	...
	public void setNoOfEmployees(int newNoOfEmployees) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProductPackage.SUPPLIER_TYPE__NO_OF_EMPLOYEES, oldNoOfEmployees, noOfEmployees, !oldNoOfEmployeesESet));
	}
	...
	public void unsetNoOfEmployees() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, ProductPackage.SUPPLIER_TYPE__NO_OF_EMPLOYEES, oldNoOfEmployees, NO_OF_EMPLOYEES_EDEFAULT, oldNoOfEmployeesESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ProductPackage.SUPPLIER_TYPE__NAME:
				return getName();
			case ProductPackage.SUPPLIER_TYPE__NO_OF_EMPLOYEES:
