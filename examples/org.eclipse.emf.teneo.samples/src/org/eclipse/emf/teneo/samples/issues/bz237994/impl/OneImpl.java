 ...
 * </copyright>
 *
 * $Id: OneImpl.java,v 1.1 2008/06/29 14:23:14 mtaal Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.samples.issues.bz237994.impl.OneImpl#getManies <em>Manies</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OneImpl extends EObjectImpl implements One {
	...
	protected EClass eStaticClass() {
		return Bz237994Package.Literals.ONE;
	}
	...
	public EList<Many> getManies() {
		if (manies == null) {
			manies = new EObjectWithInverseEList<Many>(Many.class, this, Bz237994Package.ONE__MANIES, Bz237994Package.MANY__ONE);
		}
		return manies;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Bz237994Package.ONE__MANIES:
