 ...
 * </copyright>
 *
 * $Id: bz242995Switch.java,v 1.1 2008/08/03 19:23:43 mtaal Exp $
 */
...
import org.eclipse.emf.teneo.samples.issues.bz242995.*;
 ...
 * <!-- end-user-doc -->
 * @see org.eclipse.emf.teneo.samples.issues.bz242995.bz242995Package
 * @generated
 */
public class bz242995Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case bz242995Package.BOOK: {
				Book book = (Book)theEObject;
				T result = caseBook(book);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case bz242995Package.LIBRARY: {
				Library library = (Library)theEObject;
				T result = caseLibrary(library);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case bz242995Package.WRITER: {
				Writer writer = (Writer)theEObject;
				T result = caseWriter(writer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case bz242995Package.ONE_TIME_WONDER: {
				OneTimeWonder oneTimeWonder = (OneTimeWonder)theEObject;
				T result = caseOneTimeWonder(oneTimeWonder);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case bz242995Package.AUTHOR: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>One Time Wonder</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>One Time Wonder</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOneTimeWonder(OneTimeWonder object) {
		return null;
	}
