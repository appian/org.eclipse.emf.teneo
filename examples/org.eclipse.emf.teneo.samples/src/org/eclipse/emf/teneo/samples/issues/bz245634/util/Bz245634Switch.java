 ...
 * </copyright>
 *
 * $Id: Bz245634Switch.java,v 1.1 2008/09/21 18:35:58 mtaal Exp $
 */
...
public class Bz245634Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Bz245634Package.CITY: {
				City city = (City)theEObject;
				T result = caseCity(city);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Bz245634Package.MAYOR: {
				Mayor mayor = (Mayor)theEObject;
				T result = caseMayor(mayor);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Bz245634Package.POLICE_CHIEF: {
				PoliceChief policeChief = (PoliceChief)theEObject;
				T result = casePoliceChief(policeChief);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Bz245634Package.COUNTRY: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Police Chief</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Police Chief</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePoliceChief(PoliceChief object) {
		return null;
	}
