 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.samples.issues.interfacetrue.impl.USAddressImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.samples.issues.interfacetrue.impl.USAddressImpl#getState <em>State</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class USAddressImpl extends EObjectImpl implements USAddress {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InterfacetruePackage.US_ADDRESS__NAME, oldName, name));
	}
	...
	public void setState(String newState) {
		...
		state = newState;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InterfacetruePackage.US_ADDRESS__STATE, oldState, state));
	}
