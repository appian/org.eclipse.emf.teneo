 ...
 * </copyright>
 *
 * $Id: SecondarySwitch.java,v 1.1 2008/06/10 05:25:51 mtaal Exp $
 */
 ...
 * @generated
 */
public class SecondarySwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SecondaryPackage.GENERIC: {
				Generic generic = (Generic)theEObject;
				T result = caseGeneric(generic);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SecondaryPackage.PERSON: {
				Person person = (Person)theEObject;
				T result = casePerson(person);
				if (result == null) result = caseGeneric(person);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
