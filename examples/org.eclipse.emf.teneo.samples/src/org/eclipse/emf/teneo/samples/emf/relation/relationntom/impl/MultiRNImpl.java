 ...
 * </copyright>
 *
 * $Id: MultiRNImpl.java,v 1.1 2006/07/11 16:57:11 mtaal Exp $
 */
...
public class MultiRNImpl extends EObjectImpl implements MultiRN {
	...
	protected EClass eStaticClass() {
		return RelationntomPackage.eINSTANCE.getMultiRN();
	}
	...
	public EList getMain() {
		if (main == null) {
			main = new EObjectWithInverseResolvingEList.ManyInverse(Main.class, this, RelationntomPackage.MULTI_RN__MAIN, RelationntomPackage.MAIN__MULTIRN);
		}
		return main;
	}
