 ...
 * </copyright>
 *
 * $Id: Bz237498PackageImpl.java,v 1.1 2008/06/28 22:41:35 mtaal Exp $
 */
 ...
 * @generated
 */
public class Bz237498PackageImpl extends EPackageImpl implements Bz237498Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see org.eclipse.emf.teneo.samples.issues.bz237498.Bz237498Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Bz237498PackageImpl() {
		super(eNS_URI, Bz237498Factory.eINSTANCE);
	}
	 ...
	 * @generated
	 */
	public static Bz237498Package init() {
		if (isInited) return (Bz237498Package)EPackage.Registry.INSTANCE.getEPackage(Bz237498Package.eNS_URI);

		// Obtain or create and register package
		Bz237498PackageImpl theBz237498Package = (Bz237498PackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof Bz237498PackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new Bz237498PackageImpl());

		isInited = true;

		// Create package meta-data objects
		theBz237498Package.createPackageContents();

		// Initialize created meta-data
		theBz237498Package.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theBz237498Package.freeze();

		return theBz237498Package;
	}
	 ...
	 * @generated
	 */
	public Bz237498Factory getBz237498Factory() {
		return (Bz237498Factory)getEFactoryInstance();
	}
