...
public class DynamicPackageImpl extends EPackageImpl implements DynamicPackage {
	 ...
	 * @see org.eclipse.emf.teneo.samples.emf.sample.dynamic.DynamicPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static DynamicPackage init() {
		...
		DynamicPackageImpl theDynamicPackage = (DynamicPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof DynamicPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new DynamicPackageImpl());
	...
	public void createPackageContents() {
		...
		createEAttribute(personEClass, PERSON__GROUP);
		createEAttribute(personEClass, PERSON__AGE);
		createEAttribute(personEClass, PERSON__LENGTH);
	}
	...
	public void initializePackageContents() {
		...
		initEAttribute(getPerson_Group(), ecorePackage.getEFeatureMapEntry(), "group", null, 0, -1, Person.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPerson_Age(), theXMLTypePackage.getInt(), "age", null, 0, -1, Person.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getPerson_Length(), theXMLTypePackage.getInt(), "length", null, 0, -1, Person.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
