 ...
 * </copyright>
 *
 * $Id: OneImpl.java,v 1.1 2008/09/01 12:45:05 mtaal Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.samples.issues.bz243024.impl.OneImpl#getManies <em>Manies</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OneImpl extends EObjectImpl implements One {
	...
	protected EClass eStaticClass() {
		return Bz243024Package.Literals.ONE;
	}
	...
	public EList<Many> getManies() {
		if (manies == null) {
			manies = new EObjectEList<Many>(Many.class, this, Bz243024Package.ONE__MANIES);
		}
		return manies;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Bz243024Package.ONE__MANIES:
				return getManies();
		}
