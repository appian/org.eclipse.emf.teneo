 ...
 * </copyright>
 *
 * $Id: SimplefeaturemapAdapterFactory.java,v 1.1 2006/07/11 16:57:05 mtaal Exp $
 */
...
public class SimplefeaturemapAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected SimplefeaturemapSwitch modelSwitch =
		new SimplefeaturemapSwitch() {
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.teneo.samples.emf.schemaconstructs.simplefeaturemap.PurchaseOrder <em>Purchase Order</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.teneo.samples.emf.schemaconstructs.simplefeaturemap.Supplier <em>Supplier</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
...
} //SimplefeaturemapAdapterFactory
