 ...
 * </copyright>
 *
 * $Id: AutoIDImpl.java,v 1.1 2008/10/27 13:18:30 mtaal Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.samples.issues.bz250239.impl.AutoIDImpl#getAutoID <em>Auto ID</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.samples.issues.bz250239.impl.AutoIDImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AutoIDImpl extends EObjectImpl implements AutoID {
	...
	protected EClass eStaticClass() {
		return Bz250239Package.Literals.AUTO_ID;
	}
	...
	public void setAutoID(long newAutoID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bz250239Package.AUTO_ID__AUTO_ID, oldAutoID, autoID));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bz250239Package.AUTO_ID__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Bz250239Package.AUTO_ID__AUTO_ID:
				return new Long(getAutoID());
			case Bz250239Package.AUTO_ID__NAME:
				return getName();
		}
