 ...
 * </copyright>
 *
 * $Id: StringTypeImpl.java,v 1.2 2006/07/22 13:01:17 mtaal Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.samples.emf.sample.catalog.impl.StringTypeImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StringTypeImpl extends EObjectImpl implements StringType {
	...
	protected EClass eStaticClass() {
		return CatalogPackage.Literals.STRING_TYPE;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CatalogPackage.STRING_TYPE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CatalogPackage.STRING_TYPE__VALUE:
				return getValue();
		}
