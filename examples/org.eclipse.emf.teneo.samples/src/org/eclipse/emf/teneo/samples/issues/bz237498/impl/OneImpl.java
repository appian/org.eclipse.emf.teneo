 ...
 * </copyright>
 *
 * $Id: OneImpl.java,v 1.1 2008/06/28 22:41:35 mtaal Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.samples.issues.bz237498.impl.OneImpl#getManies <em>Manies</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OneImpl extends EObjectImpl implements One {
	...
	protected EClass eStaticClass() {
		return Bz237498Package.Literals.ONE;
	}
	...
	public EList<Many> getManies() {
		if (manies == null) {
			manies = new EObjectEList<Many>(Many.class, this, Bz237498Package.ONE__MANIES);
		}
		return manies;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Bz237498Package.ONE__MANIES:
				return getManies();
		}
