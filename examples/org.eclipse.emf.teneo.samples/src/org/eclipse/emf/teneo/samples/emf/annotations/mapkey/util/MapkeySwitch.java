 ...
 * </copyright>
 *
 * $Id: MapkeySwitch.java,v 1.1 2007/03/18 19:19:26 mtaal Exp $
 */
...
public class MapkeySwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MapkeyPackage.BOOK: {
				Book book = (Book)theEObject;
				T result = caseBook(book);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MapkeyPackage.STRING_TO_WRITER_MAP_ENTRY: {
