 ...
 * </copyright>
 *
 * $Id: SequenceStyleIDImpl.java,v 1.1 2008/10/27 13:18:30 mtaal Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.samples.issues.bz250239.impl.SequenceStyleIDImpl#getMyid <em>Myid</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SequenceStyleIDImpl extends EObjectImpl implements SequenceStyleID {
	...
	protected EClass eStaticClass() {
		return Bz250239Package.Literals.SEQUENCE_STYLE_ID;
	}
	...
	public void setMyid(long newMyid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Bz250239Package.SEQUENCE_STYLE_ID__MYID, oldMyid, myid, !oldMyidESet));
	}
	...
	public void unsetMyid() {
		...
		myidESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Bz250239Package.SEQUENCE_STYLE_ID__MYID, oldMyid, MYID_EDEFAULT, oldMyidESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Bz250239Package.SEQUENCE_STYLE_ID__MYID:
