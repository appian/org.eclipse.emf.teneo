 ...
 * </copyright>
 *
 * $Id: NaturalIdSwitch.java,v 1.1 2008/06/29 14:23:14 mtaal Exp $
 */
 ...
 * @generated
 */
public class NaturalIdSwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case NaturalIdPackage.PERSON: {
				Person person = (Person)theEObject;
				T result = casePerson(person);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case NaturalIdPackage.FAMILY: {
