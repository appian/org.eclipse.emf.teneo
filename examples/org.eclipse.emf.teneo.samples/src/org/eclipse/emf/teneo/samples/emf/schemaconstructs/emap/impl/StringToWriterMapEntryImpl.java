 ...
 * </copyright>
 *
 * $Id: StringToWriterMapEntryImpl.java,v 1.3 2007/07/09 12:55:20 mtaal Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.samples.emf.schemaconstructs.emap.impl.StringToWriterMapEntryImpl#getTypedKey <em>Key</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.samples.emf.schemaconstructs.emap.impl.StringToWriterMapEntryImpl#getTypedValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StringToWriterMapEntryImpl extends EObjectImpl implements BasicEMap.Entry<String,Writer> {
	...
	public void setTypedKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmapPackage.STRING_TO_WRITER_MAP_ENTRY__KEY, oldKey, key));
	}
	...
	public void setTypedValue(Writer newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmapPackage.STRING_TO_WRITER_MAP_ENTRY__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EmapPackage.STRING_TO_WRITER_MAP_ENTRY__KEY:
				return getTypedKey();
			case EmapPackage.STRING_TO_WRITER_MAP_ENTRY__VALUE:
