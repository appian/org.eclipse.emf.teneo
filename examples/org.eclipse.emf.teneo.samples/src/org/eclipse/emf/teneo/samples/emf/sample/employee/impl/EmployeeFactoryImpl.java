 ...
 * </copyright>
 *
 * $Id: EmployeeFactoryImpl.java,v 1.1 2008/04/23 15:45:24 mtaal Exp $
 */
...
public class EmployeeFactoryImpl extends EFactoryImpl implements EmployeeFactory {
	...
	public static EmployeeFactory init() {
		try {
			EmployeeFactory theEmployeeFactory = (EmployeeFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.eclipse.org/emf/teneo/samples/emf/sample/Employee"); 
