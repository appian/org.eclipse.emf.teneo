 ...
 * @generated
 */
public class CascadenotallPackageImpl extends EPackageImpl implements CascadenotallPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see org.eclipse.emf.teneo.samples.emf.annotations.cascadenotall.CascadenotallPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private CascadenotallPackageImpl() {
		super(eNS_URI, CascadenotallFactory.eINSTANCE);
	}
	 ...
	 * @generated
	 */
	public static CascadenotallPackage init() {
		if (isInited) return (CascadenotallPackage)EPackage.Registry.INSTANCE.getEPackage(CascadenotallPackage.eNS_URI);

		// Obtain or create and register package
		CascadenotallPackageImpl theCascadenotallPackage = (CascadenotallPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof CascadenotallPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new CascadenotallPackageImpl());
		...
		theCascadenotallPackage.createPackageContents();

		// Initialize created meta-data
		theCascadenotallPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theCascadenotallPackage.freeze();

		return theCascadenotallPackage;
	}
	 ...
	 * @generated
	 */
	public CascadenotallFactory getCascadenotallFactory() {
		return (CascadenotallFactory)getEFactoryInstance();
	}
