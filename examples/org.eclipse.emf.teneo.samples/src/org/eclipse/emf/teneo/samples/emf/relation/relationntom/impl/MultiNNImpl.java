 ...
 * </copyright>
 *
 * $Id: MultiNNImpl.java,v 1.2 2007/02/08 23:09:24 mtaal Exp $
 */
...
public class MultiNNImpl extends EObjectImpl implements MultiNN {
	...
	protected EClass eStaticClass() {
		return RelationntomPackage.Literals.MULTI_NN;
	}
	...
	public EList<Main> getMain() {
		if (main == null) {
			main = new EObjectWithInverseResolvingEList.ManyInverse<Main>(Main.class, this, RelationntomPackage.MULTI_NN__MAIN, RelationntomPackage.MAIN__MULTINN);
		}
		return main;
	}
