 ...
 * </copyright>
 *
 * $Id: PrimerpoPackageImpl.java,v 1.1 2006/07/11 16:57:17 mtaal Exp $
 */
...
import org.eclipse.emf.teneo.samples.emf.sample.schemaprimerpo.util.PrimerpoValidator;
 ...
 * @generated
 */
public class PrimerpoPackageImpl extends EPackageImpl implements PrimerpoPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see org.eclipse.emf.teneo.samples.emf.sample.schemaprimerpo.PrimerpoPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private PrimerpoPackageImpl() {
		super(eNS_URI, PrimerpoFactory.eINSTANCE);
	}
	 ...
	 * @generated
	 */
	public static PrimerpoPackage init() {
		if (isInited) return (PrimerpoPackage)EPackage.Registry.INSTANCE.getEPackage(PrimerpoPackage.eNS_URI);

		// Obtain or create and register package
		PrimerpoPackageImpl thePrimerpoPackage = (PrimerpoPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof PrimerpoPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new PrimerpoPackageImpl());
		...
		thePrimerpoPackage.createPackageContents();

		// Initialize created meta-data
		thePrimerpoPackage.initializePackageContents();
			...
			(thePrimerpoPackage, 
			 new EValidator.Descriptor() {
				 public EValidator getEValidator() {
					 return PrimerpoValidator.INSTANCE;
				 }
			 });

		// Mark meta-data to indicate it can't be changed
		thePrimerpoPackage.freeze();

		return thePrimerpoPackage;
	}
	 ...
	 * @generated
	 */
	public PrimerpoFactory getPrimerpoFactory() {
		return (PrimerpoFactory)getEFactoryInstance();
	}
