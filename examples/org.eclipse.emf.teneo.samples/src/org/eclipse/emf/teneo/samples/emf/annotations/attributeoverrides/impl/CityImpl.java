 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.samples.emf.annotations.attributeoverrides.impl.CityImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.samples.emf.annotations.attributeoverrides.impl.CityImpl#getCountry <em>Country</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CityImpl extends EObjectImpl implements City {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AttributeoverridesPackage.CITY__NAME, oldName, name));
	}
	...
	public void setCountry(String newCountry) {
		...
		country = newCountry;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AttributeoverridesPackage.CITY__COUNTRY, oldCountry, country));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AttributeoverridesPackage.CITY__NAME:
				return getName();
			case AttributeoverridesPackage.CITY__COUNTRY:
				return getCountry();
		}
