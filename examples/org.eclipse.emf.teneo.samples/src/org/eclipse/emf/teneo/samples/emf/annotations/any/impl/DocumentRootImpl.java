 ...
 * </copyright>
 *
 * $Id: DocumentRootImpl.java,v 1.1.2.2 2009/06/30 07:30:13 mtaal Exp $
 */
...
public class DocumentRootImpl extends EObjectImpl implements DocumentRoot {
	...
	public int getGlobalInt() {
		return ((Integer)getMixed().get(AnyPackage.Literals.DOCUMENT_ROOT__GLOBAL_INT, true)).intValue();
	}
	...
	public void setGlobalInt(int newGlobalInt) {
		((FeatureMap.Internal)getMixed()).set(AnyPackage.Literals.DOCUMENT_ROOT__GLOBAL_INT, new Integer(newGlobalInt));
	}
