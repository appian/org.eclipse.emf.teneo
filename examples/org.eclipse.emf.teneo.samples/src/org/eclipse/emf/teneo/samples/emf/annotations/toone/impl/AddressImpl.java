 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.samples.emf.annotations.toone.impl.AddressImpl#getCity <em>City</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AddressImpl extends EObjectImpl implements Address {
	...
	protected EClass eStaticClass() {
		return ToonePackage.Literals.ADDRESS;
	}
	...
	public void setCity(String newCity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ToonePackage.ADDRESS__CITY, oldCity, city));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ToonePackage.ADDRESS__CITY:
				return getCity();
		}
