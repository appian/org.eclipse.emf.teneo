 ...
 * </copyright>
 *
 * $Id: SimplenmAdapterFactory.java,v 1.1 2006/07/11 16:56:57 mtaal Exp $
 */
...
public class SimplenmAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected SimplenmSwitch modelSwitch =
		new SimplenmSwitch() {
			public Object caseMe(Me object) {
				return createMeAdapter();
			}
			public Object caseYou(You object) {
				return createYouAdapter();
			}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.teneo.samples.issues.simplenm.Me <em>Me</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.teneo.samples.issues.simplenm.You <em>You</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
