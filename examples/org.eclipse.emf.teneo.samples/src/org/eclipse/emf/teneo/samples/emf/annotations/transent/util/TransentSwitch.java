 ...
 * </copyright>
 *
 * $Id: TransentSwitch.java,v 1.1 2006/07/11 16:57:03 mtaal Exp $
 */
...
public class TransentSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TransentPackage.BODY: {
				Body body = (Body)theEObject;
				Object result = caseBody(body);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TransentPackage.HEAD: {
