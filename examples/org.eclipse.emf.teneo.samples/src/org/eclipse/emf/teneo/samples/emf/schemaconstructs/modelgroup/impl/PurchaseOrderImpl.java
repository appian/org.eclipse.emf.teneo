 ...
 * </copyright>
 *
 * $Id: PurchaseOrderImpl.java,v 1.1 2010/03/25 00:29:09 mtaal Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.samples.emf.schemaconstructs.modelgroup.impl.PurchaseOrderImpl#getReference <em>Reference</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PurchaseOrderImpl extends EObjectImpl implements PurchaseOrder {
	...
	protected EClass eStaticClass() {
		return ModelgroupPackage.Literals.PURCHASE_ORDER;
	}
	...
	public void setReference(String newReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelgroupPackage.PURCHASE_ORDER__REFERENCE, oldReference, reference));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelgroupPackage.PURCHASE_ORDER__REFERENCE:
				return getReference();
		}
