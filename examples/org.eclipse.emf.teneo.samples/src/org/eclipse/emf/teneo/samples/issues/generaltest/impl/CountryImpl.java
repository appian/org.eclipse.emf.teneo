 ...
 * </copyright>
 *
 * $Id: CountryImpl.java,v 1.1 2007/07/04 19:29:56 mtaal Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.samples.issues.generaltest.impl.CountryImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CountryImpl extends EObjectImpl implements Country {
	...
	protected EClass eStaticClass() {
		return GeneralTestPackage.Literals.COUNTRY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GeneralTestPackage.COUNTRY__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GeneralTestPackage.COUNTRY__NAME:
				return getName();
		}
