...
public class BookImpl extends EObjectImpl implements Book {
	...
	protected EClass eStaticClass() {
		return ExtralazyPackage.Literals.BOOK;
	}
	...
	public void setTitle(String newTitle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExtralazyPackage.BOOK__TITLE, oldTitle, title));
	}
	...
	public EList<Writer> getAuthors() {
		if (authors == null) {
			authors = new EObjectResolvingEList<Writer>(Writer.class, this, ExtralazyPackage.BOOK__AUTHORS);
		}
		return authors;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExtralazyPackage.BOOK__TITLE:
				return getTitle();
