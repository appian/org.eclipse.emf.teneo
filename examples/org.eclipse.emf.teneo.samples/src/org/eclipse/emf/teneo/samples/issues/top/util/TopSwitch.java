 ...
 * </copyright>
 *
 * $Id: TopSwitch.java,v 1.1 2008/03/19 22:25:41 mtaal Exp $
 */
...
public class TopSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TopPackage.APPLICATION_DEFINITION: {
