 ...
 * </copyright>
 *
 * $Id: ClaimPackageImpl.java,v 1.1 2008/01/18 06:20:17 mtaal Exp $
 */
...
public class ClaimPackageImpl extends EPackageImpl implements ClaimPackage {
	...
	public static ClaimPackage init() {
		...
		ClaimPackageImpl theClaimPackage = (ClaimPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof ClaimPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new ClaimPackageImpl());
