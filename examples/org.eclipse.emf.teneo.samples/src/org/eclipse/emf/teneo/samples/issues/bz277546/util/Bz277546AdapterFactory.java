 ...
 * </copyright>
 *
 * $Id: Bz277546AdapterFactory.java,v 1.1.2.1 2009/05/23 10:33:40 mtaal Exp $
 */
...
public class Bz277546AdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected Bz277546Switch<Adapter> modelSwitch =
		new Bz277546Switch<Adapter>() {
			@Override
			public Adapter caseAnotherVersion(AnotherVersion object) {
				return createAnotherVersionAdapter();
			}
			@Override
			public Adapter caseDateVersion(DateVersion object) {
				return createDateVersionAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.teneo.samples.issues.bz277546.AnotherVersion <em>Another Version</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.teneo.samples.issues.bz277546.DateVersion <em>Date Version</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.teneo.samples.issues.bz277546.SimpleVersion <em>Simple Version</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
