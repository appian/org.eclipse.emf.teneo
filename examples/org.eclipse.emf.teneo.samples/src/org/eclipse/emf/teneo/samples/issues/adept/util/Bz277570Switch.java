 ...
 * </copyright>
 *
 * $Id: Bz277570Switch.java,v 1.1.2.1 2009/05/23 13:09:16 mtaal Exp $
 */
...
public class Bz277570Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Bz277570Package.BAZ: {
				Baz baz = (Baz)theEObject;
				T result = caseBaz(baz);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Bz277570Package.FOO: {
				Foo foo = (Foo)theEObject;
				T result = caseFoo(foo);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Bz277570Package.BAR: {
				Bar bar = (Bar)theEObject;
				T result = caseBar(bar);
				if (result == null) result = caseBaz(bar);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Bz277570Package.BIFF: {
				Biff biff = (Biff)theEObject;
				T result = caseBiff(biff);
				if (result == null) result = caseBaz(biff);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Baz</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Baz</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBaz(Baz object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Biff</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Biff</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBiff(Biff object) {
		return null;
	}
