...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.teneo.eclipselink.examples.library.TypeWriter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TypeWriterItemProvider
	 ...
	 * @generated
	 */
	public TypeWriterItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addMakerPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Maker feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addMakerPropertyDescriptor(Object object) {
	...
	public String getText(Object object) {
		String label = ((TypeWriter)object).getMaker();
		return label == null || label.length() == 0 ?
			getString("_UI_TypeWriter_type") :
			getString("_UI_TypeWriter_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TypeWriter.class)) {
