 ...
 * </copyright>
 *
 * $Id: PrimitiveArrayImpl.java,v 1.1 2010/08/18 09:21:39 cbouhier Exp $
 */
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Primitive Array</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.PrimitiveArrayImpl#getMeta <em>Meta</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.PrimitiveArrayImpl#getSubselect <em>Subselect</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.PrimitiveArrayImpl#getCache <em>Cache</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.PrimitiveArrayImpl#getSynchronize <em>Synchronize</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.PrimitiveArrayImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.PrimitiveArrayImpl#getKey <em>Key</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.PrimitiveArrayImpl#getIndex <em>Index</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.PrimitiveArrayImpl#getListIndex <em>List Index</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.PrimitiveArrayImpl#getElement <em>Element</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.PrimitiveArrayImpl#getLoader <em>Loader</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.PrimitiveArrayImpl#getSqlInsert <em>Sql Insert</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.PrimitiveArrayImpl#getSqlUpdate <em>Sql Update</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.PrimitiveArrayImpl#getSqlDelete <em>Sql Delete</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.PrimitiveArrayImpl#getSqlDeleteAll <em>Sql Delete All</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.PrimitiveArrayImpl#getAccess <em>Access</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.PrimitiveArrayImpl#getBatchSize <em>Batch Size</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.PrimitiveArrayImpl#getCatalog <em>Catalog</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.PrimitiveArrayImpl#getCheck <em>Check</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.PrimitiveArrayImpl#getCollectionType <em>Collection Type</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.PrimitiveArrayImpl#isEmbedXml <em>Embed Xml</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.PrimitiveArrayImpl#getFetch <em>Fetch</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.PrimitiveArrayImpl#isMutable <em>Mutable</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.PrimitiveArrayImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.PrimitiveArrayImpl#getNode <em>Node</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.PrimitiveArrayImpl#isOptimisticLock <em>Optimistic Lock</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.PrimitiveArrayImpl#getOuterJoin <em>Outer Join</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.PrimitiveArrayImpl#getPersister <em>Persister</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.PrimitiveArrayImpl#getSchema <em>Schema</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.PrimitiveArrayImpl#getSubselect1 <em>Subselect1</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.PrimitiveArrayImpl#getTable <em>Table</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.PrimitiveArrayImpl#getWhere <em>Where</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class PrimitiveArrayImpl extends EObjectImpl implements PrimitiveArray {
	/**
	...
	protected EClass eStaticClass() {
		return Hbm30Package.eINSTANCE.getPrimitiveArray();
	}
	...
	public EList<Meta> getMeta() {
		if (meta == null) {
			meta = new EObjectContainmentEList<Meta>(Meta.class, this, Hbm30Package.PRIMITIVE_ARRAY__META);
		}
		return meta;
	}
	...
	public void setSubselect(String newSubselect) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__SUBSELECT, oldSubselect, subselect));
	}
	...
	public NotificationChain basicSetCache(Cache newCache, NotificationChain msgs) {
		...
		cache = newCache;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__CACHE, oldCache, newCache);
	...
	public void setCache(Cache newCache) {
		if (newCache != cache) {
			...
			if (cache != null)
				msgs = ((InternalEObject)cache).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.PRIMITIVE_ARRAY__CACHE, null, msgs);
			if (newCache != null)
				msgs = ((InternalEObject)newCache).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.PRIMITIVE_ARRAY__CACHE, null, msgs);
			msgs = basicSetCache(newCache, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__CACHE, newCache, newCache));
	}
	...
	public EList<Synchronize> getSynchronize() {
		if (synchronize == null) {
			synchronize = new EObjectContainmentEList<Synchronize>(Synchronize.class, this, Hbm30Package.PRIMITIVE_ARRAY__SYNCHRONIZE);
		}
		return synchronize;
	}
	...
	public void setComment(String newComment) {
		...
		comment = newComment;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__COMMENT, oldComment, comment));
	}
	...
	public NotificationChain basicSetKey(Key newKey, NotificationChain msgs) {
		...
		key = newKey;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__KEY, oldKey, newKey);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setKey(Key newKey) {
		if (newKey != key) {
			NotificationChain msgs = null;
			if (key != null)
				msgs = ((InternalEObject)key).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.PRIMITIVE_ARRAY__KEY, null, msgs);
			if (newKey != null)
				msgs = ((InternalEObject)newKey).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.PRIMITIVE_ARRAY__KEY, null, msgs);
			msgs = basicSetKey(newKey, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__KEY, newKey, newKey));
	}
	...
	public NotificationChain basicSetIndex(Index newIndex, NotificationChain msgs) {
		...
		index = newIndex;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__INDEX, oldIndex, newIndex);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIndex(Index newIndex) {
		if (newIndex != index) {
			NotificationChain msgs = null;
			if (index != null)
				msgs = ((InternalEObject)index).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.PRIMITIVE_ARRAY__INDEX, null, msgs);
			if (newIndex != null)
				msgs = ((InternalEObject)newIndex).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.PRIMITIVE_ARRAY__INDEX, null, msgs);
			msgs = basicSetIndex(newIndex, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__INDEX, newIndex, newIndex));
	}
	...
	public NotificationChain basicSetListIndex(ListIndex newListIndex, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__LIST_INDEX, oldListIndex, newListIndex);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setListIndex(ListIndex newListIndex) {
		if (newListIndex != listIndex) {
			NotificationChain msgs = null;
			if (listIndex != null)
				msgs = ((InternalEObject)listIndex).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.PRIMITIVE_ARRAY__LIST_INDEX, null, msgs);
			if (newListIndex != null)
				msgs = ((InternalEObject)newListIndex).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.PRIMITIVE_ARRAY__LIST_INDEX, null, msgs);
			msgs = basicSetListIndex(newListIndex, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__LIST_INDEX, newListIndex, newListIndex));
	}
	...
	public NotificationChain basicSetElement(Element newElement, NotificationChain msgs) {
		...
		element = newElement;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__ELEMENT, oldElement, newElement);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setElement(Element newElement) {
		if (newElement != element) {
			NotificationChain msgs = null;
			if (element != null)
				msgs = ((InternalEObject)element).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.PRIMITIVE_ARRAY__ELEMENT, null, msgs);
			if (newElement != null)
				msgs = ((InternalEObject)newElement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.PRIMITIVE_ARRAY__ELEMENT, null, msgs);
			msgs = basicSetElement(newElement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__ELEMENT, newElement, newElement));
	}
	...
	public NotificationChain basicSetLoader(Loader newLoader, NotificationChain msgs) {
		...
		loader = newLoader;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__LOADER, oldLoader, newLoader);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLoader(Loader newLoader) {
		if (newLoader != loader) {
			NotificationChain msgs = null;
			if (loader != null)
				msgs = ((InternalEObject)loader).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.PRIMITIVE_ARRAY__LOADER, null, msgs);
			if (newLoader != null)
				msgs = ((InternalEObject)newLoader).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.PRIMITIVE_ARRAY__LOADER, null, msgs);
			msgs = basicSetLoader(newLoader, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__LOADER, newLoader, newLoader));
	}
	...
	public NotificationChain basicSetSqlInsert(SqlInsert newSqlInsert, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__SQL_INSERT, oldSqlInsert, newSqlInsert);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSqlInsert(SqlInsert newSqlInsert) {
		if (newSqlInsert != sqlInsert) {
			NotificationChain msgs = null;
			if (sqlInsert != null)
				msgs = ((InternalEObject)sqlInsert).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.PRIMITIVE_ARRAY__SQL_INSERT, null, msgs);
			if (newSqlInsert != null)
				msgs = ((InternalEObject)newSqlInsert).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.PRIMITIVE_ARRAY__SQL_INSERT, null, msgs);
			msgs = basicSetSqlInsert(newSqlInsert, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__SQL_INSERT, newSqlInsert, newSqlInsert));
	}
	...
	public NotificationChain basicSetSqlUpdate(SqlUpdate newSqlUpdate, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__SQL_UPDATE, oldSqlUpdate, newSqlUpdate);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSqlUpdate(SqlUpdate newSqlUpdate) {
		if (newSqlUpdate != sqlUpdate) {
			NotificationChain msgs = null;
			if (sqlUpdate != null)
				msgs = ((InternalEObject)sqlUpdate).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.PRIMITIVE_ARRAY__SQL_UPDATE, null, msgs);
			if (newSqlUpdate != null)
				msgs = ((InternalEObject)newSqlUpdate).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.PRIMITIVE_ARRAY__SQL_UPDATE, null, msgs);
			msgs = basicSetSqlUpdate(newSqlUpdate, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__SQL_UPDATE, newSqlUpdate, newSqlUpdate));
	}
	...
	public NotificationChain basicSetSqlDelete(SqlDelete newSqlDelete, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__SQL_DELETE, oldSqlDelete, newSqlDelete);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSqlDelete(SqlDelete newSqlDelete) {
		if (newSqlDelete != sqlDelete) {
			NotificationChain msgs = null;
			if (sqlDelete != null)
				msgs = ((InternalEObject)sqlDelete).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.PRIMITIVE_ARRAY__SQL_DELETE, null, msgs);
			if (newSqlDelete != null)
				msgs = ((InternalEObject)newSqlDelete).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.PRIMITIVE_ARRAY__SQL_DELETE, null, msgs);
			msgs = basicSetSqlDelete(newSqlDelete, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__SQL_DELETE, newSqlDelete, newSqlDelete));
	}
	...
	public NotificationChain basicSetSqlDeleteAll(SqlDeleteAll newSqlDeleteAll, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__SQL_DELETE_ALL, oldSqlDeleteAll, newSqlDeleteAll);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSqlDeleteAll(SqlDeleteAll newSqlDeleteAll) {
		if (newSqlDeleteAll != sqlDeleteAll) {
			...
			if (sqlDeleteAll != null)
				msgs = ((InternalEObject)sqlDeleteAll).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.PRIMITIVE_ARRAY__SQL_DELETE_ALL, null, msgs);
			if (newSqlDeleteAll != null)
				msgs = ((InternalEObject)newSqlDeleteAll).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.PRIMITIVE_ARRAY__SQL_DELETE_ALL, null, msgs);
			msgs = basicSetSqlDeleteAll(newSqlDeleteAll, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__SQL_DELETE_ALL, newSqlDeleteAll, newSqlDeleteAll));
	}
	...
	public void setAccess(String newAccess) {
		...
		access = newAccess;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__ACCESS, oldAccess, access));
	}
	...
	public void setBatchSize(String newBatchSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__BATCH_SIZE, oldBatchSize, batchSize));
	}
	...
	public void setCatalog(String newCatalog) {
		...
		catalog = newCatalog;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__CATALOG, oldCatalog, catalog));
	}
	...
	public void setCheck(String newCheck) {
		...
		check = newCheck;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__CHECK, oldCheck, check));
	}
	...
	public void setCollectionType(String newCollectionType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__COLLECTION_TYPE, oldCollectionType, collectionType));
	}
	...
	public void setEmbedXml(boolean newEmbedXml) {
		...
		embedXmlESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__EMBED_XML, oldEmbedXml, embedXml, !oldEmbedXmlESet));
	}
	...
	public void unsetEmbedXml() {
		...
		embedXmlESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Hbm30Package.PRIMITIVE_ARRAY__EMBED_XML, oldEmbedXml, EMBED_XML_EDEFAULT, oldEmbedXmlESet));
	}
	...
	public void setFetch(Fetch newFetch) {
		...
		fetchESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__FETCH, oldFetch, fetch, !oldFetchESet));
	}
	...
	public void unsetFetch() {
		...
		fetchESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Hbm30Package.PRIMITIVE_ARRAY__FETCH, oldFetch, FETCH_EDEFAULT, oldFetchESet));
	}
	...
	public void setMutable(boolean newMutable) {
		...
		mutableESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__MUTABLE, oldMutable, mutable, !oldMutableESet));
	}
	...
	public void unsetMutable() {
		...
		mutableESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Hbm30Package.PRIMITIVE_ARRAY__MUTABLE, oldMutable, MUTABLE_EDEFAULT, oldMutableESet));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__NAME, oldName, name));
	}
	...
	public void setNode(String newNode) {
		...
		node = newNode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__NODE, oldNode, node));
	}
	...
	public void setOptimisticLock(boolean newOptimisticLock) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__OPTIMISTIC_LOCK, oldOptimisticLock, optimisticLock, !oldOptimisticLockESet));
	}
	...
	public void unsetOptimisticLock() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Hbm30Package.PRIMITIVE_ARRAY__OPTIMISTIC_LOCK, oldOptimisticLock, OPTIMISTIC_LOCK_EDEFAULT, oldOptimisticLockESet));
	}
	...
	public void setOuterJoin(Outerjoin newOuterJoin) {
		...
		outerJoinESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__OUTER_JOIN, oldOuterJoin, outerJoin, !oldOuterJoinESet));
	}
	...
	public void unsetOuterJoin() {
		...
		outerJoinESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Hbm30Package.PRIMITIVE_ARRAY__OUTER_JOIN, oldOuterJoin, OUTER_JOIN_EDEFAULT, oldOuterJoinESet));
	}
	...
	public void setPersister(String newPersister) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__PERSISTER, oldPersister, persister));
	}
	...
	public void setSchema(String newSchema) {
		...
		schema = newSchema;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__SCHEMA, oldSchema, schema));
	}
	...
	public void setSubselect1(String newSubselect1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__SUBSELECT1, oldSubselect1, subselect1));
	}
	...
	public void setTable(String newTable) {
		...
		table = newTable;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__TABLE, oldTable, table));
	}
	...
	public void setWhere(String newWhere) {
		...
		where = newWhere;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.PRIMITIVE_ARRAY__WHERE, oldWhere, where));
	}
