 ...
 * </copyright>
 *
 * $Id: IdbagImpl.java,v 1.1 2010/08/18 09:21:39 cbouhier Exp $
 */
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Idbag</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#getMeta <em>Meta</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#getSubselect <em>Subselect</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#getCache <em>Cache</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#getSynchronize <em>Synchronize</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#getCollectionId <em>Collection Id</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#getKey <em>Key</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#getElement <em>Element</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#getManyToMany <em>Many To Many</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#getCompositeElement <em>Composite Element</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#getManyToAny <em>Many To Any</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#getLoader <em>Loader</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#getSqlInsert <em>Sql Insert</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#getSqlUpdate <em>Sql Update</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#getSqlDelete <em>Sql Delete</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#getSqlDeleteAll <em>Sql Delete All</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#getFilter <em>Filter</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#getAccess <em>Access</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#getBatchSize <em>Batch Size</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#getCascade <em>Cascade</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#getCatalog <em>Catalog</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#getCheck <em>Check</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#getCollectionType <em>Collection Type</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#isEmbedXml <em>Embed Xml</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#getFetch <em>Fetch</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#getLazy <em>Lazy</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#isMutable <em>Mutable</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#getNode <em>Node</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#isOptimisticLock <em>Optimistic Lock</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#getOrderBy <em>Order By</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#getOuterJoin <em>Outer Join</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#getPersister <em>Persister</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#getSchema <em>Schema</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#getSubselect1 <em>Subselect1</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#getTable <em>Table</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.IdbagImpl#getWhere <em>Where</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class IdbagImpl extends EObjectImpl implements Idbag {
	...
	/**
	 * The cached value of the '{@link #getCollectionId() <em>Collection Id</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getCollectionId()
	 * @generated
	...
	protected EClass eStaticClass() {
		return Hbm30Package.eINSTANCE.getIdbag();
	}
	...
	public EList<Meta> getMeta() {
		if (meta == null) {
			meta = new EObjectContainmentEList<Meta>(Meta.class, this, Hbm30Package.IDBAG__META);
		}
		return meta;
	}
	...
	public void setSubselect(String newSubselect) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__SUBSELECT, oldSubselect, subselect));
	}
	...
	public NotificationChain basicSetCache(Cache newCache, NotificationChain msgs) {
		...
		cache = newCache;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__CACHE, oldCache, newCache);
	...
	public void setCache(Cache newCache) {
		if (newCache != cache) {
			...
			if (cache != null)
				msgs = ((InternalEObject)cache).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.IDBAG__CACHE, null, msgs);
			if (newCache != null)
				msgs = ((InternalEObject)newCache).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.IDBAG__CACHE, null, msgs);
			msgs = basicSetCache(newCache, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__CACHE, newCache, newCache));
	}
	...
	public EList<Synchronize> getSynchronize() {
		if (synchronize == null) {
			synchronize = new EObjectContainmentEList<Synchronize>(Synchronize.class, this, Hbm30Package.IDBAG__SYNCHRONIZE);
		}
		return synchronize;
	}
	...
	public void setComment(String newComment) {
		...
		comment = newComment;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__COMMENT, oldComment, comment));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetCollectionId(CollectionId newCollectionId, NotificationChain msgs) {
		CollectionId oldCollectionId = collectionId;
		collectionId = newCollectionId;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__COLLECTION_ID, oldCollectionId, newCollectionId);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	 ...
	 * @generated
	 */
	public void setCollectionId(CollectionId newCollectionId) {
		if (newCollectionId != collectionId) {
			NotificationChain msgs = null;
			if (collectionId != null)
				msgs = ((InternalEObject)collectionId).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.IDBAG__COLLECTION_ID, null, msgs);
			if (newCollectionId != null)
				msgs = ((InternalEObject)newCollectionId).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.IDBAG__COLLECTION_ID, null, msgs);
			msgs = basicSetCollectionId(newCollectionId, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__COLLECTION_ID, newCollectionId, newCollectionId));
	}
	...
	public NotificationChain basicSetKey(Key newKey, NotificationChain msgs) {
		...
		key = newKey;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__KEY, oldKey, newKey);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setKey(Key newKey) {
		if (newKey != key) {
			NotificationChain msgs = null;
			if (key != null)
				msgs = ((InternalEObject)key).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.IDBAG__KEY, null, msgs);
			if (newKey != null)
				msgs = ((InternalEObject)newKey).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.IDBAG__KEY, null, msgs);
			msgs = basicSetKey(newKey, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__KEY, newKey, newKey));
	}
	...
	public NotificationChain basicSetElement(Element newElement, NotificationChain msgs) {
		...
		element = newElement;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__ELEMENT, oldElement, newElement);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setElement(Element newElement) {
		if (newElement != element) {
			NotificationChain msgs = null;
			if (element != null)
				msgs = ((InternalEObject)element).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.IDBAG__ELEMENT, null, msgs);
			if (newElement != null)
				msgs = ((InternalEObject)newElement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.IDBAG__ELEMENT, null, msgs);
			msgs = basicSetElement(newElement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__ELEMENT, newElement, newElement));
	}
	...
	public NotificationChain basicSetManyToMany(ManyToMany newManyToMany, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__MANY_TO_MANY, oldManyToMany, newManyToMany);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setManyToMany(ManyToMany newManyToMany) {
		if (newManyToMany != manyToMany) {
			NotificationChain msgs = null;
			if (manyToMany != null)
				msgs = ((InternalEObject)manyToMany).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.IDBAG__MANY_TO_MANY, null, msgs);
			if (newManyToMany != null)
				msgs = ((InternalEObject)newManyToMany).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.IDBAG__MANY_TO_MANY, null, msgs);
			msgs = basicSetManyToMany(newManyToMany, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__MANY_TO_MANY, newManyToMany, newManyToMany));
	}
	...
	public NotificationChain basicSetCompositeElement(CompositeElement newCompositeElement, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__COMPOSITE_ELEMENT, oldCompositeElement, newCompositeElement);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCompositeElement(CompositeElement newCompositeElement) {
		if (newCompositeElement != compositeElement) {
			...
			if (compositeElement != null)
				msgs = ((InternalEObject)compositeElement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.IDBAG__COMPOSITE_ELEMENT, null, msgs);
			if (newCompositeElement != null)
				msgs = ((InternalEObject)newCompositeElement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.IDBAG__COMPOSITE_ELEMENT, null, msgs);
			msgs = basicSetCompositeElement(newCompositeElement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__COMPOSITE_ELEMENT, newCompositeElement, newCompositeElement));
	}
	...
	public NotificationChain basicSetManyToAny(ManyToAny newManyToAny, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__MANY_TO_ANY, oldManyToAny, newManyToAny);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setManyToAny(ManyToAny newManyToAny) {
		if (newManyToAny != manyToAny) {
			NotificationChain msgs = null;
			if (manyToAny != null)
				msgs = ((InternalEObject)manyToAny).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.IDBAG__MANY_TO_ANY, null, msgs);
			if (newManyToAny != null)
				msgs = ((InternalEObject)newManyToAny).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.IDBAG__MANY_TO_ANY, null, msgs);
			msgs = basicSetManyToAny(newManyToAny, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__MANY_TO_ANY, newManyToAny, newManyToAny));
	}
	...
	public NotificationChain basicSetLoader(Loader newLoader, NotificationChain msgs) {
		...
		loader = newLoader;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__LOADER, oldLoader, newLoader);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLoader(Loader newLoader) {
		if (newLoader != loader) {
			NotificationChain msgs = null;
			if (loader != null)
				msgs = ((InternalEObject)loader).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.IDBAG__LOADER, null, msgs);
			if (newLoader != null)
				msgs = ((InternalEObject)newLoader).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.IDBAG__LOADER, null, msgs);
			msgs = basicSetLoader(newLoader, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__LOADER, newLoader, newLoader));
	}
	...
	public NotificationChain basicSetSqlInsert(SqlInsert newSqlInsert, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__SQL_INSERT, oldSqlInsert, newSqlInsert);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSqlInsert(SqlInsert newSqlInsert) {
		if (newSqlInsert != sqlInsert) {
			NotificationChain msgs = null;
			if (sqlInsert != null)
				msgs = ((InternalEObject)sqlInsert).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.IDBAG__SQL_INSERT, null, msgs);
			if (newSqlInsert != null)
				msgs = ((InternalEObject)newSqlInsert).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.IDBAG__SQL_INSERT, null, msgs);
			msgs = basicSetSqlInsert(newSqlInsert, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__SQL_INSERT, newSqlInsert, newSqlInsert));
	}
	...
	public NotificationChain basicSetSqlUpdate(SqlUpdate newSqlUpdate, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__SQL_UPDATE, oldSqlUpdate, newSqlUpdate);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSqlUpdate(SqlUpdate newSqlUpdate) {
		if (newSqlUpdate != sqlUpdate) {
			NotificationChain msgs = null;
			if (sqlUpdate != null)
				msgs = ((InternalEObject)sqlUpdate).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.IDBAG__SQL_UPDATE, null, msgs);
			if (newSqlUpdate != null)
				msgs = ((InternalEObject)newSqlUpdate).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.IDBAG__SQL_UPDATE, null, msgs);
			msgs = basicSetSqlUpdate(newSqlUpdate, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__SQL_UPDATE, newSqlUpdate, newSqlUpdate));
	}
	...
	public NotificationChain basicSetSqlDelete(SqlDelete newSqlDelete, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__SQL_DELETE, oldSqlDelete, newSqlDelete);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSqlDelete(SqlDelete newSqlDelete) {
		if (newSqlDelete != sqlDelete) {
			NotificationChain msgs = null;
			if (sqlDelete != null)
				msgs = ((InternalEObject)sqlDelete).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.IDBAG__SQL_DELETE, null, msgs);
			if (newSqlDelete != null)
				msgs = ((InternalEObject)newSqlDelete).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.IDBAG__SQL_DELETE, null, msgs);
			msgs = basicSetSqlDelete(newSqlDelete, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__SQL_DELETE, newSqlDelete, newSqlDelete));
	}
	...
	public NotificationChain basicSetSqlDeleteAll(SqlDeleteAll newSqlDeleteAll, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__SQL_DELETE_ALL, oldSqlDeleteAll, newSqlDeleteAll);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSqlDeleteAll(SqlDeleteAll newSqlDeleteAll) {
		if (newSqlDeleteAll != sqlDeleteAll) {
			...
			if (sqlDeleteAll != null)
				msgs = ((InternalEObject)sqlDeleteAll).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.IDBAG__SQL_DELETE_ALL, null, msgs);
			if (newSqlDeleteAll != null)
				msgs = ((InternalEObject)newSqlDeleteAll).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.IDBAG__SQL_DELETE_ALL, null, msgs);
			msgs = basicSetSqlDeleteAll(newSqlDeleteAll, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__SQL_DELETE_ALL, newSqlDeleteAll, newSqlDeleteAll));
	}
	...
	public EList<Filter> getFilter() {
		if (filter == null) {
			filter = new EObjectContainmentEList<Filter>(Filter.class, this, Hbm30Package.IDBAG__FILTER);
		}
		return filter;
	}
	...
	public void setAccess(String newAccess) {
		...
		access = newAccess;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__ACCESS, oldAccess, access));
	}
	...
	public void setBatchSize(String newBatchSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__BATCH_SIZE, oldBatchSize, batchSize));
	}
	...
	public void setCascade(String newCascade) {
		...
		cascade = newCascade;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__CASCADE, oldCascade, cascade));
	}
	...
	public void setCatalog(String newCatalog) {
		...
		catalog = newCatalog;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__CATALOG, oldCatalog, catalog));
	}
	...
	public void setCheck(String newCheck) {
		...
		check = newCheck;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__CHECK, oldCheck, check));
	}
	...
	public void setCollectionType(String newCollectionType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__COLLECTION_TYPE, oldCollectionType, collectionType));
	}
	...
	public void setEmbedXml(boolean newEmbedXml) {
		...
		embedXmlESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__EMBED_XML, oldEmbedXml, embedXml, !oldEmbedXmlESet));
	}
	...
	public void unsetEmbedXml() {
		...
		embedXmlESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Hbm30Package.IDBAG__EMBED_XML, oldEmbedXml, EMBED_XML_EDEFAULT, oldEmbedXmlESet));
	}
	...
	public void setFetch(Fetch newFetch) {
		...
		fetchESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__FETCH, oldFetch, fetch, !oldFetchESet));
	}
	...
	public void unsetFetch() {
		...
		fetchESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Hbm30Package.IDBAG__FETCH, oldFetch, FETCH_EDEFAULT, oldFetchESet));
	}
	...
	public void setLazy(LazyTrueFalseExtra newLazy) {
		...
		lazyESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__LAZY, oldLazy, lazy, !oldLazyESet));
	}
	...
	public void unsetLazy() {
		...
		lazyESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Hbm30Package.IDBAG__LAZY, oldLazy, LAZY_EDEFAULT, oldLazyESet));
	}
	...
	public void setMutable(boolean newMutable) {
		...
		mutableESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__MUTABLE, oldMutable, mutable, !oldMutableESet));
	}
	...
	public void unsetMutable() {
		...
		mutableESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Hbm30Package.IDBAG__MUTABLE, oldMutable, MUTABLE_EDEFAULT, oldMutableESet));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__NAME, oldName, name));
	}
	...
	public void setNode(String newNode) {
		...
		node = newNode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__NODE, oldNode, node));
	}
	...
	public void setOptimisticLock(boolean newOptimisticLock) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__OPTIMISTIC_LOCK, oldOptimisticLock, optimisticLock, !oldOptimisticLockESet));
	}
	...
	public void unsetOptimisticLock() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Hbm30Package.IDBAG__OPTIMISTIC_LOCK, oldOptimisticLock, OPTIMISTIC_LOCK_EDEFAULT, oldOptimisticLockESet));
	}
	...
	public void setOrderBy(String newOrderBy) {
		...
		orderBy = newOrderBy;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__ORDER_BY, oldOrderBy, orderBy));
	}
	...
	public void setOuterJoin(Outerjoin newOuterJoin) {
		...
		outerJoinESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__OUTER_JOIN, oldOuterJoin, outerJoin, !oldOuterJoinESet));
	}
	...
	public void unsetOuterJoin() {
		...
		outerJoinESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Hbm30Package.IDBAG__OUTER_JOIN, oldOuterJoin, OUTER_JOIN_EDEFAULT, oldOuterJoinESet));
	}
	...
	public void setPersister(String newPersister) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__PERSISTER, oldPersister, persister));
	}
	...
	public void setSchema(String newSchema) {
		...
		schema = newSchema;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__SCHEMA, oldSchema, schema));
	}
	...
	public void setSubselect1(String newSubselect1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__SUBSELECT1, oldSubselect1, subselect1));
	}
	...
	public void setTable(String newTable) {
		...
		table = newTable;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__TABLE, oldTable, table));
	}
	...
	public void setWhere(String newWhere) {
		...
		where = newWhere;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.IDBAG__WHERE, oldWhere, where));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case Hbm30Package.IDBAG__COLLECTION_ID:
				return basicSetCollectionId(null, msgs);
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case Hbm30Package.IDBAG__COMMENT:
				...
				return;
			case Hbm30Package.IDBAG__COLLECTION_ID:
				setCollectionId((CollectionId)newValue);
				return;
			case Hbm30Package.IDBAG__KEY:
				setKey((Key)newValue);
				return;
