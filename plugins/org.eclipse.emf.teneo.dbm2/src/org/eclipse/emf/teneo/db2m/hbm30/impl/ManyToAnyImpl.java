 ...
 * </copyright>
 *
 * $Id: ManyToAnyImpl.java,v 1.1 2010/08/18 09:21:38 cbouhier Exp $
 */
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Many To Any</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ManyToAnyImpl#getMetaValue <em>Meta Value</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ManyToAnyImpl#getColumn <em>Column</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ManyToAnyImpl#getColumn1 <em>Column1</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ManyToAnyImpl#getIdType <em>Id Type</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ManyToAnyImpl#getMetaType <em>Meta Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ManyToAnyImpl extends EObjectImpl implements ManyToAny {
	/**
	...
	protected EClass eStaticClass() {
		return Hbm30Package.eINSTANCE.getManyToAny();
	}
	...
	public EList<MetaValue> getMetaValue() {
		if (metaValue == null) {
			metaValue = new EObjectContainmentEList<MetaValue>(MetaValue.class, this, Hbm30Package.MANY_TO_ANY__META_VALUE);
		}
		return metaValue;
	}
	...
	public NotificationChain basicSetColumn(Column newColumn, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.MANY_TO_ANY__COLUMN, oldColumn, newColumn);
	...
	public void setColumn(Column newColumn) {
		if (newColumn != column) {
			...
			if (column != null)
				msgs = ((InternalEObject)column).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.MANY_TO_ANY__COLUMN, null, msgs);
			if (newColumn != null)
				msgs = ((InternalEObject)newColumn).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.MANY_TO_ANY__COLUMN, null, msgs);
			msgs = basicSetColumn(newColumn, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.MANY_TO_ANY__COLUMN, newColumn, newColumn));
	}
	...
	public EList<Column> getColumn1() {
		if (column1 == null) {
			column1 = new EObjectContainmentEList<Column>(Column.class, this, Hbm30Package.MANY_TO_ANY__COLUMN1);
		}
		return column1;
	}
	...
	public void setIdType(String newIdType) {
		...
		idType = newIdType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.MANY_TO_ANY__ID_TYPE, oldIdType, idType));
	}
	...
	public void setMetaType(String newMetaType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.MANY_TO_ANY__META_TYPE, oldMetaType, metaType));
	}
