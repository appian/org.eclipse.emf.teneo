 ...
 * </copyright>
 *
 * $Id: ArrayImpl.java,v 1.1 2010/08/18 09:21:39 cbouhier Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#getMeta <em>Meta</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#getSubselect <em>Subselect</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#getCache <em>Cache</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#getSynchronize <em>Synchronize</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#getKey <em>Key</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#getIndex <em>Index</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#getListIndex <em>List Index</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#getElement <em>Element</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#getOneToMany <em>One To Many</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#getManyToMany <em>Many To Many</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#getCompositeElement <em>Composite Element</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#getManyToAny <em>Many To Any</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#getLoader <em>Loader</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#getSqlInsert <em>Sql Insert</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#getSqlUpdate <em>Sql Update</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#getSqlDelete <em>Sql Delete</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#getSqlDeleteAll <em>Sql Delete All</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#getAccess <em>Access</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#getBatchSize <em>Batch Size</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#getCascade <em>Cascade</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#getCatalog <em>Catalog</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#getCheck <em>Check</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#getCollectionType <em>Collection Type</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#getElementClass <em>Element Class</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#isEmbedXml <em>Embed Xml</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#getFetch <em>Fetch</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#isInverse <em>Inverse</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#isMutable <em>Mutable</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#getNode <em>Node</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#isOptimisticLock <em>Optimistic Lock</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#getOuterJoin <em>Outer Join</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#getPersister <em>Persister</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#getSchema <em>Schema</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#getSubselect1 <em>Subselect1</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#getTable <em>Table</em>}</li>
 *   <li>{@link org.eclipse.emf.teneo.db2m.hbm30.impl.ArrayImpl#getWhere <em>Where</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ArrayImpl extends EObjectImpl implements Array {
	...
	/**
	 * The cached value of the '{@link #getListIndex() <em>List Index</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getListIndex()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getElementClass() <em>Element Class</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getElementClass()
	 * @generated
	...
	protected EClass eStaticClass() {
		return Hbm30Package.eINSTANCE.getArray();
	}
	...
	public EList<Meta> getMeta() {
		if (meta == null) {
			meta = new EObjectContainmentEList<Meta>(Meta.class, this, Hbm30Package.ARRAY__META);
		}
		return meta;
	}
	...
	public void setSubselect(String newSubselect) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__SUBSELECT, oldSubselect, subselect));
	}
	...
	public NotificationChain basicSetCache(Cache newCache, NotificationChain msgs) {
		...
		cache = newCache;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__CACHE, oldCache, newCache);
	...
	public void setCache(Cache newCache) {
		if (newCache != cache) {
			...
			if (cache != null)
				msgs = ((InternalEObject)cache).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.ARRAY__CACHE, null, msgs);
			if (newCache != null)
				msgs = ((InternalEObject)newCache).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.ARRAY__CACHE, null, msgs);
			msgs = basicSetCache(newCache, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__CACHE, newCache, newCache));
	}
	...
	public EList<Synchronize> getSynchronize() {
		if (synchronize == null) {
			synchronize = new EObjectContainmentEList<Synchronize>(Synchronize.class, this, Hbm30Package.ARRAY__SYNCHRONIZE);
		}
		return synchronize;
	}
	...
	public void setComment(String newComment) {
		...
		comment = newComment;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__COMMENT, oldComment, comment));
	}
	...
	public NotificationChain basicSetKey(Key newKey, NotificationChain msgs) {
		...
		key = newKey;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__KEY, oldKey, newKey);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setKey(Key newKey) {
		if (newKey != key) {
			NotificationChain msgs = null;
			if (key != null)
				msgs = ((InternalEObject)key).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.ARRAY__KEY, null, msgs);
			if (newKey != null)
				msgs = ((InternalEObject)newKey).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.ARRAY__KEY, null, msgs);
			msgs = basicSetKey(newKey, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__KEY, newKey, newKey));
	}
	...
	public NotificationChain basicSetIndex(Index newIndex, NotificationChain msgs) {
		...
		index = newIndex;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__INDEX, oldIndex, newIndex);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setIndex(Index newIndex) {
		if (newIndex != index) {
			NotificationChain msgs = null;
			if (index != null)
				msgs = ((InternalEObject)index).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.ARRAY__INDEX, null, msgs);
			if (newIndex != null)
				msgs = ((InternalEObject)newIndex).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.ARRAY__INDEX, null, msgs);
			msgs = basicSetIndex(newIndex, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__INDEX, newIndex, newIndex));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetListIndex(ListIndex newListIndex, NotificationChain msgs) {
		ListIndex oldListIndex = listIndex;
		listIndex = newListIndex;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__LIST_INDEX, oldListIndex, newListIndex);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	 ...
	 * @generated
	 */
	public void setListIndex(ListIndex newListIndex) {
		if (newListIndex != listIndex) {
			NotificationChain msgs = null;
			if (listIndex != null)
				msgs = ((InternalEObject)listIndex).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.ARRAY__LIST_INDEX, null, msgs);
			if (newListIndex != null)
				msgs = ((InternalEObject)newListIndex).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.ARRAY__LIST_INDEX, null, msgs);
			msgs = basicSetListIndex(newListIndex, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__LIST_INDEX, newListIndex, newListIndex));
	}
	...
	public NotificationChain basicSetElement(Element newElement, NotificationChain msgs) {
		...
		element = newElement;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__ELEMENT, oldElement, newElement);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setElement(Element newElement) {
		if (newElement != element) {
			NotificationChain msgs = null;
			if (element != null)
				msgs = ((InternalEObject)element).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.ARRAY__ELEMENT, null, msgs);
			if (newElement != null)
				msgs = ((InternalEObject)newElement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.ARRAY__ELEMENT, null, msgs);
			msgs = basicSetElement(newElement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__ELEMENT, newElement, newElement));
	}
	...
	public NotificationChain basicSetOneToMany(OneToMany newOneToMany, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__ONE_TO_MANY, oldOneToMany, newOneToMany);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOneToMany(OneToMany newOneToMany) {
		if (newOneToMany != oneToMany) {
			NotificationChain msgs = null;
			if (oneToMany != null)
				msgs = ((InternalEObject)oneToMany).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.ARRAY__ONE_TO_MANY, null, msgs);
			if (newOneToMany != null)
				msgs = ((InternalEObject)newOneToMany).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.ARRAY__ONE_TO_MANY, null, msgs);
			msgs = basicSetOneToMany(newOneToMany, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__ONE_TO_MANY, newOneToMany, newOneToMany));
	}
	...
	public NotificationChain basicSetManyToMany(ManyToMany newManyToMany, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__MANY_TO_MANY, oldManyToMany, newManyToMany);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setManyToMany(ManyToMany newManyToMany) {
		if (newManyToMany != manyToMany) {
			NotificationChain msgs = null;
			if (manyToMany != null)
				msgs = ((InternalEObject)manyToMany).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.ARRAY__MANY_TO_MANY, null, msgs);
			if (newManyToMany != null)
				msgs = ((InternalEObject)newManyToMany).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.ARRAY__MANY_TO_MANY, null, msgs);
			msgs = basicSetManyToMany(newManyToMany, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__MANY_TO_MANY, newManyToMany, newManyToMany));
	}
	...
	public NotificationChain basicSetCompositeElement(CompositeElement newCompositeElement, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__COMPOSITE_ELEMENT, oldCompositeElement, newCompositeElement);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setCompositeElement(CompositeElement newCompositeElement) {
		if (newCompositeElement != compositeElement) {
			...
			if (compositeElement != null)
				msgs = ((InternalEObject)compositeElement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.ARRAY__COMPOSITE_ELEMENT, null, msgs);
			if (newCompositeElement != null)
				msgs = ((InternalEObject)newCompositeElement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.ARRAY__COMPOSITE_ELEMENT, null, msgs);
			msgs = basicSetCompositeElement(newCompositeElement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__COMPOSITE_ELEMENT, newCompositeElement, newCompositeElement));
	}
	...
	public NotificationChain basicSetManyToAny(ManyToAny newManyToAny, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__MANY_TO_ANY, oldManyToAny, newManyToAny);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setManyToAny(ManyToAny newManyToAny) {
		if (newManyToAny != manyToAny) {
			NotificationChain msgs = null;
			if (manyToAny != null)
				msgs = ((InternalEObject)manyToAny).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.ARRAY__MANY_TO_ANY, null, msgs);
			if (newManyToAny != null)
				msgs = ((InternalEObject)newManyToAny).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.ARRAY__MANY_TO_ANY, null, msgs);
			msgs = basicSetManyToAny(newManyToAny, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__MANY_TO_ANY, newManyToAny, newManyToAny));
	}
	...
	public NotificationChain basicSetLoader(Loader newLoader, NotificationChain msgs) {
		...
		loader = newLoader;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__LOADER, oldLoader, newLoader);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLoader(Loader newLoader) {
		if (newLoader != loader) {
			NotificationChain msgs = null;
			if (loader != null)
				msgs = ((InternalEObject)loader).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.ARRAY__LOADER, null, msgs);
			if (newLoader != null)
				msgs = ((InternalEObject)newLoader).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.ARRAY__LOADER, null, msgs);
			msgs = basicSetLoader(newLoader, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__LOADER, newLoader, newLoader));
	}
	...
	public NotificationChain basicSetSqlInsert(SqlInsert newSqlInsert, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__SQL_INSERT, oldSqlInsert, newSqlInsert);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSqlInsert(SqlInsert newSqlInsert) {
		if (newSqlInsert != sqlInsert) {
			NotificationChain msgs = null;
			if (sqlInsert != null)
				msgs = ((InternalEObject)sqlInsert).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.ARRAY__SQL_INSERT, null, msgs);
			if (newSqlInsert != null)
				msgs = ((InternalEObject)newSqlInsert).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.ARRAY__SQL_INSERT, null, msgs);
			msgs = basicSetSqlInsert(newSqlInsert, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__SQL_INSERT, newSqlInsert, newSqlInsert));
	}
	...
	public NotificationChain basicSetSqlUpdate(SqlUpdate newSqlUpdate, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__SQL_UPDATE, oldSqlUpdate, newSqlUpdate);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSqlUpdate(SqlUpdate newSqlUpdate) {
		if (newSqlUpdate != sqlUpdate) {
			NotificationChain msgs = null;
			if (sqlUpdate != null)
				msgs = ((InternalEObject)sqlUpdate).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.ARRAY__SQL_UPDATE, null, msgs);
			if (newSqlUpdate != null)
				msgs = ((InternalEObject)newSqlUpdate).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.ARRAY__SQL_UPDATE, null, msgs);
			msgs = basicSetSqlUpdate(newSqlUpdate, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__SQL_UPDATE, newSqlUpdate, newSqlUpdate));
	}
	...
	public NotificationChain basicSetSqlDelete(SqlDelete newSqlDelete, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__SQL_DELETE, oldSqlDelete, newSqlDelete);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSqlDelete(SqlDelete newSqlDelete) {
		if (newSqlDelete != sqlDelete) {
			NotificationChain msgs = null;
			if (sqlDelete != null)
				msgs = ((InternalEObject)sqlDelete).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.ARRAY__SQL_DELETE, null, msgs);
			if (newSqlDelete != null)
				msgs = ((InternalEObject)newSqlDelete).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.ARRAY__SQL_DELETE, null, msgs);
			msgs = basicSetSqlDelete(newSqlDelete, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__SQL_DELETE, newSqlDelete, newSqlDelete));
	}
	...
	public NotificationChain basicSetSqlDeleteAll(SqlDeleteAll newSqlDeleteAll, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__SQL_DELETE_ALL, oldSqlDeleteAll, newSqlDeleteAll);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSqlDeleteAll(SqlDeleteAll newSqlDeleteAll) {
		if (newSqlDeleteAll != sqlDeleteAll) {
			...
			if (sqlDeleteAll != null)
				msgs = ((InternalEObject)sqlDeleteAll).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.ARRAY__SQL_DELETE_ALL, null, msgs);
			if (newSqlDeleteAll != null)
				msgs = ((InternalEObject)newSqlDeleteAll).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Hbm30Package.ARRAY__SQL_DELETE_ALL, null, msgs);
			msgs = basicSetSqlDeleteAll(newSqlDeleteAll, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__SQL_DELETE_ALL, newSqlDeleteAll, newSqlDeleteAll));
	}
	...
	public void setAccess(String newAccess) {
		...
		access = newAccess;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__ACCESS, oldAccess, access));
	}
	...
	public void setBatchSize(String newBatchSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__BATCH_SIZE, oldBatchSize, batchSize));
	}
	...
	public void setCascade(String newCascade) {
		...
		cascade = newCascade;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__CASCADE, oldCascade, cascade));
	}
	...
	public void setCatalog(String newCatalog) {
		...
		catalog = newCatalog;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__CATALOG, oldCatalog, catalog));
	}
	...
	public void setCheck(String newCheck) {
		...
		check = newCheck;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__CHECK, oldCheck, check));
	}
	...
	public void setCollectionType(String newCollectionType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__COLLECTION_TYPE, oldCollectionType, collectionType));
	}
	 ...
	 * @generated
	 */
	public void setElementClass(String newElementClass) {
		String oldElementClass = elementClass;
		elementClass = newElementClass;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__ELEMENT_CLASS, oldElementClass, elementClass));
	}
	...
	public void setEmbedXml(boolean newEmbedXml) {
		...
		embedXmlESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__EMBED_XML, oldEmbedXml, embedXml, !oldEmbedXmlESet));
	}
	...
	public void unsetEmbedXml() {
		...
		embedXmlESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Hbm30Package.ARRAY__EMBED_XML, oldEmbedXml, EMBED_XML_EDEFAULT, oldEmbedXmlESet));
	}
	...
	public void setFetch(Fetch newFetch) {
		...
		fetchESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__FETCH, oldFetch, fetch, !oldFetchESet));
	}
	...
	public void unsetFetch() {
		...
		fetchESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Hbm30Package.ARRAY__FETCH, oldFetch, FETCH_EDEFAULT, oldFetchESet));
	}
	...
	public void setInverse(boolean newInverse) {
		...
		inverseESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__INVERSE, oldInverse, inverse, !oldInverseESet));
	}
	...
	public void unsetInverse() {
		...
		inverseESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Hbm30Package.ARRAY__INVERSE, oldInverse, INVERSE_EDEFAULT, oldInverseESet));
	}
	...
	public void setMutable(boolean newMutable) {
		...
		mutableESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__MUTABLE, oldMutable, mutable, !oldMutableESet));
	}
	...
	public void unsetMutable() {
		...
		mutableESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Hbm30Package.ARRAY__MUTABLE, oldMutable, MUTABLE_EDEFAULT, oldMutableESet));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__NAME, oldName, name));
	}
	...
	public void setNode(String newNode) {
		...
		node = newNode;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__NODE, oldNode, node));
	}
	...
	public void setOptimisticLock(boolean newOptimisticLock) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__OPTIMISTIC_LOCK, oldOptimisticLock, optimisticLock, !oldOptimisticLockESet));
	}
	...
	public void unsetOptimisticLock() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Hbm30Package.ARRAY__OPTIMISTIC_LOCK, oldOptimisticLock, OPTIMISTIC_LOCK_EDEFAULT, oldOptimisticLockESet));
	}
	...
	public void setOuterJoin(Outerjoin newOuterJoin) {
		...
		outerJoinESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__OUTER_JOIN, oldOuterJoin, outerJoin, !oldOuterJoinESet));
	}
	...
	public void unsetOuterJoin() {
		...
		outerJoinESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, Hbm30Package.ARRAY__OUTER_JOIN, oldOuterJoin, OUTER_JOIN_EDEFAULT, oldOuterJoinESet));
	}
	...
	public void setPersister(String newPersister) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__PERSISTER, oldPersister, persister));
	}
	...
	public void setSchema(String newSchema) {
		...
		schema = newSchema;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__SCHEMA, oldSchema, schema));
	}
	...
	public void setSubselect1(String newSubselect1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__SUBSELECT1, oldSubselect1, subselect1));
	}
	...
	public void setTable(String newTable) {
		...
		table = newTable;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__TABLE, oldTable, table));
	}
	...
	public void setWhere(String newWhere) {
		...
		where = newWhere;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Hbm30Package.ARRAY__WHERE, oldWhere, where));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case Hbm30Package.ARRAY__LIST_INDEX:
				return basicSetListIndex(null, msgs);
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case Hbm30Package.ARRAY__INDEX:
				...
				return;
			case Hbm30Package.ARRAY__LIST_INDEX:
				setListIndex((ListIndex)newValue);
				return;
			case Hbm30Package.ARRAY__ELEMENT:
			...
			case Hbm30Package.ARRAY__COLLECTION_TYPE:
				...
				return;
			case Hbm30Package.ARRAY__ELEMENT_CLASS:
				setElementClass((String)newValue);
				return;
			case Hbm30Package.ARRAY__EMBED_XML:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case Hbm30Package.ARRAY__ELEMENT_CLASS:
				return ELEMENT_CLASS_EDEFAULT == null ? elementClass != null : !ELEMENT_CLASS_EDEFAULT.equals(elementClass);
			case Hbm30Package.ARRAY__EMBED_XML:
