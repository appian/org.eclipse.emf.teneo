  ...
  public <E> boolean addToEList(EList<E> eList, E element) {
    if (eList instanceof BasicEList) {
      ...
      try {
        ...
        Method growMethod = PrivilegedAccessHelper.getDeclaredMethod(BasicEList.class, "grow", new Class[] { int.class });
        ...
        Method assignMethod = PrivilegedAccessHelper.getDeclaredMethod(BasicEList.class, "assign", new Class[] { int.class, Object.class });
  ...
  public <K, V> void setEMapContents(EMap<K, V> mapContents, EMap<K, V> targetMap) {
    try {
      if (targetMap instanceof BasicEMap) {
        ...
        // set the entry list
        Method basicEMapEnsureEntryDataExistsMethod = PrivilegedAccessHelper.getDeclaredMethod(BasicEMap.class, "ensureEntryDataExists", new Class[] {});
        basicEMapEnsureEntryDataExistsMethod.setAccessible(true);
        basicEMapEnsureEntryDataExistsMethod.invoke(basicEMap, new Object[] {});
        Method basicEMapDoPutMethod = PrivilegedAccessHelper.getDeclaredMethod(BasicEMap.class, "doPut", new Class[] { BasicEMap.Entry.class });
