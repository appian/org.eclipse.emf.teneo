...
public class IndirectEList<E> extends ArrayList<E> implements IndirectEContainer<E>, InternalEList.Unsettable<E>, EStructuralFeature.Setting {
  ...
  /**
   * PUBLIC: Construct an empty IndirectEList so that its internal data array
  ...
  /**
   * PUBLIC: Construct an empty IndirectEList with the specified initial
  ...
  /**
   * PUBLIC: Construct an IndirectEList containing the elements of the specified
   * collection, in the order they are returned by the collection's iterator.
   * 
   * @param collection
   *          a collection containing the elements to construct this
   *          IndirectEList with.
   */
   ...
   * PUBLIC:
   * 
   * @see java.util.Vector#clone() This will result in a database query if
   *      necessary.
   */
  ...
  /**
   * PUBLIC: Check whether the contents have been read from the database. If
   * they have not, read them and set the delegate.
   */
  ...
  /**
   * INTERNAL: return whether this IndirectEList has been registered with the
   * UnitOfWork
   */
  ...
  /**
   * PUBLIC: Use the java.util.Vector#toString(); but wrap it with braces to
   * indicate there is a bit of indirection. Don't allow this method to trigger
   * a database read.
   * 
