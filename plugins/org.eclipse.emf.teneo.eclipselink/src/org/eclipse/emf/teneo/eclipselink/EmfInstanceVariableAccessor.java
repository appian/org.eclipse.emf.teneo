...
/**
 * All attribute access from EclipseLink uses the getter for the getting and direct
 * field access for the set. This allows EclipseLink to leverage the lazy
 * initialization done for instance variables (esp. collections) and yet avoid
 * firing events when setting an instance variable during object construction.
 * 
 * EmfInstanceVariableAccessor uses delegation to mix instance variable with
 * method access.
 * 
 * @author shsmith
 * 
...
public class EmfInstanceVariableAccessor extends AttributeAccessor {
  ...
  /*
   * Enhance direct attribute access with support for isSetE<AttrName>. Replace
   * accessor with EmfInstanceVariableAccessor for all mapped attributes except
   * for EMF framework define attributes.
   */
  ...
  /**
   * Set get and set method after creating these methods by using get and set
   * method names
   */
  @SuppressWarnings("unchecked")
  @Override
  public void initializeAttributes(Class theJavaClass) throws DescriptorException {
    ...
    try {
      ...
      DescriptorException descriptorException = DescriptorException.noSuchMethodWhileInitializingAttributesInMethodAccessor("", getGetMethodName(), theJavaClass.getName());
      descriptorException.setInternalException(ex);
      throw descriptorException;
    }
    catch (SecurityException exception) {
      DescriptorException descriptorException = DescriptorException.securityWhileInitializingAttributesInMethodAccessor("", getGetMethodName(), theJavaClass.getName());
  ...
  public void setAttributeValueInObject(Object anObject, Object value) throws DescriptorException {
    try {
      ...
      throw DescriptorException.nullPointerWhileSettingValueThruInstanceVariableAccessor(getAttributeName(), value, accessException);
    }
  }
}
