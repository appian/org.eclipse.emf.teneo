 ...
 * </copyright>
 *
 * $Id: ResultsetItemProvider.java,v 1.1 2010/08/18 09:29:33 cbouhier Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.teneo.db2m.hbm30.Resultset} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResultsetItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Hbm30Package.eINSTANCE.getResultset_Name(),
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Hbm30Package.eINSTANCE.getResultset_Group());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Hbm30Package.eINSTANCE.getResultset_Group(),
				 FeatureMapUtil.createEntry
					(Hbm30Package.eINSTANCE.getResultset_ReturnScalar(),
		...
		newChildDescriptors.add
			(createChildParameter
				(Hbm30Package.eINSTANCE.getResultset_Group(),
				 FeatureMapUtil.createEntry
					(Hbm30Package.eINSTANCE.getResultset_Return(),
		...
		newChildDescriptors.add
			(createChildParameter
				(Hbm30Package.eINSTANCE.getResultset_Group(),
				 FeatureMapUtil.createEntry
					(Hbm30Package.eINSTANCE.getResultset_ReturnJoin(),
		...
		newChildDescriptors.add
			(createChildParameter
				(Hbm30Package.eINSTANCE.getResultset_Group(),
				 FeatureMapUtil.createEntry
					(Hbm30Package.eINSTANCE.getResultset_LoadCollection(),
