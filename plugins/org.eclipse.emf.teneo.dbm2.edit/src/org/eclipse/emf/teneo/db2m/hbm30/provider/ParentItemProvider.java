 ...
 * </copyright>
 *
 * $Id: ParentItemProvider.java,v 1.1 2010/08/18 09:29:33 cbouhier Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.teneo.db2m.hbm30.Parent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParentItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Parent_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Parent_name_feature", "_UI_Parent_type"),
				 Hbm30Package.eINSTANCE.getParent_Name(),
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Parent)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Parent.class)) {
			case Hbm30Package.PARENT__NAME:
