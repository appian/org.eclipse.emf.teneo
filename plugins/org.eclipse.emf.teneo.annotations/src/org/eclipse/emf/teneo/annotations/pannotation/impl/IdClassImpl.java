 ...
 * </copyright>
 *
 * $Id: IdClassImpl.java,v 1.1 2006/07/04 21:37:02 mtaal Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.annotations.pannotation.impl.IdClassImpl#getEModelElement <em>EModel Element</em>}</li>
...
public class IdClassImpl extends EObjectImpl implements IdClass {
	...
	protected EClass eStaticClass() {
		return PannotationPackage.eINSTANCE.getIdClass();
	}
		...
		if (eModelElement != null && eModelElement.eIsProxy()) {
			...
			if (eModelElement != oldEModelElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PannotationPackage.ID_CLASS__EMODEL_ELEMENT, oldEModelElement, eModelElement));
			}
		}
	...
	public void setEModelElement(EModelElement newEModelElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PannotationPackage.ID_CLASS__EMODEL_ELEMENT, oldEModelElement, eModelElement));
	}
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			case PannotationPackage.ID_CLASS__EMODEL_ELEMENT:
