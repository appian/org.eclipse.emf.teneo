 ...
 * </copyright>
 *
 * $Id: OrderByImpl.java,v 1.1 2006/07/04 21:37:02 mtaal Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.teneo.annotations.pannotation.impl.OrderByImpl#getEModelElement <em>EModel Element</em>}</li>
...
public class OrderByImpl extends EObjectImpl implements OrderBy {
	...
	protected EClass eStaticClass() {
		return PannotationPackage.eINSTANCE.getOrderBy();
	}
		...
		if (eModelElement != null && eModelElement.eIsProxy()) {
			...
			if (eModelElement != oldEModelElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PannotationPackage.ORDER_BY__EMODEL_ELEMENT, oldEModelElement, eModelElement));
			}
		}
	...
	public void setEModelElement(EModelElement newEModelElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PannotationPackage.ORDER_BY__EMODEL_ELEMENT, oldEModelElement, eModelElement));
	}
	...
	public Object eGet(EStructuralFeature eFeature, boolean resolve) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			case PannotationPackage.ORDER_BY__EMODEL_ELEMENT:
