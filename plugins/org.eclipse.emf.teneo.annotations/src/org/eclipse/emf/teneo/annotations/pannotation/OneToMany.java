 ...
 * </copyright>
 *
 * $Id: OneToMany.java,v 1.1 2006/07/04 21:37:00 mtaal Exp $
 */
...
public interface OneToMany extends PAnnotation {
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.teneo.annotations.pannotation.OneToMany#getFetch <em>Fetch</em>}'
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.teneo.annotations.pannotation.OneToMany#getTargetEntity <em>Target Entity</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.teneo.annotations.pannotation.OneToMany#getMappedBy <em>Mapped By</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
