...
public abstract class PAnnotatedEStructuralFeatureImpl extends PAnnotatedEModelElementImpl implements
	...
	public EList getAttributeOverrides() {
		if (attributeOverrides == null) {
			attributeOverrides = new EObjectContainmentEList(AttributeOverride.class, this, PamodelPackage.PANNOTATED_ESTRUCTURAL_FEATURE__ATTRIBUTE_OVERRIDES);
		}
	...
	public EList getJoinColumns() {
		if (joinColumns == null) {
			joinColumns = new EObjectContainmentEList(JoinColumn.class, this, PamodelPackage.PANNOTATED_ESTRUCTURAL_FEATURE__JOIN_COLUMNS);
		}
		return joinColumns;
	}
