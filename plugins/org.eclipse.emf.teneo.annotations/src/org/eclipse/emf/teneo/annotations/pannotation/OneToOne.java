 ...
 * </copyright>
 *
 * $Id: OneToOne.java,v 1.1 2006/07/04 21:37:00 mtaal Exp $
 */
...
public interface OneToOne extends PAnnotation {
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.teneo.annotations.pannotation.OneToOne#getFetch <em>Fetch</em>}'
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.teneo.annotations.pannotation.OneToOne#isOptional <em>Optional</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.teneo.annotations.pannotation.OneToOne#getTargetEntity <em>Target Entity</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	...
	/**
	 * Returns the value of the '<em><b>Cascade</b></em>' attribute list. The list contents are of type
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.teneo.annotations.pannotation.OneToOne#getMappedBy <em>Mapped By</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
