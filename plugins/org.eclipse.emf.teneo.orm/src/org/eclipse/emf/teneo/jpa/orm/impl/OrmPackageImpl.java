...
public class OrmPackageImpl extends EPackageImpl implements OrmPackage {
	...
	public static OrmPackage init() {
		...
		OrmPackageImpl theOrmPackage = (OrmPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof OrmPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new OrmPackageImpl());
