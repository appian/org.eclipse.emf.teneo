...
public class PersistenceOptions {
	...
	/**
	 * Can be used to control if implementation classes should be used for
	 * entity names and target entities or that eclass names are used.
	 */
	public static final String USE_IMPLEMENTATION_CLASSES_AS_ENTITYNAME = NAMING_PREFIX
			+ "java_class_entity_names";

	/** Qualify the entity name */
	public static final String QUALIFY_ENTITY_NAME = NAMING_PREFIX
			+ "qualify_entity_name";
	...
	/**
	 * The value of the QUALIFY_ENTITY_NAME when nsprefix qualification should
	 * occur
	 */
	 ...
	 */
	public static final String JOIN_TABLE_NAMING_STRATEGY = MAPPING_PREFIX
	...
	public boolean isUseImplementationClassAsEntityName() {
		return Boolean.valueOf(
				properties
						.getProperty(USE_IMPLEMENTATION_CLASSES_AS_ENTITYNAME))
				.booleanValue();
	}
	...
	public SQLCaseStrategy getSQLCaseStrategy() {
		return SQLCaseStrategyImpl.createSQLCaseStrategy(properties
				.getProperty(SQL_CASE_STRATEGY));
	}
	...
	/**
	 * Returns the qualify entity names option, returns QUALIFY_ENTITY_NAME_NO
	 * ("no")
	 */
	public EClassNameStrategy getEClassNameStrategy() {
		// note create uses singletons
		return EClassNameStrategyUtils.create(properties.getProperty(
				QUALIFY_ENTITY_NAME, QUALIFY_ENTITY_NAME_NO));
	}
