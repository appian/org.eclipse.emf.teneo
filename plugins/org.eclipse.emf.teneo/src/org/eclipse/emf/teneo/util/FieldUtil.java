 ...
 * implementation </copyright> $Id: FieldUtil.java,v 1.16 2009/03/30 06:41:00 mtaal Exp $
 */
...
public class FieldUtil {
	...
	public static Object callMethod(Object obj, String methodName,
		...
		try {
			...
			if (method != null) {
				...
				throw new TeneoException("Method does not exist "
			...
			throw new TeneoException("Exception " + obj.getClass().getName()
	...
	public static Object callGetter(Object target, String fieldName) {
		try {
			...
			throw new TeneoException("Exception getting " + fieldName
	...
	public static void callSetter(Object target, String fieldName, Object value) {
		try {
			final Method method = getMethodInternal(target.getClass(), "get"
					+ fieldName);
			if (method != null) {
			...
			throw new TeneoException("Exception setting " + fieldName
					+ " from " + target.getClass().getName() + " to value "
					+ value + " of type "
	...
	public static Field getField(Class<?> clazz, String fieldName) {
		...
		{
			throw new TeneoException("Field " + fieldName
	...
	private static Method getMethodInternal(Class<?> clazz, String methodName)
		...
		final Method method = (Method) fieldMethodCache.get(clazz.getName()
				+ "." + methodName);
		if (method != null) {
			return method;
		}
		...
		for (Method element : methods) {
			if (element.getName().compareToIgnoreCase(methodName) == 0) {
				element.setAccessible(true);
				fieldMethodCache.put(clazz.getName() + "." + methodName,
						element);
				return element;
			}
		}
