 ...
 * </copyright>
 *
 * $Id: GenerateHBMActionSuperClass.java,v 1.2 2007/02/01 12:34:24 mtaal Exp $
 */
...
public class GenerateHBMActionSuperClass extends GenerateMappingAction {
	...
	public void run(IAction action) {
		...
		super.run(action, HbConstants.HBM_FILE_NAME, "Generate JDO 2.0 Metadata File", options, GenerateHBM.class.getName());
	}
}