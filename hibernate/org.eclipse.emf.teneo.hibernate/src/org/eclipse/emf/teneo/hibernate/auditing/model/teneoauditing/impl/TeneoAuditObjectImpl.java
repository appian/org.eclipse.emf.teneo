 ...
 * <ul>
 * <li>
 * {@link org.eclipse.emf.teneo.hibernate.auditing.model.teneoauditing.impl.TeneoAuditObjectImpl#getTeneo_audit_id
 * <em>Teneo audit id</em>}</li>
 * <li>
 * {@link org.eclipse.emf.teneo.hibernate.auditing.model.teneoauditing.impl.TeneoAuditObjectImpl#getTeneo_version
 * <em>Teneo version</em>}</li>
 * <li>
 * {@link org.eclipse.emf.teneo.hibernate.auditing.model.teneoauditing.impl.TeneoAuditObjectImpl#getTeneo_object_id
 * <em>Teneo object id</em>}</li>
 * <li>
 * {@link org.eclipse.emf.teneo.hibernate.auditing.model.teneoauditing.impl.TeneoAuditObjectImpl#getTeneo_start
 * <em>Teneo start</em>}</li>
 * <li>
 * {@link org.eclipse.emf.teneo.hibernate.auditing.model.teneoauditing.impl.TeneoAuditObjectImpl#getTeneo_end
 * <em>Teneo end</em>}</li>
 * <li>
 * {@link org.eclipse.emf.teneo.hibernate.auditing.model.teneoauditing.impl.TeneoAuditObjectImpl#getTeneo_commit_info
 * <em>Teneo commit info</em>}</li>
 * <li>
 * {@link org.eclipse.emf.teneo.hibernate.auditing.model.teneoauditing.impl.TeneoAuditObjectImpl#getTeneo_audit_kind
...
public class TeneoAuditObjectImpl extends EObjectImpl implements TeneoAuditObject {
	...
	public void setTeneo_audit_id(long newTeneo_audit_id) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TeneoauditingPackage.TENEO_AUDIT_OBJECT__TENEO_AUDIT_ID, oldTeneo_audit_id,
					teneo_audit_id));
	}
	...
	public void setTeneo_version(long newTeneo_version) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TeneoauditingPackage.TENEO_AUDIT_OBJECT__TENEO_VERSION, oldTeneo_version, teneo_version));
	}
	...
	public void setTeneo_object_id(String newTeneo_object_id) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TeneoauditingPackage.TENEO_AUDIT_OBJECT__TENEO_OBJECT_ID, oldTeneo_object_id,
					teneo_object_id));
	}
	...
	public void setTeneo_start(long newTeneo_start) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TeneoauditingPackage.TENEO_AUDIT_OBJECT__TENEO_START, oldTeneo_start, teneo_start));
	}
	...
	public void setTeneo_end(long newTeneo_end) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TeneoauditingPackage.TENEO_AUDIT_OBJECT__TENEO_END, oldTeneo_end, teneo_end));
	}
			...
			if (teneo_commit_info != oldTeneo_commit_info) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							TeneoauditingPackage.TENEO_AUDIT_OBJECT__TENEO_COMMIT_INFO, oldTeneo_commit_info,
							teneo_commit_info));
			}
		}
	...
	public void setTeneo_audit_kind(TeneoAuditKind newTeneo_audit_kind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TeneoauditingPackage.TENEO_AUDIT_OBJECT__TENEO_AUDIT_KIND, oldTeneo_audit_kind,
					teneo_audit_kind));
	}
